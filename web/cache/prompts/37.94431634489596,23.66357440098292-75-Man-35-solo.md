...
The tourist is currently located at these coordinates: 37°56'39.54"N, 23°39'48.87"E (37.94431634489596, 23.66357440098292).
Name of Road: E 75
...
- Peace and Friendship Stadium, network: Τραμ Αθήνας, operator: ΣΤΑΣΥ, public_transport: stop_position, railway: tram_stop, short_name: ΣΕΦ, short_name:en: SEF, short_name:fr: SEF, start_date: 2004-07-19, tram: yes (49m)
- Peace and Friendship Stadium, network: Τραμ Αθήνας, operator: ΣΤΑΣΥ, public_transport: stop_position, railway: tram_stop, short_name: ΣΕΦ, short_name:en: SEF, short_name:fr: SEF, start_date: 2004-07-19, tram: yes (54m)
- railway: buffer_stop (55m)
- Neo Faliro Metro Line 1 Depot, operator: ΣΤΑ.ΣΥ. Α.Ε., railway: yard (57m)
- Peace and Friendship Stadium, network: Τραμ Αθήνας, operator: ΣΤΑΣΥ, public_transport: stop_position, railway: tram_stop, short_name: ΣΕΦ, short_name:en: SEF, short_name:fr: SEF, start_date: 2004-07-19, tram: yes (59m)
- railway: buffer_stop (63m)
- Peace and Friendship Stadium, network: Τραμ Αθήνας, operator: ΣΤΑΣΥ, public_transport: stop_position, railway: tram_stop, short_name: ΣΕΦ, short_name:en: SEF, short_name:fr: SEF, start_date: 2004-07-19, tram: yes (66m)
- uncontrolled, bicycle: yes, railway: crossing (92m)

Within a 75m radius, there are also:
- Οδός Πειραιώς;Peiraios Str. (oneway 1-lane asphalt road, lit), destination: Καλλιθέα;Μοσχάτο;Ν. Φάληρο, reg_ref: ΕΠ16
- Ethnarchou Makariou (oneway 1-lane asphalt road, lit), destination: Μικρολίμανο;Καστέλλα, maxheight: 4.2, maxspeed: 50km/h, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- tertiary, destination: Μικρολίμανο;Καστέλλα, lanes: 1, lit: yes, maxheight: 4.2, maxspeed: 50km/h, oneway: yes, surface: asphalt, tunnel: yes
- Εθνάρχου Μακαρίου;Peiraios Str.Οδός Πειραιώς (oneway 1-lane asphalt road, lit), destination: Καλλιθέα;Μοσχάτο, reg_ref: ΕΠ16, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Ποσειδώνος (oneway 2-lane asphalt road, lit), destination: Λαμία;Γλυφάδα;Σ.Ε.Φ., destination:lang:el-Latn: Glyfada;Lamia, maxspeed: 60km/h
- trunk, int_ref: E 75, lanes: 2, lit: yes, maxspeed: 60km/h, oneway: yes, surface: asphalt
- trunk, bridge: yes, destination:lanes: Αθήνα;Γλυφάδα|Αεροδρόμιο;Γλυφάδα|Λαμία|ΣΕΦ, int_ref: E 75, lanes: 4, lit: yes, maxspeed: 60km/h, oneway: yes, turn:lanes: none|none|none|right
- trunk, destination: Λαμία;Αθήνα;Γλυφάδα;Σ.Ε.Φ., destination:lanes: Αθήνα;Γλυφάδα|Λαμία;Σ.Ε.Φ., int_ref: E 75, lanes: 2, lit: yes, maxheight: 4.2, maxspeed: 60km/h, oneway: yes, surface: asphalt
- Ποσειδώνος (oneway 1-lane asphalt road, lit), destination: Κέντρο;Λιμάνι, destination:lang:el-Latn: Centre, destination:lang:en: Port, maxheight: 4.5, maxspeed: 50km/h
- primary, access:lanes: yes|yes|no, int_ref: E 75, lanes: 3, lit: yes, maxspeed: 60km/h, oneway: yes, reg_ref: ΕΠ16, source:reg_ref: ΦΕΚ 47 Α/8.2.1956, surface: asphalt
- Εθνάρχου Μακαρίου (oneway 1-lane asphalt road, unlit), destination: Μικρολίμανο;Καστέλλα, maxheight: 4.2, maxspeed: 50km/h
- primary, access:lanes: yes|yes|no, bridge: yes, int_ref: E 75, lanes: 3, lit: yes, maxspeed: 60km/h, oneway: yes, reg_ref: ΕΠ16, source:reg_ref: ΦΕΚ 47 Α/8.2.1956, surface: asphalt
- primary, destination:lanes: Καλλιθέα;Μοσχάτο;Αθήνα|Λαμία, int_ref: E 75, lanes: 2, lit: yes, maxspeed: 60km/h, oneway: yes, reg_ref: ΕΠ16, source:reg_ref: ΦΕΚ 47 Α/8.2.1956, surface: asphalt
- parking
- leisure: pitch, sport: soccer
- shelter, shelter_type: building
...
- colour: #007A33, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: subway, service: yard, voltage: 750
- building:levels: 1
- Πλατεία Αλικάκου ( road), area: yes, place: square
- footway, footway: sidewalk, lit: no, smoothness: bad, surface: dirt
- Tzavella (oneway 2-lane asphalt road, lit), destination:lanes: Λαμία;Γλυφάδα|Καλλιθέα;Μοσχάτο, maxspeed: 50km/h, sidewalk: no
- Davaki - Pindou (1-lane asphalt road)
- Athens Tram, bridge: yes, electrified: contact_line, frequency: 0, gauge: 1435, oneway: yes, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: main, voltage: 750
- footway, surface: concrete
- footway, footway: sidewalk, surface: concrete, wheelchair: yes
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: tram, service: spur, start_date: 2004-07-19, voltage: 750
...
- platform, area: yes, bench: yes, covered: no, passenger_information_display: yes, public_transport: platform, railway: platform, shelter: yes, tram: yes, wheelchair: yes
- platform, area: yes, bench: yes, covered: no, passenger_information_display: yes, public_transport: platform, railway: platform, shelter: yes, tram: yes, wheelchair: yes
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: tram, service: spur, start_date: 2004-07-19, voltage: 750
- Athens Tram, bridge: yes, electrified: contact_line, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: siding, voltage: 750
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, oneway: yes, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: main, voltage: 750
- Paraliaki Leoforos
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: siding, voltage: 750
- Athens Tram, bridge: yes, electrified: contact_line, frequency: 0, gauge: 1435, oneway: yes, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: main, voltage: 750
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, oneway: yes, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: main, voltage: 750
- building:levels: 1
- Line 1, (Green line), colour: #007A33, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, network: Μετρό Αθήνας, operator: ΣΤΑΣΥ, railway: subway, start_date: 1869-02-27, usage: main, voltage: 750
- electrified: contact_line, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: tram, start_date: 2004-07-19, usage: siding, voltage: 750
- Peace and Friendship Stadium Park, leisure: park
- footway, footway: sidewalk, surface: concrete
