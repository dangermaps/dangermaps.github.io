...
Tourist: a Man in a wheelchair, 23 years old, traveling on foot and solo.

It is 11AM local time.

The tourist is currently located at these coordinates: 52°13'34.88"N, 21°0'49.62"E (52.226354205136886, 21.01378428441424).
...
- traffic signals (10m)
- barrier: bollard, bollard: fixed, material: metal (17m)
- barrier: bollard, bollard: fixed, material: metal (17m)
- Marszałkowska - Hoża, bicycle rental, bicycle_rental: dropoff_point, brand: Veturilo, capacity: 15, network: Veturilo, operator: Nextbike Polska (17m)
- street lamp (18m)
- barrier: bollard, bollard: fixed, material: metal (18m)
- barrier: bollard, bollard: fixed, material: metal (18m)
- barrier: bollard, bollard: fixed, material: metal (18m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 8, covered: no, fee: no (19m)
- barrier: bollard, bollard: fixed, material: metal (19m)
- barrier: bollard, bollard: fixed, material: metal (19m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 10, covered: no, fee: no (20m)
- barrier: bollard, bollard: fixed, material: metal (20m)
- barrier: bollard, bollard: fixed, material: metal (20m)
- barrier: bollard, bollard: fixed, material: metal (20m)
- barrier: bollard, bollard: fixed, material: metal (21m)
- barrier: bollard, bollard: fixed, material: metal (21m)
- railway: tram_level_crossing (22m)
...
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 10, covered: no, fee: no (24m)
- barrier: bollard, bollard: fixed, material: metal (24m)
- barrier: bollard, bollard: fixed, material: metal (24m)
- fire hydrant (underground) (24m)
- barrier: bollard, bollard: fixed, material: metal (26m)
- barrier: bollard, bollard: fixed, material: metal (26m)
- barrier: bollard, bollard: fixed, material: metal (27m)
- atm, brand: Alior Bank, indoor: yes, opening_hours: 24/7, operator: Euronet, wheelchair: no (28m)
- barrier: bollard, bollard: fixed, material: metal (28m)
- barrier: bollard, bollard: fixed, material: metal (29m)
- crossing, traffic_signals, bicycle: yes, button_operated: yes, traffic_signals:sound: yes, traffic_signals:vibration: no (29m)
- Hoża 02 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: yes (30m)
- 85 Marszałkowska, 00-683 Warszawa, addr:city:simc: 0918123, brand: Żabka, name: Żabka, opening_hours: Mo-Sa 06:00-23:00; Su 11:00-20:00, shop: convenience, wheelchair: no (30m)
- 85 Marszałkowska, Warszawa, bank, atm: yes, brand: Alior Bank, name: Alior Bank, opening_hours: Mo-We,Fr 09:00-17:00; Th 11:00-17:00, wheelchair: no (30m)
- crossing, traffic_signals, button_operated: yes, check_date:traffic_signals:vibration: 2024-12-05, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: no (32m)
- barrier: bollard, bollard: fixed, material: metal (33m)
- barrier: bollard, bollard: fixed, material: metal (34m)
- waste basket (34m)
- street lamp (35m)
- V4B, addr:housenumber: 76, addr:street: Marszałkowska, opening_hours: Mo-Sa 09:00-24:00, shop: e-cigarette, wheelchair: yes (35m)
- barrier: bollard, bollard: fixed, material: metal (35m)
- barrier: bollard, bollard: fixed, material: metal (35m)
- barrier: bollard, bollard: fixed, material: metal (35m)
- barrier: bollard, bollard: fixed, material: metal (35m)
- crossing, traffic_signals, button_operated: no, crossing_ref: zebra, traffic_signals:sound: no, traffic_signals:vibration: no (35m)
- bicycle parking, bicycle_parking: stands, capacity: 8, covered: no (36m)
- parcel locker, brand: Paczkomat InPost, image: https://geowidget.easypack24.net/uploads/pl/images/WAW322M.jpg, opening_hours: 24/7, operator: InPost, parcel_mail_in: yes, parcel_pickup: yes, website: https://inpost.pl/paczkomat-warszawa-waw322m-marszalkowska-paczkomaty-mazowieckie (36m)
- barrier: bollard, bollard: fixed, material: metal (36m)
- barrier: bollard, bollard: fixed, material: metal (36m)
- waste basket (36m)
- Hoża 02, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position (36m)
- Rossmann, addr:housenumber: 78/80, addr:street: Marszałkowska, brand: Rossmann, opening_hours: Mo-Fr 07:00-21:30; Sa 08:30-18:00, shop: chemist, wheelchair: yes (37m)
- Loombard, addr:housenumber: 85, addr:street: Marszałkowska, brand: Loombard, opening_hours: Mo-Sa 08:00-21:00; Su 09:00-18:00, shop: pawnbroker, wheelchair: no (37m)
- barrier: bollard, bollard: fixed, material: metal (37m)
- barrier: bollard, bollard: fixed, material: metal (37m)
- man_made: manhole (37m)
- 76 Marszałkowska, 00-517 Warszawa, studio, access: private, contact:facebook: ScenaDDTVN, name: Dzień Dobry TVN, operator: TVN, short_name: DD TVN, studio: television (37m)
- traffic signals (37m)
- barrier: bollard, bollard: fixed, material: metal (38m)
- barrier: bollard, bollard: fixed, material: metal (38m)
- barrier: bollard, bollard: fixed, material: metal (38m)
- Dr. Roxi, addr:housenumber: 85, addr:street: Marszałkowska, opening_hours: Mo-Sa 10:00-19:00, shop: cosmetics, wheelchair: no (39m)
- barrier: bollard, bollard: fixed, material: metal (40m)
- railway: tram_crossing (41m)
- atm, brand: Kasa Stefczyka, covered: no, opening_hours: 24/7, operator: Planet Cash, wheelchair: yes (42m)
- barrier: bollard, bollard: fixed, material: metal (42m)
- BOŚ Dom Maklerski, addr:housenumber: 78/80, addr:street: Marszałkowska, office: financial, opening_hours: Mo-Fr 09:00-17:00, wheelchair: yes (43m)
- barrier: bollard, bollard: fixed, material: metal (43m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: no (43m)
- barrier: bollard, bollard: fixed, material: metal (45m)
- street lamp (48m)
- barrier: bollard, bollard: fixed, material: metal (49m)

Within a 75m radius, there are also:
- 78/80 Marszałkowska, 00-517 Warszawa, addr:city:simc: 0918123, building:levels: 2, source:addr: gugik.gov.pl
- 76 Marszałkowska, 00-517 Warszawa, addr:city:simc: 0918123, building:levels: 11, name: M76, source:addr: gugik.gov.pl
...
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, bicycle: use_sidepath, maxspeed: 50km/h, parking:left: no, parking:right: separate, sidewalk:left: no, sidewalk:right: separate
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:right: no, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
...
- cycleway, cycleway: crossing, lit: yes, surface: asphalt
...
- parking, access: yes, fee: yes, parking: street_side
- Hoża (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Hoża w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
- Hoża (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Hoża w Warszawie, maxspeed: 50km/h, sidewalk: separate
- parking, access: yes, fee: yes, orientation: parallel, parking: street_side
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: sett
- shelter, shelter_type: public_transport
- Hoża (residential oneway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Hoża w Warszawie, maxspeed: 50km/h, sidewalk: separate
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
- footway, footway: sidewalk, lit: yes, smoothness: intermediate, surface: sett
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
...
Again, the person is a Man in a wheelchair, 23 years old, traveling on foot and solo.
