...
The tourist is currently located at these coordinates: 6°14'50.66"N, 75°34'10.25"W (6.247404340485864, -75.56951419339606).
Name of Road: Ciclorruta Paseo Bolívar
...
- entrance: yes (20m)
- crossing (21m)
- Dios Mercurio, tourism: artwork (24m)
- crossing, marked (28m)
- entrance: yes (31m)
- entrance: yes (31m)
- entrance: yes (35m)
- railway: buffer_stop (48m)

Within a 75m radius, there are also:
- Carrera 51 (oneway 1-lane asphalt road), (Bolívar)
- Estación Metro San Antonio. Línea A, bench: yes, bin: yes, bridge: yes, covered: yes, lit: yes, network: Metro de Medellín, operator: ETMVA, public_transport: platform, railway: platform, subway: yes
- Estación Metro San Antonio. Línea A, bench: yes, bin: yes, bridge: yes, covered: yes, lit: yes, network: Metro de Medellín, operator: ETMVA, public_transport: platform, railway: platform, subway: yes
- Estación Metro San Antonio. Línea B, bench: yes, bin: yes, bridge: yes, covered: yes, lit: yes, network: Metro de Medellín, operator: ETMVA, public_transport: platform, railway: platform, subway: yes
- Estación Metro San Antonio. Línea B, bench: yes, bin: yes, bridge: yes, covered: yes, lit: yes, network: Metro de Medellín, operator: ETMVA, public_transport: platform, railway: platform, subway: yes
- bridge: yes, electrified: contact_line, frequency: 0, gauge: 1435, railway: subway, surface: concrete, voltage: 1500
- bridge: yes, electrified: contact_line, frequency: 0, gauge: 1435, railway: subway, surface: concrete, voltage: 1500
- footway, bridge: yes
- steps, bridge: yes, handrail: yes
- steps, bridge: yes, handrail: yes
- San Antonio, bridge: yes, network: Metro de Medellín, operator: ETMVA, platforms: 4, public_transport: station, railway: station, shelter: yes, station: subway, subway: yes, website: https://www.metrodemedellin.gov.co/
- Calle 47 (oneway 2-lane asphalt road), (Avenida Maturín)
- footway
- footway
- Carrera 51 ( road)
- steps
...
- steps
- footway
- Tranvía de Ayacucho, bicycle: yes, electrified: contact_line, railway: tram, surface: concrete
- Ciclorruta Paseo Bolívar (twoway concrete road), marking:left: solid_line, marking:right: double_solid_line, separation:left: no, separation:right: studs, traffic_mode:left: foot, traffic_mode:right: motor_vehicle
- Carrera 51 (oneway 2-lane asphalt road), (Bolívar), fixme: direction of one-way
- Carrera 51A (residential oneway road)
- bridge: viaduct, electrified: contact_line, frequency: 0, gauge: 1435, railway: subway, voltage: 1500
- bridge: viaduct, designation: Metro de Medellín, electrified: contact_line, frequency: 0, gauge: 1435, railway: subway, voltage: 1500
- Calle 47 (oneway 2-lane asphalt road), (Avenida Maturín), cycleway: separate
- footway
- footway
- footway
- Ciclorruta Maturín (twoway concrete road), marking:left: solid_line, marking:right: double_solid_line;surface, separation:left: no, separation:right: studs, traffic_mode:left: foot, traffic_mode:right: motor_vehicle
- Ciclorruta Paseo Bolívar (twoway concrete road), marking:left: double_solid_line, marking:right: solid_line, separation:left: studs, separation:right: no, traffic_mode:left: motor_vehicle, traffic_mode:right: foot
