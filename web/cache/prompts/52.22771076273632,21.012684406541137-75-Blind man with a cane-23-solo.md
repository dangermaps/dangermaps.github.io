...
The tourist is currently located at these coordinates: 52°13'39.76"N, 21°0'45.66"E (52.22771076273632, 21.012684406541137).
...
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: no, wheelchair: yes (10m)
- Ulica Marszałkowska, tourism information, information: board (12m)
- PZU, addr:housenumber: 87, addr:street: Marszałkowska, brand: PZU, office: insurance, opening_hours: Mo-Fr 08:00-18:00, wheelchair: yes (13m)
- TK Laser, addr:housenumber: 87, addr:street: Marszałkowska, beauty: hair_removal, disused:shop: beauty, opening_hours: Mo-Sa 08:00-22:00, wheelchair: limited (15m)
- crossing, traffic_signals, bicycle: yes, button_operated: yes, traffic_signals:sound: yes, traffic_signals:vibration: no (19m)
- traffic_signals, button_operated: yes, railway: tram_crossing, traffic_signals:sound: yes, traffic_signals:vibration: no (19m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: no (20m)
- railway: tram_crossing (22m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (22m)
- traffic signals (22m)
- Bio Carrefour, addr:housenumber: 87, addr:street: Marszałkowska, brand:website: https://www.carrefour.pl/sklep-bio, opening_hours: Mo-Fr 07:30-21:30; Sa 08:30-20:30, organic: yes, shop: deli, wheelchair: limited (26m)
- Żabka, addr:housenumber: 87, addr:street: Marszałkowska, brand: Żabka, opening_hours: Mo-Sa 06:00-23:00; Su 09:00-20:00; PH 09:00-21:00, shop: convenience, wheelchair: yes (26m)
- traffic signals (30m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: no (30m)
- traffic signals (36m)
- street lamp (37m)
- waste basket (37m)
- 89 Marszałkowska, 00-693 Warszawa, brand: Volvo, email: warszawa@volvocars.com, name: Volvo, opening_hours: Mo-Fr 10:00-18:00; Sa 10:00-15:00, phone: +48 22 777 00 77, shop: car, website: https://volvocarwarszawa.pl/, wheelchair: yes (38m)
- bench, backrest: no (43m)
- waste basket, material: concrete (44m)
- waste basket (45m)
- Deseo, opening_hours: Mo-Fr 10:00-21:00; Sa,Su 11:00-21:00, shop: pastry (47m)

Within a 75m radius, there are also:
- 89 Marszałkowska, 00-693 Warszawa, addr:city:simc: 0918123, building:levels: 12, height: 47, name: Wolf Marszałkowska, source:addr: gugik.gov.pl
- 43 Żurawia, 00-680 Warszawa, addr:city:simc: 0918123, building:levels: 5, source:addr: gugik.gov.pl
- 87 Marszałkowska, 00-683 Warszawa, addr:city:simc: 0918123, building:levels: 9, source:addr: gugik.gov.pl
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:left: no, parking:right: street_side, parking:right:orientation: diagonal, sidewalk:left: no, sidewalk:right: separate, smoothness: good
- Marszałkowska (oneway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, bicycle: use_sidepath, maxspeed: 50km/h, parking:left: no, parking:right: separate, sidewalk: separate
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:left: no, parking:right: street_side, parking:right:orientation: diagonal, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
...
- area:highway: secondary, fixme: zmieniona geometria skrzyżowania (Nowe Centrum Warszawy)
- area:highway: secondary, fixme: zmieniona geometria skrzyżowania (Nowe Centrum Warszawy), lit: yes
- area:highway: footway, lit: yes
- area:highway: footway, lit: yes
- area:highway: footway, lit: yes
- area:highway: yes, junction: yes
- area:highway: footway, lit: yes, traffic_calming: island
- service, access: private, maxheight: default, service: driveway, tunnel: building_passage
...
- footway, footway: crossing, lit: yes, smoothness: intermediate, surface: concrete, width: 8
- area:highway: secondary
- area:highway: yes, junction: yes
...
- area:highway: secondary
- cycleway, cycleway: crossing, lit: yes, smoothness: excellent, surface: asphalt
- cycleway, lit: yes, smoothness: excellent, surface: paving_stones
...
- area:highway: emergency
- area:highway: yes, junction: yes
- secondary link, cycleway:both: no, lanes: 1, lit: yes, maxspeed: 50km/h, oneway: yes, sidewalk: no, smoothness: good, surface: asphalt
- area:highway: yes, junction: yes
- area:highway: emergency
- parking, area:highway: parking_space, orientation: diagonal, parking: street_side
- parking, area:highway: parking_space, orientation: diagonal, parking: street_side
- Marszałkowska (oneway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, bicycle: use_sidepath, maxspeed: 50km/h, parking:left: no, parking:right: separate, sidewalk:left: no, sidewalk:right: separate, smoothness: good
- footway, footway: sidewalk, lit: yes, smoothness: intermediate, surface: sett
- footway, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt, width: 8
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones, width: 8
- footway, footway: crossing, lit: yes, smoothness: good, surface: asphalt, width: 8
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- building:colour: #4F6B74, building:levels: 8, building:material: stone, building:part: yes, height: 30, roof:colour: #706F55, roof:material: grass, roof:shape: flat
- building:colour: #1C444E, building:levels: 8, building:material: glass, building:min_level: 1, building:part: yes, height: 30, min_height: 3.5, roof:colour: #1C444E, roof:material: glass
- building:colour: #1C444E, building:levels: 2, building:material: glass, building:min_level: 1, building:part: yes, height: 9, min_height: 3.5, roof:colour: #92A197
- building:colour: #1C444E, building:material: glass, building:part: yes, height: 31, min_height: 30, roof:colour: #1C444E, roof:height: 1, roof:material: glass, roof:orientation: along, roof:shape: gabled
- barrier: fence
...
- Żurawia (residential oneway 2-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Żurawia w Warszawie, maxspeed: 50km/h, sidewalk: separate
- Żurawia (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Żurawia w Warszawie, cycleway:both: no, maxspeed: 50km/h, sidewalk:left: no, sidewalk:right: separate, smoothness: good
- Żurawia (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Żurawia w Warszawie, maxspeed: 50km/h, sidewalk: separate
- footway, footway: sidewalk, lit: yes, smoothness: intermediate, surface: sett
...
Again, the person is a Blind man with a cane, 23 years old, traveling on foot and solo.
