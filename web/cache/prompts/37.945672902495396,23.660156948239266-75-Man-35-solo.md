...
It is Wednesday, Aug 16, 2023, 2:00 PM local time.

The tourist is currently located at these coordinates: 37°56'44.42"N, 23°39'36.57"E (37.945672902495396, 23.660156948239266).
Name of Road: Δημοσθένους Ομηρίδου Σκυλίτση
Name of neighborhood: Μυρτιδιώτισσα
City district: 2nd District of Piraeus
City: athens
Admin district: 2nd District of Piraeus, Municipality of Piraeus, Regional Unit of Piraeus, Attica, Greece (2η Κοινότητα Πειραιά, Δήμος Πειραιώς, Περιφερειακή Ενότητα Πειραιώς, Περιφέρεια Αττικής, Αποκεντρωμένη Διοίκηση Αττικής, Ελλάς)

The following points of interest are within a 75m radius (with distance in meters):
- railway: level_crossing (20m)
- Mikras Asias, network: Τραμ Αθήνας, operator: ΣΤΑΣΥ, public_transport: stop_position, railway: tram_stop, start_date: 2021-12-06, tram: yes (29m)
- railway: level_crossing (31m)
- AEGEAN, fuel, brand: Aegean, operator: ΜΙΔΑΣ ΙΚΕ (32m)
- ΔΕΚΑΕΠΤΑ, bus: yes, network: ΟΑΣΑ, operator: ΟΣΥ, public_transport: stop_position (46m)
- railway: level_crossing (47m)
- railway: switch (47m)
- ΔΕΚΑΕΠΤΑ ( road, unlit), bench: no, bin: no, bus: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΣΥ, public_transport: platform, route_ref: 040;130;217;218;229;500;Α1;Β1, shelter: no (48m)
- man_made: street_cabinet (55m)
- addr:housenumber: 66Β, addr:street: Δημοσθένους Ομηρίδου Σκυλίτση (59m)
- maxspeed: 30km/h, traffic_sign: maxspeed (68m)
- railway: level_crossing (71m)
- fire hydrant (74m)
- railway: level_crossing (86m)
- Omiridou Skylitsi, network: Τραμ Αθήνας, operator: ΣΤΑΣΥ, public_transport: stop_position, railway: tram_stop, start_date: 2021-12-06, tram: yes (97m)

Within a 75m radius, there are also:
- Pythagora (residential oneway asphalt road), maxspeed: 30km/h
- Dimosthenous Omiridi Skylitsi (oneway 2-lane asphalt road, lit), int_ref: E 75, maxheight: 4.2, maxspeed: 60km/h, old_name: Τροχιοδρόμων, reg_ref: ΕΠ16, short_name: Ομηρίδη Σκυλίτση, source:maxheight: sign, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Dimosthenous Omiridi Skylitsi (oneway 2-lane asphalt road, lit), int_ref: E 75, maxheight: 4.8, maxspeed: 60km/h, old_name: Τροχιοδρόμων, reg_ref: ΕΠ16, short_name: Ομηρίδη Σκυλίτση, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
...
- Line 1, (Green line), colour: #007A33, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, network: Μετρό Αθήνας, operator: ΣΤΑΣΥ, railway: subway, railway:preferred_direction: forward, start_date: 1869-02-27, usage: main, voltage: 750
- barrier: wall
- barrier: wall
- Mezonos (residential oneway asphalt road), bicycle: yes, cycleway: no
- barrier: wall
- barrier: wall
- barrier: wall
- building:levels: 6
- building:levels: 6
- Μεγάλου Αλεξάνδρου, Πειραιάς, building:levels: 1, operator: ΟΣΥ, roof:material: eternit, roof:shape: gabled
- 66 Δημοσθένους Ομηρίδου Σκυλίτση, 18533 Πειραιάς, building:levels: 1
- service, access: private, service: driveway, trolley_wire: yes, trolleybus: yes
- service, access: no, service: parking_aisle, trolleybus: yes
- service, oneway: yes, service: driveway, surface: asphalt
- Αμαξοστάσιο Ηλεκτροκινήτων Λεωφορείων Φαλήρου, access: private, addr:street: Μεγάλου Αλεξάνδρου, operator: ΟΣΥ, trolleybus: yes
- barrier: wall, height: 3
- access: private, leisure: garden
- parking, access: private, barrier: fence, height: 2
- barrier: wall, height: 3
- barrier: wall, height: 2
- barrier: wall, height: 4
- barrier: wall, height: 2, material: concrete
- service, lanes: 1, lit: yes, smoothness: good, surface: asphalt
- Αιγαίον
...
- Paraliaki Leoforos
- Mikras Asias (oneway 3-lane asphalt bridge, lit), access:lanes: yes|yes|no, int_ref: E 75, maxspeed: 60km/h, reg_ref: ΕΠ16, sidewalk: right, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Mikras Asias (oneway 3-lane asphalt road, lit), access:lanes: yes|yes|no, int_ref: E 75, maxspeed: 40km/h, reg_ref: ΕΠ16, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, oneway: yes, operator: ΣΤΑΣΥ, railway: tram, start_date: 2021-12-06, usage: main, voltage: 750
- Athens Tram, electrified: contact_line, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: tram, service: siding, start_date: 2021-12-06, voltage: 750
- service
- service, lanes: 1, oneway: yes, surface: asphalt
- service, lanes: 1, oneway: yes, surface: asphalt
...
- colour: #007A33, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: subway, railway:preferred_direction: forward, service: crossover, voltage: 750
- Μικράς Ασίας ( road, lit), area: yes, bench: yes, bin: no, covered: no, passenger_information_display: yes, public_transport: platform, railway: platform, shelter: yes, tram: yes, wheelchair: yes
...
In your rating, emphasize the tourist's current location (2nd District of Piraeus) and the nearby POIs over country-level information.
