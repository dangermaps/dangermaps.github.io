...
It is Wednesday, Aug 16, 2023, 2:13 PM local time.

The tourist is currently located at these coordinates: 37°59'59.88"N, 23°44'0.32"E (37.99996678436762, 23.73342299967288).
Name of Road: 28ης Οκτωβρίου
...
- crossing, marked (13m)
- crossing, marked (16m)
- Αθήνα, shop: kiosk (18m)
- crossing, traffic_signals (21m)
- Σάββας, fast food (22m)
- 61 Αγίου Μελετίου, 11257 Αθήνα, fast food, brand: Everest, cuisine: burger, name: Everest, takeaway: yes, website: everest.com.gr (24m)
- Adil, shop: convenience (26m)
- 150 Πατησίων, Αθήνα, clothes: women, name: ALE, shop: clothes (26m)
- 52 Αγίου Μελετίου, 11257 Αθήνα (26m)
- National Bank of Greece, bank, atm: yes, brand: Εθνική Τράπεζα, brand:el: Εθνική Τράπεζα, brand:en: National Bank of Greece (26m)
- traffic signals, traffic_signals: signal (29m)
- traffic signals, traffic_signals: signal (30m)
- 61 Αγίου Μελετίου, Αθήνα, name: X-phone, shop: mobile_phone (32m)
- 1 Φωκίωνος Νέγρη, Αθήνα, shop: chemist (32m)
- Αντωνάκης, shop: bag (32m)
- 150 Πατησίων, Αθήνα (35m)
- 1 Φωκίωνος Νέγρη, Αθήνα, email: info@kinhtro.gr, facebook: https://el-gr.facebook.com/kinhtroKosmhma, name: Κίνητρο, phone: 2108814313, shop: jewelry, website: www.kinhtro.gr (36m)
- 61 Αγίου Μελετίου, Αθήνα, taxi (36m)
- Romano, clothes: women, shop: clothes (36m)
- 54 Αγίου Μελετίου, 11252 Αθήνα (39m)
- 149 28ης Οκτωβρίου, Αθήνα, clothes: men, name: Homer, shop: clothes (40m)
- 54 Αγίου Μελετίου, Αθήνα, dance:teaching: yes, leisure: dance, name: Horoelxis (43m)
- Zara, brand: Zara, shop: clothes (44m)
- 56 Αγίου Μελετίου, Αθήνα, beauty: nails, name: Azzur, shop: beauty (47m)
- 1 Φωκίωνος Νέγρη, Αθήνα (47m)
- Galerie de beaute, shop: cosmetics (50m)

Within a 75m radius, there are also:
- primary link, destination: Γαλάτσι;Κυψέλη, destination:lang:el-Latn: Galatsi, lanes: 1, lit: yes, maxspeed: 50km/h, oneway: yes, sidewalk: right, smoothness: excellent, surface: asphalt
- Φωκίωνος Νέγρη (oneway asphalt road), lane_markings: no
- 28is Oktovriou (oneway 2-lane asphalt road, lit), (Πατησίων), old_name:en: Patision Street, shoulder: no, smoothness: excellent, trolley_wire: yes
- Agiou Meletiou (oneway 1-lane asphalt road), maxspeed: 30km/h
- Agiou Meletiou (oneway 1-lane asphalt road, lit), maxspeed: 30km/h, smoothness: excellent
- Agiou Meletiou (oneway 1-lane asphalt road)
- 28is Oktovriou (oneway 2-lane asphalt road, lit), (Πατησίων), trolley_wire: yes
- 149 Πατησίων, 11257 Αθήνα
- 151 28ης Οκτωβρίου, 11251 Αθήνα
- 147 28ης Οκτωβρίου, 11257 Αθήνα
- 28is Oktovriou (oneway 2-lane asphalt road, lit), (Πατησίων), trolley_wire: yes
- Patision (twoway 4-lane asphalt road, lit), lanes:backward: 2, lanes:bus:backward: 1, lanes:bus:forward: 1, lanes:forward: 2, maxspeed: 50km/h, smoothness: excellent, source:name: Sign, trolley_wire: yes
- footway, footway: crossing, lit: yes
- footway, footway: crossing, lit: yes
- 2Α Χανίων, Αθήνα, height: 21, roof:material: concrete, roof:shape: flat
- addr:housenumber: 2, addr:street: Χανίων, height: 24, roof:material: concrete, roof:shape: flat
- addr:housenumber: 142, addr:street: Πατησίων, height: 21, roof:material: concrete, roof:shape: flat
- height: 21, roof:material: concrete, roof:shape: flat
- addr:housenumber: 1, addr:street: Χανίων, height: 21, roof:material: concrete, roof:shape: flat
- height: 24, roof:material: concrete, roof:shape: flat
- height: 12, roof:material: concrete, roof:shape: flat
- height: 15, roof:material: roof_tiles, roof:shape: hipped
- 56 Αγίου Μελετίου, Αθήνα
- Χανίων (paving_stones road)
- 28is Oktovriou (oneway 2-lane asphalt road, lit), (Πατησίων), trolley_wire: yes
- 28is Oktovriou (oneway 2-lane asphalt road, lit), (Πατησίων), old_name:en: Patision Street, shoulder: no, smoothness: excellent, trolley_wire: yes
