...
The tourist is currently located at these coordinates: 52°28'55.24"N, 1°53'34.71"W (52.48201224867766, -1.8929748662104078).
...
- Bannatyne's, leisure: fitness_centre (4m)
- artwork:location: onbuilding wall access walkway to carpark, artwork_type: mosaic, tourism: artwork (9m)
- PQ8 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000208402, naptan:Bearing: E, naptan:CommonName: Argos, naptan:Indicator: Stop PQ8, naptan:NaptanCode: nwmajgtj, naptan:PlusbusZoneRef: BHAMNWS, naptan:Street: THE PRIORY QUEENSWAY, public_transport: platform, route_ref: 61;63;X21;X22, shelter: yes (15m)
- entrance: yes, level: 1 (16m)
- elevator (18m)
- entrance: yes, level: 0 (20m)
- traffic_sign: variable_message (22m)
- parking entrance (25m)
- maxheight: 2.8 (28m)
- Hobgoblin Music, addr:housenumber: 40, addr:postcode: B4 7LA, addr:street: The Priory Queensway, email: Birmingham@hobgoblin.co.uk, opening_hours: Mo-Sa 10:00-18:00; Su 11:00-16:00, shop: music, website: https://hobgoblin.com/ (29m)
- PQ7 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000208401, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Old Square, naptan:Indicator: Stop PQ7, naptan:NaptanCode: nwmajgtg, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: THE PRIORY QUEENSWAY, naptan:Towards: Duddeston, Saltley and Alum Ro, public_transport: platform, shelter: yes (32m)
- PQ13 ( road), bus: yes, naptan:AtcoCode: 43000207604, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Bus Mall, naptan:Indicator: Stop PQ13, naptan:NaptanCode: nwmajgmp, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: THE PRIORY QUEENSWAY, naptan:Towards: Snow Hill Interchange, Handswo, public_transport: platform, route_ref: 65;67, shelter: yes (34m)
- age: semi-mature, constituency: City Centre, genus: Platanus, height: 15, height:range: 14 to 14.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100015, ref:usrn: 2702381, site_name: THE PRIORY QUEENSWAY, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (35m)
- ticket validator, operator: Transport for West Midlands, operator:short: TfWM, payment:swift_card: yes (38m)
- bench (39m)
- bench (40m)
- entrance: yes (40m)
- Scruffy Murphy's, pub (40m)
- bench (41m)
- PQ9 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000207601, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Bus Mall, naptan:Indicator: Stop PQ9, naptan:NaptanCode: nwmajgmd, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: THE PRIORY QUEENSWAY, naptan:Towards: Saltley, Washwood Heath and Br, public_transport: platform, route_ref: 65;66;67, shelter: yes (47m)
...
- The Priory Queensway (twoway 2-lane asphalt bridge, lit), access: no, bicycle: yes, bus: yes, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B4, psv: yes, taxi: yes
- The Priory Queensway (twoway 2-lane asphalt road, lit), access: no, bicycle: yes, bus: yes, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B4, psv: yes, taxi: yes
- 46 The Priory Queensway, B4 7LR Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/The McLaren Building, architect: Bonham, building:levels: 21, height: 69, name: McLaren Building, start_date: 1972
- unclassified
- footway
...
- Londonderry House, parking, capacity: 720, operator: National Car Parks, operator:type: private, parking: multi-storey
- 2 Newton Street, B4 6NB Birmingham, height: 55, name: Londonderry House
- The Square, architect: Sir Frederick Gibberd, start_date: 1963
- footway, bridge: yes
- footway, lit: yes, surface: paving_stones
- Dale End (asphalt road, lit), cycleway: shared_lane, gritting: priority_3, maintenance: gritting, maxheight: 2.8, maxspeed: 20 mphkm/h, motor_vehicle: destination, postal_code: B4
- Dale End (2-lane asphalt road, lit), cycleway:both: shared_lane, cycleway:both:lane: pictogram, gritting: priority_3, maintenance: gritting, maxheight: default, maxspeed: 20 mphkm/h, motor_vehicle: destination, postal_code: B4, sidewalk: both
- footway, level: 1, surface: paving_stones
- footway, bridge: yes, level: 1
- service, service: driveway
- footway, surface: paved
- footway, bridge: yes, surface: paved
- Dalton Street ( road, lit), maxspeed: 20 mphkm/h, postal_code: B4, sidewalk: both
