...
Tourist: a Transgender Woman, 21 years old, traveling on foot and solo.

It is Tuesday, Mar 11, 2025, 9:37 AM local time.

The tourist is currently located at these coordinates: 51°46'57.42"N, 19°30'21.22"E (51.7826161984877, 19.50589552916923).
Name of Road: Telefoniczna
Name of neighborhood: 
City district: Łódź-Widzew
City: lodz
Admin district: Łódź Voivodeship, Central Macroregion, Poland (land mass) (Stoki-Sikawa-Podgórze, Sikawa, Łódź-Widzew, Łódź, województwo łódzkie, Makroregion centralny, Polska (ląd))

The following points of interest are within a 75m radius (with distance in meters):
- 29 Telefoniczna, Łódź, source:addr: EMUiA (emuia.geoportal.gov.pl) (35m)

Within a 75m radius, there are also:
- barrier: fence
- LWN 110kV Janów–Źródłowa, cables: 3, frequency: 50, operator: PGE Dystrybucja, power: line, voltage: 110000
- Telefoniczna (2-lane asphalt road), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Telefoniczna w Łodzi, maxspeed: 50km/h, sidewalk:both: separate, smoothness: excellent, unsigned_ref: 1208E
- footway, footway: sidewalk, surface: paving_stones
- service, service: driveway
- Wzniesienia Łódzkie, Dość urozmaicony krajobrazowo region, w którym zlokalizowana jest Łódź, z dominacją peryglacjalnego krajobrazu pagórkowatego, w obrębie którego występują płaty krajobrazu wzgórzowego, związanego z kulminacjami moren czołowych (z maksimum
...
In your rating, emphasize the tourist's current location (Stoki-Sikawa-Podgórze) and the nearby POIs over country-level information.
