...
The tourist is currently located at these coordinates: 52°29'2.57"N, 1°53'54.62"W (52.48404708507682, -1.898506158598428).
Name of Road: Snow Hill Queensway
...
- entrance: main (11m)
- age: new planting, constituency: City Centre, height: 5, height:range: 4 to 4.99m, plot_number: 100005, ref:usrn: 2702276, site_name: SNOW HILL QUEENSWAY, tree_form: natural, ward: Ladywood (13m)
- SQ2 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000207205, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Lloyd House, naptan:Indicator: Stop SQ2, naptan:NaptanCode: nwmajgjd, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: SNOW HILL QUEENSWAY, naptan:Towards: City Hospital, public_transport: platform, route_ref: 16;16A;16W;424;424E, shelter: yes (15m)
- age: new planting, constituency: City Centre, height: 5, height:range: 4 to 4.99m, plot_number: 100007, ref:usrn: 2702276, site_name: SNOW HILL QUEENSWAY, tree_form: natural, ward: Ladywood (17m)
- elevator (18m)
- Snow Hill Queensway, B4 6WR Birmingham, name: Wragge Lawrence & Graham, office: lawyer (20m)
- entrance: yes (21m)
- HS2, office: company (23m)
- SQ3 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000207206, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Lloyd House, naptan:Indicator: Stop SQ3, naptan:NaptanCode: nwmajgjg, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: SNOW HILL QUEENSWAY, naptan:Towards: xxx, public_transport: platform, route_ref: 74, shelter: yes (26m)
- age: young, constituency: City Centre, genus: Platanus, height: 9, height:range: 8 to 8.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100004, ref:usrn: 2702276, site_name: SNOW HILL QUEENSWAY, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (29m)
- SQ5 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000207202, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Lloyd House, naptan:Indicator: Stop SQ5, naptan:NaptanCode: nwmajgdt, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: SNOW HILL QUEENSWAY, naptan:Towards: Snow Hill Interchange, public_transport: platform, route_ref: 9;83;89;120;127;128;129;140;X10, shelter: yes (29m)
- fire hydrant (underground), operator: WMFS (31m)
- entrance: main (33m)
- SQ4 ( road, lit), bench: yes, bin: no, bus: yes, naptan:AtcoCode: 43000207201, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Lloyd House, naptan:Indicator: Stop SQ4, naptan:NaptanCode: nwmajgdp, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: SNOW HILL QUEENSWAY, naptan:Towards: Snow Hill Interchange, public_transport: platform, route_ref: 10, shelter: no (33m)
- age: new planting, constituency: City Centre, height: 5, height:range: 4 to 4.99m, plot_number: 100008, ref:usrn: 2702276, site_name: SNOW HILL QUEENSWAY, tree_form: natural, ward: Ladywood (35m)
- age: young, constituency: City Centre, genus: Platanus, height: 9, height:range: 8 to 8.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100003, ref:usrn: 2702276, site_name: SNOW HILL QUEENSWAY, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (37m)
- entrance: yes (37m)
- 2 Snow Hill Queensway, B4 6GA Birmingham, name: The National Lottery Heritage Fund - Midlands & East, office: government, opening_hours: Mo-Fr 09:00-17:00, phone: +44 121 393 4734, website: https://www.heritagefund.org.uk/in-your-area/midlands-east (38m)
- SQ1 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000207204, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Lloyd House, naptan:Indicator: Stop SQ1, naptan:NaptanCode: nwmajgja, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: SNOW HILL QUEENSWAY, naptan:Towards: Hockley, Hamstead and Newtown, public_transport: platform, route_ref: 7;46, shelter: yes (38m)
- bench (41m)
- bench (41m)
- bench (43m)

Within a 75m radius, there are also:
- Snow Hill Queensway (4-lane paved road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B4
- Livery St Car Park, (Snow Hill Car Park), parking, access: yes, fee: yes, level: 1, parking: multi-storey
- Colmore Circus Queensway, B4 6AT Birmingham, addr:housename: Lloyd House, architect: Kelly & Sturman, height: 59, name: West Midlands Police HQ (Lloyd House), start_date: 1962
- Snow Hill Queensway, B4 6GN Birmingham, addr:housename: One Snowhill, building:levels: 12, height: 56, name: One Snowhill
- pedestrian, area: yes, lit: yes, surface: paving_stones
- Snow Hill Queensway, B4 6GA Birmingham, addr:housename: Two Snowhill, building:levels: 15, height: 75, name: Two Snowhill
