...
The tourist is currently located at these coordinates: 60°11'15.62"N, 24°57'13.49"E (60.18767182120028, 24.953747909717357).
Name of Road: Helsinginkuja
...
- barrier: lift_gate (7m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella J] (24m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella J] (26m)
- traffic_sign: FI:372 (28m)
- door:buzzer: yes, entrance: staircase (28m)
- crossing, marked (29m)
- manhole: heat (31m)
- 21 Fleminginkatu, Helsinki, restaurant, cuisine: vietnamese, diet:halal: no, diet:kosher: no, name: Namnam, opening_hours: Tu-Fr 10:30-19:00; Sa 12:00-19:00, payment:credit_cards: yes, payment:debit_cards: yes, website: https://cafenamnam.com/ (33m)
- traffic_sign: FI:511 (33m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella J] (34m)
- crossing, marked (35m)
- entrance: staircase (36m)
- crossing, marked (36m)
- traffic_sign: FI:531;FI:533 (37m)
- Helsinginkatu, bench: yes, bin: yes, departures_board: multiline, lit: yes, public_transport: platform, railway: tram_stop, shelter: yes, shelter:ref: 1776, tram: yes, wheelchair: yes, zone:HSL: A (37m)
- addr:housenumber: 19, addr:street: Helsinginkatu (38m)
- crossing, marked (38m)
- traffic_sign: FI:152, traffic_sign:2: FI:363[30] (43m)

Within a 75m radius, there are also:
- Kaarlenkuja (residential oneway 1-lane asphalt road), maxspeed: 30km/h, parking:condition:reason: junction
- platform, lit: yes, public_transport: platform, shelter: yes
- footway, bicycle: no, footway: sidewalk, lit: yes, surface: asphalt
- barrier: hedge
- Helsinginkuja (1-lane asphalt road), FIXME:parking: Tarkista asukaspysäköintitunnus, maxspeed: 30km/h, motorcar: destination, parking:condition:both: ticket, parking:condition:both:residents: I, parking:condition:both:time_interval: Mo-Fr 09:00-19:00, parking:lane:both:parallel: on_street
- Helsinginkuja ( road), maxspeed: 30km/h, motorcar: destination, parking:lane:right: no_stopping
...
- Fleminginkatu (2-lane asphalt road, lit), bicycle: yes, embedded_rails: tram, fi:hkr:kunnossapitoluokka: II, loc_name: Flemari, maxspeed: 30km/h, motor_vehicle: destination, parking:condition:left:default: free, parking:condition:left:residents: J, parking:condition:left:time_interval: Mo-Fr 09:00-21:00, parking:lane:left: parallel, parking:lane:left:parallel: lay_by, parking:ticket:zone: 3, paved:date: 2008, sidewalk: separate, tram:lanes:backward: yes, tram:lanes:forward: yes
...
- Helsinginkuja (asphalt road), maxspeed: 30km/h, motorcar: destination
...
- service, motor_vehicle: private, service: parking_aisle, surface: paved
- barrier: fence
- barrier: fence
- addr:housenumber: 21a, addr:street: Fleminginkatu, building:levels: 6, building:maintenance:operator: Kanta-Helsingin Kiinteistöhuolto Oy, roof:levels: 0
- addr:housenumber: 21b, addr:street: Fleminginkatu, building:levels: 6, building:maintenance:operator: Kanta-Helsingin Kiinteistöhuolto Oy, roof:levels: 0
- Fleminginkatu (2-lane asphalt road, lit), bicycle: yes, bus: yes, divider: solid_line, embedded_rails: tram, fi:hkr:kunnossapitoluokka: II, hazard: children, huoltoajo: yes, loc_name: Flemari, maxspeed: 30km/h, parking:condition:reason: tram, parking:lane:right: no_stopping, paved:date: 2008, source:hazard: traffic_sign, taxi: yes, tram:lanes:backward: yes, tram:lanes:forward: yes
- barrier: fence
...
- Fleminginkatu (2-lane asphalt road, lit), bicycle: yes, bus: yes, embedded_rails: tram, fi:hkr:kunnossapitoluokka: II, hazard: children, huoltoajo: yes, loc_name: Flemari, maxspeed: 30km/h, parking:condition:reason: tram, parking:lane:right: no_stopping, paved:date: 2008, sidewalk: separate, source:hazard: traffic_sign, taxi: yes, tram:lanes:backward: yes, tram:lanes:forward: yes
- electrified: contact_line, frequency: 0, gauge: 1000, oneway: yes, operator: HKL-Raitioliikenne, railway: tram, start_date: 2008-07, tram:segregation:physical: in_lane, voltage: 600
...
- addr:housenumber: 6, addr:street: Helsinginkuja, building:levels: 5, operator: Helsingin Berkka, start_date: 2023-11
- Helsinginkuja (1-lane paved road), FIXME:parking: Tarkista asukaspysäköintitunnus, maxspeed: 30km/h, motorcar: destination, parking:condition:both: ticket, parking:condition:both:residents: I, parking:condition:both:time_interval: Mo-Fr 09:00-19:00, parking:lane:both:parallel: on_street
