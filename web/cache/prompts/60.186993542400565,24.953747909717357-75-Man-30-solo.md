...
The tourist is currently located at these coordinates: 60°11'13.18"N, 24°57'13.49"E (60.186993542400565, 24.953747909717357).
...
- entrance: staircase (9m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 10, covered: no, fee: no (10m)
- advertising: sign, lit: yes (11m)
- Helsinginkatu, bench: yes, bin: yes, departures_board: realtime, lit: yes, public_transport: platform, railway: tram_stop, shelter: yes, wheelchair: yes, zone:HSL: A (11m)
- location: overhead, traffic_sign: FI:413[left] (13m)
- advertising: sign, lit: yes (15m)
- traffic_signals: signal, traffic_signals:foot: yes (15m)
- location: overhead, traffic_sign: FI:414[right] (16m)
- 16 Helsinginkatu, Helsinki (16m)
- 1981 Helsinki, email: info@1981helsinki.fi, opening_hours: tu-th 12:00-17:00; fr 14:00-19:00; sa 12:00-17:00, shop: clothes, website: https://1981helsinki.fi/ (17m)
- entrance: staircase (17m)
- traffic signals, cycleway: asl (17m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: yes, traffic_signals:vibration: no (17m)
- entrance: staircase (18m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: yes, traffic_signals:vibration: no (18m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 10, covered: no, fee: no (19m)
- man_made: utility_pole, material: steel, traffic_sign: FI:648[FI:811[right] FI:312 FI:851[23-06(23-06)23-06], traffic_sign:2: FI:152, traffic_sign:3: FI:372, traffic_sign:4: FI:855a[9-21], traffic_sign:5: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I/J], traffic_sign:6: FI:825 (19m)
- noexit: yes (20m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: yes, traffic_signals:vibration: no (20m)
- traffic_sign: FI:371, traffic_signals: signal, traffic_signals:foot: yes (21m)
- advertising: column (22m)
- traffic_signals:button: yes, traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes (22m)
- man_made: utility_pole, material: steel, traffic_sign: FI:417, traffic_signals: signal, traffic_signals:motor_vehicle: yes (22m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: yes, traffic_signals:vibration: no (22m)
- Helsinki, fast food, diet:halal: no, diet:kosher: no, name: Hesarin grilli, payment:credit_cards: yes, payment:debit_cards: yes (22m)
- 16 Helsinginkatu, Helsinki, name: Recci, was:shop: clothes (23m)
- was:name: Akvaario Arena, was:shop: pet (24m)
- traffic_sign: FI:372, traffic_sign:2: FI:851[8-17] (26m)
- advertising: sign (27m)
- traffic_sign: FI:231, traffic_signals: signal, traffic_signals:detector: remote_sensing, traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes (29m)
- entrance: staircase, man_made: flagpole (29m)
- Wanha Apteekki, pub, opening_hours: Su-Th 15:00-02:00; Fr-Sa 15:00-04:30, website: https://www.wanhaapteekki.com/ (32m)
- graffiti:tag: KC, power: box (32m)
- traffic_sign: FI:312, traffic_sign:2: FI:851[23-06 (23-06) 23-06], traffic_sign:3: FI:871[Ei koske -tontilleajoa -huoltoajoa -P-tunnuksella J -linja-autoja -takseja], traffic_sign:4: FI:871[Samma på svenska], traffic_signals: signal, traffic_signals:foot: yes (33m)
- 17 Fleminginkatu, Helsinki (33m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: yes, traffic_signals:vibration: no (34m)
...
- door:buzzer: yes, entrance: staircase (36m)
- Happy Hand, payment:credit_cards: yes, payment:debit_cards: yes, shop: second_hand (38m)
- traffic signals, highway:give_way: yes (38m)
- man_made: utility_pole, material: steel, traffic_sign: FI:363[40] (39m)
- Helsinki, atm, indoor: no, name: Otto., operator: Suomen Automatia Oy (39m)
- location: overhead, traffic_sign: FI:414[right] (40m)
- 19 Helsinginkatu, Helsinki, (Hurstinapu), social facility, name: Laupeudentyö, operator: Veikko & Lahja Hursti, social_facility: food_bank, social_facility:for: underprivileged (41m)
- location: overhead, traffic_sign: FI:413[left] (42m)
- ele: 17, source:ele: barometric*1 (44m)
- traffic_sign: FI:363[30], traffic_sign:2: FI:372, traffic_sign:3: FI:855a[9-21], traffic_sign:4: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I], traffic_sign:5: FI:871[← Lippuautomaatti] (45m)
- Rõõm, payment:credit_cards: yes, payment:debit_cards: yes, shop: gift (48m)
...
- Fleminginkatu (2-lane asphalt road, lit), bicycle: yes, bus: yes, embedded_rails: tram, fi:hkr:kunnossapitoluokka: II, huoltoajo: yes, loc_name: Flemari, maxspeed: 40km/h, parking:condition:reason: tram, parking:lane:right: no_stopping, paved:date: 2008, taxi: yes, tram:lanes:backward: yes, tram:lanes:forward: yes
- footway, bicycle: no, footway: sidewalk, lit: yes, smoothness: good, snowplowing: yes, surface: asphalt
- footway, lit: yes, smoothness: intermediate, surface: asphalt
- platform, bench: yes, lit: yes, public_transport: platform, shelter: yes, surface: paving_stones
- Fleminginkatu (3-lane asphalt road), fi:hkr:kunnossapitoluokka: II, lanes:backward: 2, loc_name: Flemari, maxspeed: 30km/h
- Helsinginkatu (oneway 1-lane asphalt road, lit), cycleway:right: lane, loc_name: Hesari, maxspeed: 40km/h, snowplowing: yes
- platform, lit: yes, public_transport: platform, shelter: yes
- footway, bicycle: no, footway: sidewalk, lit: yes, surface: asphalt
- footway, bicycle: no, footway: sidewalk, lit: yes, surface: asphalt
- footway, bicycle: no, footway: sidewalk, lit: yes, surface: asphalt
- Helsinginkatu (oneway 2-lane asphalt road, lit), cycleway:right: lane, hazard: children, loc_name: Hesari, maxspeed: 40km/h, snowplowing: yes, source:hazard: traffic_sign
- barrier: fence
...
- Fleminginkatu (3-lane asphalt road), fi:hkr:kunnossapitoluokka: II, lanes:backward: 2, loc_name: Flemari, maxspeed: 30km/h, parking:condition:right: ticket, parking:condition:right:default: free, parking:condition:right:residents: I, parking:condition:right:time_interval: Mo-Fr 09:00-19:00, parking:lane:left: no_stopping, parking:lane:right: parallel, parking:ticket:zone: 3
- addr:street: Helsinginkatu, building:levels: 8, building:maintenance:operator: Kallion Talohuolto
- Aadolfinkatu (residential oneway 1-lane asphalt road), maxspeed: 30km/h, oneway:bicycle: no
- Fleminginkatu (2-lane asphalt road, lit), bicycle: yes, cycleway:both: no, embedded_rails: tram, fi:hkr:kunnossapitoluokka: II, loc_name: Flemari, maxspeed: 30km/h, parking:condition:reason: junction, smoothness: good
- building:levels: 7, building:maintenance:operator: Tark-Huolto, roof:levels: 0
...
- location: overhead, man_made: beam
- 19 Helsinginkatu, 00500 Helsinki, building:levels: 1, diet:halal: no, diet:kosher: no, name: Kiosk, payment:credit_cards: yes, payment:debit_cards: yes, shop: convenience, website: https://nyt.fi/a1305849419900
- barrier: fence
- Fleminginkatu (2-lane asphalt road, lit), bicycle: yes, bus: yes, cycleway:both: no, divider: solid_line, embedded_rails: tram, fi:hkr:kunnossapitoluokka: II, huoltoajo: yes, loc_name: Flemari, maxspeed: 40km/h, parking:condition:reason: tram, parking:lane:right: no_stopping, paved:date: 2008, taxi: yes, tram:lanes:backward: yes, tram:lanes:forward: yes
...
- electrified: contact_line, frequency: 0, gauge: 1000, oneway: yes, operator: HKL-Raitioliikenne, railway: tram, start_date: 2008-07-10, tram:segregation:physical: in_lane, voltage: 600
...
- electrified: contact_line, frequency: 0, gauge: 1000, oneway: yes, operator: HKL-Raitioliikenne, railway: tram, tram:segregation:physical: junction, voltage: 600
- electrified: contact_line, frequency: 0, gauge: 1000, last_renovation: 2015, oneway: yes, operator: HKL-Raitioliikenne, railway: tram, tram:segregation:physical: in_lane, voltage: 600
