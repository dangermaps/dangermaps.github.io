...
The tourist is currently located at these coordinates: 52°28'57.69"N, 1°53'42.67"W (52.48269052747738, -1.8951873831656159).
...
- 10 The Priory Queensway, B4 6BS Birmingham, dentist, healthcare: dentist, name: Smiles Plus (3m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (12m)
- entrance: yes, operator: Canon House (13m)
- PQ6 ( road, unlit), bench: no, bin: no, bus: yes, naptan:AtcoCode: 43000208503, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Colmore Circus, naptan:Indicator: Stop PQ6, naptan:NaptanCode: nwmwgpmd, naptan:PlusbusZoneRef: West Midlands, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: THE PRIORY QUEENSWAY, naptan:Towards: xxx, public_transport: platform, route_ref: 16;16A;16W;110;424;424E;X16, shelter: no (14m)
- fire hydrant (underground), operator: WMFS (15m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: pelican, traffic_signals:sound: yes, traffic_signals:vibration: no (16m)
- Priory, cafe (18m)
- Snow+Rock, brand: Snow+Rock, contact:website: https://www.snowandrock.com/stores/birmingham.html, shop: outdoor (21m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: pelican, traffic_signals:sound: yes, traffic_signals:vibration: no (27m)
- entrance: yes (30m)
- PQ4 ( road), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000208501, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Colmore Circus, naptan:Indicator: Stop PQ4, naptan:NaptanCode: nwmwdawj, naptan:PlusbusZoneRef: West Midlands, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: THE PRIORY QUEENSWAY, naptan:Towards: Hockley, Hamstead, Handsworth, public_transport: platform, route_ref: 74, shelter: yes (30m)
- Old Square, bicycle rental, capacity: 9, email: support@beryl.cc, fee: yes, network: West Midlands Cycle Hire, network:regional: Starley, official_name: Old Square, operator: Beryl, payment:app: yes, payment:cash: no, payment:credit_cards: no, payment:cryptocurrencies: no, payment:debit_cards: no, phone: +44 20 3003 5044, ref:gbfs: beryl_west_midlands:2755, ref:wmch: 4, rental: city_bike;ebike, website: https://beryl.cc/scheme/west-midlands (31m)
- 2-4 The Priory Queensway, B4 6BS Birmingham, disused:amenity: bank, old_name: TSB, source:addr:postcode: code-point_open (32m)
- man_made: street_cabinet (34m)
- man_made: surveillance (35m)
- Colmore Circus Queensway, B4 6SH Birmingham (37m)
- Salts Medilink, office: medical, opening_hours: Mo-Fr 09:00-17:00, phone: +44 121 333 1596, website: https://www.saltsmedilink.co.uk/dispensing-care-centres/birmingham-central (37m)
- Old Square outside Snow and Rock, bicycle parking, bcc_ref: 262, bicycle_parking: stands, capacity: 16, covered: no (37m)
- Snow Hill Queensway, B4 6FD Birmingham (39m)
- entrance: yes, operator: Two Colmore Square (45m)
- parking, access: customers, operator: Voi, operator:type: private, parking: e-scooter (47m)
- Colmore Circus, bicycle rental, bicycle_rental: docking_station, capacity: 12, email: support@beryl.cc, fee: yes, network: West Midlands Cycle Hire, network:regional: Starley, official_name: Colmore Circus, operator: Beryl, payment:app: yes, payment:cash: no, payment:credit_cards: no, payment:cryptocurrencies: no, payment:debit_cards: no, phone: +44 20 3003 5044, ref:gbfs: beryl_west_midlands:2824, ref:wmch: 61, rental: city_bike;ebike, website: https://beryl.cc/scheme/west-midlands (50m)
...
- 2 Colmore Circus Queensway, B4 6BN Birmingham, building:levels: 7, name: Two Colmore Square
- The Lewis Buidling, architect: Gerald de Courcy Fraser, start_date: 1924
- Newton Street, B4 6NE Birmingham, courthouse, architect: Peacock & Bewlay, name: Coroner's Court, start_date: 1936
- 8 The Priory Queensway, B4 6BS Birmingham, building:levels: 6, name: Cannon House
- Old Square (2-lane asphalt road, lit), gritting: priority_3, junction: roundabout, maintenance: gritting, maxspeed: 20 mphkm/h
- Colmore Circus Queensway (2-lane asphalt road, lit), access: destination, bicycle: yes, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B4, psv: yes
