...
The tourist is currently located at these coordinates: 52°13'20.22"N, 21°1'1.5"E (52.22228453233858, 21.017083918033546).
Name of Road: Plac Konstytucji
...
- fire hydrant (underground) (3m)
- tourism information, information: guidepost (9m)
- street lamp (10m)
- Dom Wschodni, community centre, addr:housenumber: 6, addr:street: Plac Konstytucji, operator: Ośrodek Karta, wheelchair: yes (11m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (12m)
- street lamp (13m)
- waste basket, material: concrete (13m)
- crossing, uncontrolled, crossing_ref: zebra (20m)
- 6 Plac Konstytucji, 00-550 Warszawa, name: W. Kruk, opening_hours: Mo-Fr 11:00-19:00; Sa 10:00-14:00, shop: jewelry, website: http://wkruk.pl/punktyodbioru-w-kruk-warszawa-plac-konstytucji,p4, wheelchair: yes (21m)
- street lamp (22m)
- direction: 250, traffic_sign: PL:B-43[30] (23m)
- Plac Konstytucji 10 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: no (23m)
- street lamp (28m)
- bicycle parking, bicycle_parking: stands, capacity: 12, covered: no (29m)
- Bollywood Curry, addr:housenumber: 6, addr:street: Plac Konstytucji, cuisine: indian, disused:amenity: restaurant, opening_hours: 11:30-22:30, outdoor_seating: yes, wheelchair: no (29m)
- street lamp (33m)
- Stefan Majchrowski, historic: memorial, memorial: plaque (33m)
- Plac Konstytucji 02 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: yes (33m)
- Plac Konstytucji 10, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position (33m)
- 6 Plac Konstytucji, 00-550 Warszawa, disused:craft: watchmaker, wheelchair: yes (36m)
- noexit: yes (40m)
- bicycle parking, bicycle_parking: stands, capacity: 4, covered: no (42m)

Within a 75m radius, there are also:
- Koszykowa (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
- Marszałkowska (oneway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:both: no, sidewalk: separate, smoothness: excellent
- service, cycleway:both: no, lanes: 1, lit: yes, oneway: yes, service: parking_aisle, surface: asphalt
...
- 4 Plac Konstytucji, 00-552 Warszawa, addr:city:simc: 0918123, building:levels: 7, historic: yes, roof:levels: 1, roof:shape: flat, source:addr: gugik.gov.pl
- Koszykowa (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, cycleway:left: opposite_lane, maxspeed: 30km/h, oneway:bicycle: no, sidewalk: separate
- area:highway: footway, lit: yes
- area:highway: footway, lit: yes
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- Koszykowa (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, cycleway:left: opposite_lane, maxheight: default, maxspeed: 30km/h, oneway:bicycle: no, sidewalk: separate, tunnel: building_passage
- service, access: private, service: driveway
- building:colour: #e9d8c5, building:material: concrete, height: 0.1, man_made: obelisk, note:pl: schodek, roof:colour: #e9d8c5, roof:material: concrete
- building:colour: #e9d8c5, building:material: concrete, building:part: yes, height: 0.3, min_height: 0.2, note:pl: schodek, roof:colour: #e9d8c5, roof:material: concrete
- building:colour: #e9d8c5, building:material: concrete, building:part: yes, height: 0.2, min_height: 0.1, note:pl: schodek, roof:colour: #e9d8c5, roof:material: concrete
- 6 Plac Konstytucji, 00-550 Warszawa, See Wikipedia: https://pl.wikipedia.org/wiki/Marszałkowska Dzielnica Mieszkaniowa, addr:city:simc: 0918123, building:levels: 0.5, height: 0.1, historic: yes, roof:shape: flat, source:addr: gugik.gov.pl
- building:colour: #e9d8c5, building:levels: 9, building:material: sandstone, building:min_level: 8, building:part: yes, roof:colour: #9c7878
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 8, building:material: concrete, building:min_level: 2, building:part: yes, roof:colour: #8a8a8a
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 1, building:material: concrete, building:part: yes, roof:colour: #8a8a8a
...
- parking, access: yes, capacity: 8, fee: yes, parking: street_side
- area:highway: yes, junction: yes
- area:highway: bus
- area:highway: secondary
- area:highway: service
- parking, access: yes, capacity: 13, fee: yes, parking: street_side
- parking, access: yes, capacity: 19, capacity:disabled: 3, fee: yes, parking: street_side
- area:highway: footway, lit: yes
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
- 30 Koszykowa, 00-553 Warszawa, addr:city:simc: 0918123, building:levels: 4, historic: yes, source:addr: gugik.gov.pl
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, lit: yes, surface: paving_stones, tunnel: building_passage
- barrier: bollard, bollard: unremovable, material: metal
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:both: no, sidewalk: separate, smoothness: excellent
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:both: no, maxspeed: 50km/h, sidewalk: separate, smoothness: excellent
- footway, lit: yes, surface: paving_stones, tunnel: building_passage
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- barrier: fence
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- Koszykowa (residential 2-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, cycleway:both: no, maxspeed: 50km/h, sidewalk: separate
- building:colour: #e9d8c5, building:levels: 8, building:material: concrete, building:part: yes
- area:highway: residential
