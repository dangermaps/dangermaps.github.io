...
The tourist is currently located at these coordinates: 6°14'43.33"N, 75°34'22.45"W (6.245369504086709, -75.57290297664353).
Name of Road: San Juan
...
- crossing, traffic_signals (27m)
- crossing, uncontrolled (32m)
- traffic signals (33m)
- Fotodetección ( road), Direccion: Calle 44 x Carrera 53 - Municipio: Medellin, maxspeed: 60km/h (34m)
- crossing, traffic_signals (36m)
- palmera (48m)

Within a 75m radius, there are also:
- San Juan (oneway 3-lane asphalt road)
- San Juan (oneway 3-lane asphalt road)
- Centro Administrativo La Alpujarra, official_name: Centro Administrativo José María Córdoba
- Parque de Las Luces, leisure: park
- Calle 44 (oneway 4-lane asphalt road), (San Juan)
- Calle 44 (oneway 4-lane asphalt road), (San Juan), maxspeed: 60km/h
- service, maxspeed: 10km/h, oneway: yes
- footway, zebra, footway: crossing
- Plazoleta de la Alpujarra (asphalt road), area: yes
- leisure: garden
- Cceso al Sotano del Palacio de Justicia, service
...
- Ciclorruta San Juan (asphalt road), bicycle: yes, segregated: yes, width: 2.5
- leaf_type: broadleaved
- leaf_type: broadleaved
- San Juan (oneway 2-lane asphalt road)
