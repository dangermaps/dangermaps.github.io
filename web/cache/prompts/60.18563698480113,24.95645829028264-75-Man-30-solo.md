...
The tourist is currently located at these coordinates: 60°11'8.29"N, 24°57'23.25"E (60.18563698480113, 24.95645829028264).
Name of Road: Torkkelinkatu
...
- access: private, addr:housenumber: 9, addr:street: Torkkelinkatu, entrance: staircase (4m)
- With keycode, access: private, addr:housenumber: 7, addr:street: Torkkelinkatu, entrance: staircase (12m)
- 7 Torkkelinkatu, Helsinki (14m)
- With keycode, access: private, addr:housenumber: 11, addr:street: Torkkelinkuja, entrance: staircase, wheelchair: no (16m)
- With keycode, access: private, addr:housenumber: 11, addr:street: Torkkelinkatu, entrance: staircase (17m)
- entrance: secondary (21m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I], traffic_sign:4: FI:871[← Lippuautomaatti] (27m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I] (29m)
- With keycode, access: private, addr:housenumber: 13, addr:street: Torkkelinkatu, entrance: staircase (31m)
- vending machine, currency:EUR: yes, opening_hours: Mo-Fr 09:00-19:00, operator: HKR, parking:ticket:zone: 3, vending: parking_tickets (32m)
- crossing, uncontrolled, check_date:crossing: 2023-08-12 (32m)
- traffic_sign: FI:511, traffic_sign:2: FI:331 (34m)
- traffic_sign: FI:331 (34m)
- bench, backrest: yes (35m)
- bench, backrest: yes (35m)
- unmarked (35m)
- traffic_sign: FI:372 (37m)
- traffic_sign: FI:511 (39m)
- entrance: secondary (39m)
- crossing, uncontrolled, check_date:crossing: 2020-12-05 (39m)
- With buzzer, access: private, addr:housenumber: 28, addr:street: Torkkelinkuja, addr:unit: A, entrance: staircase, wheelchair: yes (40m)
- 30 Torkkelinkuja, Helsinki (41m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I] (42m)
- 5 Torkkelinkatu, Helsinki (48m)
- With buzzer, access: private, addr:housenumber: 5, addr:street: Torkkelinkatu, entrance: staircase, wheelchair: no (49m)

Within a 75m radius, there are also:
- building:levels: 3, building:maintenance:operator: Huoltoalanen Oy, roof:levels: 1
- 9 Torkkelinkatu, Helsinki, building:levels: 4, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy, name: Torkkelinsiivu, roof:levels: 1
- Torkkelinpuistikko, See Wikipedia: https://fi.wikipedia.org/wiki/Torkkelinpuistikko, hoitoluokitus_viheralue: A2, leisure: park
- building:maintenance:operator: Huoltoalanen Oy
- footway, bicycle: no, footway: sidewalk, lit: yes, surface: asphalt, width: 1
- Torkkelinkuja (residential oneway 1-lane paved road, lit), maxspeed: 30km/h, oneway:bicycle: no, parking:condition:right: ticket, parking:condition:right:residents: I, parking:condition:right:time_interval: Mo-Fr 09:00-19:00, parking:lane:left: no_parking, parking:lane:right: parallel, parking:lane:right:parallel: on_street
- footway, lit: yes, surface: paved, width: 1
- Torkkelinkuja (residential oneway 1-lane asphalt road, lit), maxspeed: 30km/h, oneway:bicycle: no
- Torkkelinkuja (residential oneway 1-lane asphalt road, lit), maxspeed: 30km/h, oneway:bicycle: no, parking:condition:right: ticket, parking:condition:right:residents: I, parking:condition:right:time_interval: Mo-Fr 09:00-19:00, parking:lane:left: no_parking, parking:lane:right: parallel, parking:lane:right:parallel: on_street, parking:ticket:zone: 3
- Torkkelinkatu (residential asphalt road), maxspeed: 30km/h, parking:condition:reason: junction, sidewalk:both: separate
- Torkkelinkuja (residential oneway 1-lane paved road, lit), maxspeed: 30km/h
- Torkkelinkuja (residential oneway 1-lane asphalt road, lit), maxspeed: 30km/h, oneway:bicycle: no
- footway, lit: yes, surface: asphalt
- Torkkelinkuja (residential oneway 1-lane paved road, lit), maxspeed: 30km/h, oneway:bicycle: no, parking:lane:left: no_parking, parking:lane:right: no_stopping
- footway, lit: yes, surface: asphalt
- Torkkelinkatu (residential asphalt road, lit), maxspeed: 30km/h, parking:condition:both: ticket, parking:condition:both:default: free, parking:condition:both:residents: I, parking:condition:both:time_interval: Mo-Fr 09:00-19:00, parking:lane:both:parallel: on_street, parking:ticket:zone: 3, sidewalk:both: separate
- Torkkelinkuja (residential oneway 1-lane asphalt road, lit), maxspeed: 30km/h, oneway:bicycle: no, parking:lane:left: no_stopping, parking:lane:right: no_stopping
- footway, lit: yes, surface: asphalt
- footway, surface: fine_gravel
- pedestrian, area: yes, surface: fine_gravel
...
- 11 Torkkelinkatu, Helsinki, building:levels: 4, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy, roof:levels: 1
- 13 Torkkelinkatu, Helsinki, building:levels: 4, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy, roof:levels: 1
- 15 Torkkelinkatu, Helsinki, building:levels: 4, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy, roof:levels: 1
- Pengerpuisto, See Wikipedia: https://fi.wikipedia.org/wiki/Pengerpuisto, hoitoluokitus_viheralue: A2, leisure: park
- Torkkelinkuja (residential oneway 1-lane asphalt road, lit), maxspeed: 30km/h, parking:condition:left: ticket, parking:condition:left:residents: I, parking:condition:left:time_interval: Mo-Fr 09:00-19:00, parking:lane:left: parallel, parking:lane:left:parallel: on_street, parking:lane:right: no_parking
- service, access: no, maxheight: 2.2, trailer: no, tunnel: yes
- footway, lit: yes, surface: asphalt
- Suruton, building:levels: 4, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy, roof:levels: 1
- Torkkelinkuja (residential 1-lane paved road, lit), maxspeed: 30km/h, oneway:bicycle: no, parking:condition:right: ticket, parking:condition:right:residents: I, parking:condition:right:time_interval: Mo-Fr 09:00-19:00, parking:lane:left: no_parking, parking:lane:right: parallel, parking:lane:right:parallel: on_street
- footway
- footway
- steps, incline: up, ramp: no, step_count: 2, surface: paving_stones
...
- footway
- footway
- steps, handrail: both, incline: down, step_count: 2, surface: paving_stones
- steps, handrail: no, incline: down, step_count: 1, surface: paving_stones
- steps, handrail: left, incline: down, step_count: 2
