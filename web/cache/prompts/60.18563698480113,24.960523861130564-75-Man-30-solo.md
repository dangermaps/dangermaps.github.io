...
The tourist is currently located at these coordinates: 60°11'8.29"N, 24°57'37.89"E (60.18563698480113, 24.960523861130564).
...
- Ponnistus jk, addr:housenumber: 42, addr:street: Hämeentie, office: association (10m)
- With buzzer, access: private, addr:housenumber: 42, addr:street: Hämeentie, entrance: yes (14m)
- 42 Hämeentie, 00500 Helsinki, branch: Hämeentie 42, brand: K-Market, diet:halal: no, diet:kosher: no, name: K-Market, opening_hours: Mo-Fr 7:00-23:00; Sa 9:00-23:00; Su 10:00-23:00, phone: 09 5840 0442, shop: convenience, short_name: K-Market, website: https://www.k-ruoka.fi/kauppa/k-market-hameentie-42 (14m)
- With keycode, access: private, addr:housenumber: 42, addr:street: Hämeentie, addr:unit: B, entrance: staircase (15m)
- With keycode, access: private, addr:housenumber: 42, addr:street: Hämeentie, addr:unit: A, entrance: staircase, wheelchair: no (16m)
- access: yes, addr:housenumber: 42, addr:street: Hämeentie, entrance: yes, wheelchair: no (17m)
- traffic_sign: FI:pelastustie, traffic_sign:2: FI:372, traffic_sign:3: FI:871 (21m)
- traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes (21m)
- bbq, fuel: charcoal (22m)
- traffic_sign: FI:372, traffic_sign:2: rectangle (22m)
- With keycode, access: private, addr:housenumber: 44, addr:street: Hämeentie, addr:unit: A, entrance: staircase, wheelchair: no (23m)
- access: private, barrier: gate (23m)
- man_made: utility_pole, traffic_sign: FI:tekninen_valvonta (24m)
- traffic_sign: FI:372 (25m)
- post box (25m)
- access: private, barrier: gate (27m)
- With keycode, access: private, addr:housenumber: 44, addr:street: Hämeentie, addr:unit: B, entrance: staircase, wheelchair: no (28m)
- access: private, addr:housenumber: 44, addr:street: Hämeentie, entrance: yes, wheelchair: no (29m)
- traffic_sign: FI:pelastustie (29m)
- location: overhead, traffic_sign: FI:541b, traffic_sign:2: FI:871[Kuorma- ja pakettiautot 9-15, 18-07 (0-24) 0-24] (29m)
- traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes, traffic_signals:tram: yes (29m)
- traffic_sign: FI:511, traffic_signals:foot: yes, traffic_signals:tram: yes (30m)
- 44 Hämeentie, 00500 Helsinki, name: Hattuateljee Lindqvist Miia, payment:credit_cards: yes, payment:debit_cards: yes, phone: +358 9 712 363, shop: yes, was:website: http://www.hattukauppa.fi (31m)
- access: private, addr:housenumber: 40, addr:street: Hämeentie, entrance: staircase (32m)
- 2 Torkkelinkatu, Helsinki (32m)
- JHL, addr:housenumber: 2, addr:street: Torkkelinkatu, office: association (33m)
- Helsinki, address: Hämeentie 44, contact:instagram: miso_ceramic, craft: pottery, name: MiSo Ceramics, postal_code: 00500, was:name: Hattuateljee Miia Lindqvist (34m)
- access: yes, addr:housenumber: 44, addr:street: Hämeentie, entrance: yes (35m)
- barrier: gate (35m)
- Mäkikupla, restaurant, addr:housenumber: 2b, addr:street: Torkkelinkatu, diet:halal: no, diet:kosher: no, opening_hours: Mo-Fr 11:00-02:00,13:00-02:00, payment:credit_cards: yes, payment:debit_cards: yes (36m)
- access: private, addr:housenumber: 4, addr:street: Torkkelinkatu, addr:unit: A, entrance: staircase (38m)
- With buzzer, access: private, addr:housenumber: 2a, addr:street: Torkkelinkatu, entrance: yes, wheelchair: no (38m)
- was:highway: traffic_signals (38m)
- access: yes, addr:housenumber: 2b, addr:street: Torkkelinkatu, entrance: yes, wheelchair: no (39m)
- Studioysi, addr:housenumber: 44, addr:street: Hämeentie, level: 1, payment:credit_cards: yes, payment:debit_cards: yes, shop: hairdresser (40m)
- access: private, addr:housenumber: 2b, addr:street: Torkkelinkatu, entrance: staircase, wheelchair: no (41m)
- access: private, barrier: gate (44m)
- 4 Torkkelinkatu, Helsinki (44m)
- traffic_sign: FI:371 (45m)
- barrier: gate, traffic_sign: FI.871[Pelastustie] (46m)
- 4 Torkkelinkatu, Helsinki, address: Torkkelinkatu 4 B, name: Art & Soul Studio, payment:credit_cards: yes, payment:debit_cards: yes, postal_code: 00500, shop: tattoo (47m)
- traffic_signals:foot: yes (48m)
- access: private, addr:housenumber: 4, addr:street: Torkkelinkatu, entrance: yes, wheelchair: no (49m)

Within a 75m radius, there are also:
- 40 Hämeentie, 00500 Helsinki, building:levels: 8
- 44 Hämeentie, 00500 Helsinki, building:levels: 8, building:maintenance:operator: Huoltoalanen Oy, guard:operator: Turvatiimi, operator: Sato Oyj
- 42 Hämeentie, 00500 Helsinki, building:levels: 8, guard:operator: Vartioässät, operator: Sato Oyj, roof:levels: 0, roof:orientation: along, roof:shape: pitched
- was:highway: footway
- was:highway: platform
- Hämeentie (residential oneway 1-lane asphalt road, lit), maxspeed: 40km/h, parking:condition:right: no_stopping, parking:condition:right:time_interval: Mo-Fr 07:00-18:00;Sa 09:00-15:00, parking:left: no, parking:left:restriction: no_stopping, parking:right: no, parking:right:restriction: no_parking, sidewalk:left: no, sidewalk:right: separate, snowplowing: yes, taxi: yes
- diameter: 300, location: underground, man_made: pipeline, substance: water
- building:levels: 1, roof:shape: flat
- barrier: fence
- barrier: gate
- building:levels: 1
- service, emergency: designated, parking:enforcement:operator: ParkPatrol, pihatie: yksityisalue, service: driveway
- service, emergency: designated, pihatie: yksityisalue, service: driveway
- service
...
- 2b Torkkelinkatu, Helsinki, building:levels: 8, building:maintenance:operator: Kanta-Helsingin Kiinteistöhuolto Oy, start_date: 1939
...
- footway
- footway
- steps, handrail: yes, ramp: no, step_count: 3
- steps, incline: up, step_count: 1
- steps, handrail: no, incline: up, step_count: 1
- steps, handrail: no, incline: up, ramp: no, step_count: 2, surface: paving_stones
- footway
- footway
- steps, handrail: yes, ramp: no, step_count: 7
- steps, handrail: no, incline: up, ramp: no, step_count: 2, surface: paving_stones
- steps, handrail: no, incline: down, ramp: no, step_count: 1, surface: paving_stones
