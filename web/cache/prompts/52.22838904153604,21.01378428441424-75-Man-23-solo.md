...
The tourist is currently located at these coordinates: 52°13'42.2"N, 21°0'49.62"E (52.22838904153604, 21.01378428441424).
Name of Road: Żurawia
...
- 32/34 Żurawia, Warszawa, name: Biprodrzew, office: company, official_name: Biprodrzew S.A. (9m)
- 32/34 Żurawia, Warszawa, pub, name: Beer & Bones, opening_hours: Mo-Th 14:00-02:00; Fr-Su 14:00+, outdoor_seating: yes, wheelchair: no (12m)
- 32/34 Żurawia, Warszawa, check_date:opening_hours: 2023-07-14, cuisine: kebab, disused:amenity: fast_food, name: Box Kebab, opening_hours:signed: no, outdoor_seating: yes, takeaway: yes, wheelchair: limited (13m)
- 32/34 Żurawia, 00-515 Warszawa, nightclub, check_date:opening_hours: 2023-07-14, email: zurawia@clubwesele.pl, name: Wesele, opening_hours:signed: no, phone: +48 728 323 151, website: http://www.clubwesele.pl/ (14m)
- 32/34 Żurawia, Warszawa, pub, cuisine: pizza, name: Hopito, opening_hours: Mo-Th 12:00-24:00; Fr 12:00-02:00; Sa 14:00-02:00; Su 14:00-24:00, outdoor_seating: yes, website: https://hopito.ontap.pl, wheelchair: no (18m)
- 32/34 Żurawia, Warszawa, restaurant, check_date:opening_hours: 2023-07-14, cuisine: barbecue;arab;indian, name: Leila, opening_hours:signed: no, outdoor_seating: yes, wheelchair: limited (20m)
...
- give way, direction: backward (31m)
- 84/92 Marszałkowska, Warszawa, male: yes, name: Baku City, opening_hours: Mo-Sa 09:00-21:00; Su 10:00-19:00, shop: hairdresser, wheelchair: no (31m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (33m)
- crossing, uncontrolled, crossing_ref: zebra (33m)
- Żabka, brand: Żabka, opening_hours: Mo-Sa 06:00-23:00, shop: convenience, wheelchair: limited (33m)
- crossing, uncontrolled, crossing_ref: zebra (34m)
- Efez Express, fast food, addr:housenumber: 84/92, addr:street: Marszałkowska, check_date:opening_hours: 2023-07-17, cuisine: kebab, indoor_seating: no, opening_hours:signed: no, outdoor_seating: yes, takeaway: yes, wheelchair: yes (35m)
- 27 Nowogrodzka, 00-511 Warszawa, bar, name: Chicas & Gorillas, wheelchair: limited (39m)
- entrance: yes (42m)
- direction: 345, maxspeed: 30km/h, traffic_sign: maxspeed (46m)

Within a 75m radius, there are also:
- Żurawia (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Żurawia w Warszawie, maxspeed: 30km/h, sidewalk: separate
- Parkingowa (residential oneway 1-lane sett road), bicycle: yes, maxspeed: 30km/h, oneway:bicycle: no, sidewalk:both: separate, smoothness: intermediate
- Parkingowa (residential 2-lane asphalt road, lit), maxspeed: 50km/h, sidewalk: separate
...
- 32/34 Żurawia, 00-515 Warszawa, addr:city:simc: 0918123, building:levels: 6, source:addr: gugik.gov.pl
- 31 Nowogrodzka, 00-511 Warszawa, addr:city:simc: 0918123, building:levels: 6, source:addr: gugik.gov.pl
...
- steps, footway: sidewalk, handrail: no, incline: up, lit: yes, ramp: no, step_count: 5, surface: paving_stones
- 27 Nowogrodzka, 00-511 Warszawa, parking, access: yes, addr:city:simc: 0918123, building:levels: 9, fee: yes, operator:type: private, parking: multi-storey, source:addr: gugik.gov.pl
- footway, footway: sidewalk, surface: paving_stones
- service, service: driveway, surface: paving_stones
- service, maxheight: default, service: driveway, surface: paving_stones, tunnel: building_passage
- service, service: driveway, surface: paving_stones
- service, incline: down, service: driveway, surface: paving_stones
- parking, access: yes, capacity:disabled: 0, fee: yes, orientation: diagonal, parking: street_side
- parking, access: yes, capacity: 2, capacity:disabled: 0, fee: yes, orientation: diagonal, parking: street_side
- parking, access: customers, fee: no, parking: surface
- 84/92 Marszałkowska, 00-514 Warszawa, addr:city:simc: 0918123, building:levels: 9, source:addr: gugik.gov.pl
- parking, access: yes, fee: yes, orientation: perpendicular, parking: street_side
- building:levels: 1, noname: yes, shop: kiosk
- service, incline: up, service: driveway, surface: paving_stones
...
- parking, access: yes, capacity: 3, capacity:disabled: 0, fee: yes, orientation: diagonal, parking: street_side
- parking, access: yes, capacity:disabled: 0, fee: yes, orientation: diagonal, parking: street_side
