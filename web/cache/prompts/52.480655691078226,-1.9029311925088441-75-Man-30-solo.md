...
The tourist is currently located at these coordinates: 52°28'50.36"N, 1°54'10.55"W (52.480655691078226, -1.9029311925088441).
Name of Road: Chamberlain Square
...
- Eden Place, bicycle parking, bcc_ref: 52, bicycle_parking: stands, capacity: 10, covered: no (12m)
- BCC Eden Place, bicycle rental, capacity: 12, email: support@beryl.cc, fee: yes, network: West Midlands Cycle Hire, network:regional: Starley, official_name: BCC Eden Place, operator: Beryl, payment:app: yes, payment:cash: no, payment:credit_cards: no, payment:cryptocurrencies: no, payment:debit_cards: no, phone: +44 20 3003 5044, ref:gbfs: beryl_west_midlands:2757, ref:wmch: 54, rental: city_bike;ebike, website: https://beryl.cc/scheme/west-midlands (13m)
- elevator, indoor: yes (14m)
- entrance: yes, wheelchair: yes (15m)
- Victoria Square, B3 3AA Birmingham (16m)
- internet_access: wlan, operator: BT, service: Birmingham FIZ (16m)
- barrier: bollard, bicycle: yes, material: metal, maxwidth: 1.5 (21m)
- bicycle: no, entrance: main, level: 0, operator: Water Hall (23m)
- booth: K6, colour: red, covered: booth, disused:amenity: telephone, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, man_made: telephone_box, shop: kiosk (24m)
- entrance: yes, wheelchair: yes (25m)
- barrier: bollard, bicycle: yes, bollard: rising (25m)
- booth: K6, colour: red, covered: booth, disused:amenity: telephone, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, man_made: telephone_box, shop: kiosk (28m)
- entrance: emergency, wheelchair: limited (30m)
- fire hydrant (underground), operator: WMFS (32m)
- Chamberlain Square, bicycle parking, bcc_ref: 263, bicycle_parking: stands, capacity: 8, covered: no (33m)
- Margaret Street Electric Charge Point, charging station, fuel:electricity: yes, operator: E.ON, parking: electric vehicles only (34m)
- ES1 ( road), bus: yes, naptan:AtcoCode: 43000205601, naptan:Bearing: SW, naptan:BusStopType: MKD, naptan:CommonName: Art Gallery, naptan:Indicator: Stop ES1, naptan:NaptanCode: nwmajdpw, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: EDMUND ST, naptan:Towards: Bearwood, Harborne, Quinton an, public_transport: platform, route_ref: 9;10;10H;82;83;87;89;120;127;128;129;140;X10, shelter: yes (34m)
- fire hydrant (underground), operator: WMFS (35m)
- bicycle parking, access: private (37m)
- Rose Window, PMSA_ref: WMbiBIxx078, artist_name: William Martin, tourism: artwork (39m)
- Margaret Street, motorcycle parking, bcc_ref: 77, capacity: 8, covered: no (41m)
- Margaret Street Electric Charge Point, charging station, fuel:electricity: yes, operator: E.ON, parking: electric vehicles only (43m)
- booth: K6, colour: red, covered: booth, disused:amenity: telephone, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, man_made: telephone_box, shop: kiosk (45m)

Within a 75m radius, there are also:
- Margaret Street (oneway asphalt road, lit), cycleway:left: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- Edmund Street (paving_stones road), lane_markings: no
...
- Edmund Street (oneway asphalt road, lit), See Wikipedia: https://en.wikipedia.org/wiki/Edmund Street, cycleway:left: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- Chamberlain Square, B3 3DH Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/Birmingham Museum and Art Gallery, architect: Yeoville Thomason, building:levels: 6, fee: no, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, name: Birmingham Museum & Art Gallery, opening_hours: Mo-Th 10:00-17:00, Fr 10:30-17:00,Sa-Su 10:00-17:00, operator: Birmingham City Council, start_date: 1884-89, tourism: museum, wheelchair: no
- Margaret Street, B3 3DA Birmingham, addr:housename: Council House Extension, building:levels: 4, height: 20, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, name: Council House Extension, operator: Birmingham City Council
- height: 3, operator: Birmingham City Council, shape: octagon, type: kiosk
- Margaret Street, B3 3BX Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/Birmingham School of Art, university, architect: J H Chamberlain, building:architecture: gothic, building:levels: 5, heritage: 2, heritage:operator: Historic England, listed_status: Grade I, name: Birmingham School of Art, operator: Birmingham City University, previous_name: Birmingham Institute of Art and Design, start_date: 1884
- WaterHall, indoor: yes, level: 0, operator: Birmingham City Council, tourism: gallery
- Colmore Row, B3 3AL Birmingham, building:levels: 10
- gauge: 1067, railway: tram
- 125 Colmore Row, B3 3SD Birmingham, architect: Sidell Gibson Partnership, building:levels: 9, start_date: 1999
- service, service: driveway, surface: cobblestone
- BMAG Gift Shop, indoor: yes, level: 2, shop: gift
- Birmingham Museum and Art Gallery, fee: no, indoor: yes, level: 2, tourism: museum
- Chamberlain Square, B3 3DH Birmingham, cafe, fhrs:id: 601127, indoor: yes, level: 2, name: Edwardian Tea Room, not:addr:postcode: B3 3HQ, source:addr:postcode: code-point_open
- footway, lit: yes, surface: paving_stones
- footway, bicycle: designated, lit: yes, segregated: no, surface: paving_stones
- Edmund Street (paving_stones road), access: permissive, lane_markings: no
- Chamberlain Square, B3 3DH Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/Birmingham Museum and Art Gallery, architect: Yeoville Thomason, building:levels: 6, fee: no, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, name: Birmingham Museum & Art Gallery, opening_hours: Mo-Th 10:00-17:00, Fr 10:30-17:00,Sa-Su 10:00-17:00, operator: Birmingham City Council, start_date: 1884-89, tourism: museum, wheelchair: no
- Chamberlain Square, B3 3DH Birmingham, cafe, fhrs:id: 601127, indoor: yes, level: 2, name: Edwardian Tea Room, not:addr:postcode: B3 3HQ, source:addr:postcode: code-point_open
