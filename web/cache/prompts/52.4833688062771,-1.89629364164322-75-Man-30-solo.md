...
The tourist is currently located at these coordinates: 52°29'0.13"N, 1°53'46.66"W (52.4833688062771, -1.89629364164322).
...
- barrier: gate (20m)
- SQ8 ( road, lit), NaPTANAreaCode: 43000207301, bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000207301, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Steelhouse Lane, naptan:Indicator: Stop SH8, naptan:NaptanCode: nwmajgjp, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: COLMORE CIRCUS QUEENSWAY, naptan:Towards: xxx, naptan:verified: yes, public_transport: platform, route_ref: 22;23;24;29, shelter: yes, shelter_ref: 507424 (24m)
- mini roundabout, direction: clockwise (26m)
- age: young, constituency: City Centre, genus: Platanus, height: 8, height:range: 7 to 7.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100001, ref:usrn: 2701507, site_name: COLMORE CIRCUS QUEENSWAY, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (27m)
- internet_access: wlan, operator: BT, service: Birmingham FIZ (32m)
- entrance: yes (34m)
- Wesleyan, bicycle parking, bcc_ref: 563, bicycle_parking: stands, capacity: 18, covered: no (36m)
- waste basket, waste: litter (37m)
- entrance: yes (37m)
- bench, armrest: no, backrest: no (38m)
- fountain (39m)
- Steelhouse Lane at Colmore Circus, bicycle parking, bcc_ref: 43, bicycle_parking: stands, capacity: 10, covered: no (39m)
- crossing, traffic_signals, bicycle: yes, button_operated: yes, crossing_ref: toucan, source:type: BCC_CycleData, traffic_signals:sound: yes, traffic_signals:vibration: yes (44m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (50m)
...
- cycleway, bicycle: designated, lit: yes, segregated: no, surface: paving_stones
- Colmore Circus Queensway (2-lane asphalt road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B4
...
- building:colour: #b79c92, building:part: yes, height: 50, roof:colour: #b79c92, roof:edge: yes, roof:height: 9, roof:shape: pyramidal
- service, access: private
...
- footway, lit: yes, ramp: yes, surface: paving_stones, wheelchair: yes
- steps, handrail: yes, incline: down, lit: yes, ramp: separate, ramp:wheelchair: separate, surface: paving_stones
