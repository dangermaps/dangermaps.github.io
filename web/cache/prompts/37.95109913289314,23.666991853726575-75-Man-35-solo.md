...
The tourist is currently located at these coordinates: 37°57'3.96"N, 23°40'1.17"E (37.95109913289314, 23.666991853726575).
Name of Road: Κανελλοπούλου
...
- 44 Κανελλοπούλου, Νέο Φάληρο, restaurant, int_name: Alatopipero, name: Αλατοπίπερο, outdoor_seating: yes (19m)
- crossing (42m)
- crossing, unmarked (71m)
- maxspeed: 30km/h, traffic_sign: maxspeed (83m)
- crossing, uncontrolled (85m)

Within a 75m radius, there are also:
- Kanelopoulou (residential twoway 2-lane asphalt road)
- Chrisostomou Smyrnis (residential oneway asphalt road)
- Χρυσοστόμου Σμύρνης (residential oneway asphalt road)
- residential, junction: roundabout, maxspeed: 30km/h, surface: asphalt
- Mitsa (residential oneway asphalt road)
- N. Pizoy (residential oneway asphalt road)
- Elais
- AMALL, shop: yes
- service, service: parking_aisle
- parking, access: private, parking: surface
- parking, access: private, parking: surface
- service, maxspeed: 10km/h, service: parking_aisle, surface: asphalt
- service, service: parking_aisle
- service, maxspeed: 10km/h, surface: asphalt
- service, service: parking_aisle
- service, service: parking_aisle
- service, service: parking_aisle
- parking, access: customers, operator: Carrefour, parking: surface
...
- parking, access: customers, operator: Factory Outlet, parking: surface
- service, service: driveway, surface: asphalt
- 74Α Πειραιώς, Πειραιάς, name: 360 Connect
- 58 Κανελλοπούλου, Νέο Φάληρο, school, name: 2ο Δημοτικό Σχολείο, και 2ο Νηπιαγωγείο Νέου Φαλήρου
- 2Αν. Μητσα (residential oneway asphalt road)
