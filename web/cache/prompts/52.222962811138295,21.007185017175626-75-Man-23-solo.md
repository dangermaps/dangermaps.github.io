...
The tourist is currently located at these coordinates: 52°13'22.67"N, 21°0'25.87"E (52.222962811138295, 21.007185017175626).
Name of Road: Wilcza
...
- 79 Wilcza, Warszawa, addr:city:simc: 0918123, source:addr: gugik.gov.pl (14m)
- Jassmine, nightclub, addr:housenumber: 73, addr:street: Wilcza, website: https://jassmine.com (18m)
- crossing, uncontrolled, crossing_ref: zebra (18m)
- give way, direction: forward (20m)
- Ulica Wilcza, tourism information, information: board (23m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (24m)
- addr:flats: 1-10,40, entrance: staircase (25m)
- addr:flats: 11-25,37, entrance: staircase (26m)
- bicycle parking, bicycle_parking: wall_loops, capacity: 4, covered: no, fee: no, wikimedia_commons: File:Mały parking rowerowy na rogu ogrodzenia i budynku.jpg (26m)
- Słoneczna, pharmacy, addr:housenumber: 74, addr:street: Wilcza, dispensing: yes, healthcare: pharmacy, opening_hours: Mo-Fr 07:00-21:00; Sa 08:00-15:00, wheelchair: yes (26m)
- access: permissive, barrier: gate, horse: no, material: metal, motor_vehicle: no (27m)
- Ormex, dispensing: yes, disused:shop: medical_supply, opening_hours: Mo-Fr 10:00-18:00, wheelchair: yes (27m)
- Nobu, restaurant, addr:housenumber: 73, addr:street: Wilcza, brand: Nobu, cuisine: japanese, email: dine-warsaw@nobuhotels.com, phone: +48 22 551 88 00, website: https://noburestaurants.com/warsaw/home-warsaw/, wheelchair: yes (29m)
- crossing, unmarked (29m)
- access: private, barrier: gate, bicycle: permissive, locked: yes, material: metal (30m)
- Anna Smoleńska i Tadeusz Zawadzki, historic: memorial, material: stone, memorial: plaque (32m)
- addr:flats: 26-39, entrance: staircase (33m)
- bench, backrest: no, material: wood (33m)
- leaf_type: needleleaved (34m)
- Tomasz Szymański, addr:housenumber: 72, addr:street: Wilcza, opening_hours: Mo-Fr 09:00-20:00; Sa 10:00-16:00, shop: hairdresser, wheelchair: yes (35m)
- tourism information map, direction: 275 (35m)
- waste basket, material: concrete (35m)
- 77 Wilcza, Warszawa, addr:city:simc: 0918123, source:addr: gugik.gov.pl (35m)
- Noakowskiego 01, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position, stop_position:direction: backward (36m)
- advertising: column (37m)
- leaf_type: broadleaved (38m)
- Noakowskiego 01 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: yes (39m)
- leaf_type: needleleaved (39m)
- addr:flats: 43, entrance: home (39m)
- 72 Wilcza, 00-670 Warszawa, addr:door: 1, email: pruszczynska@notariusze.waw.pl, name: Marta Józefina Pruszczyńska, office: notary, phone: +48226251237, website: https://notariusze.waw.pl/kancelaria-notarialna/kancelaria,kancelaria-notarialna-marta-jozefina-pruszczynska (39m)
- bicycle parking, bicycle_parking: wall_loops, capacity: 5, covered: no, fee: no (40m)
- leaf_type: needleleaved (41m)
- leaf_type: needleleaved (41m)
- Batalion AK "Golski", historic: memorial, material: stone, memorial: plaque (41m)
- bicycle parking, bicycle_parking: wall_loops, capacity: 5, covered: no, fee: no (42m)
- Clarena, addr:housenumber: 72, addr:street: Wilcza, beauty: cosmetics, opening_hours: Mo-Fr 08:00-18:00, shop: beauty, wheelchair: yes (45m)
- bench, backrest: yes, material: wood, wikimedia_commons: File:Drewniana ławka przy budynku.jpg (51m)

Within a 75m radius, there are also:
- Profesora Witolda Wierzbickiego (asphalt road), service: driveway
...
- 72 Wilcza, 00-670 Warszawa, addr:city:simc: 0918123, building:levels: 5, historic: yes, source:addr: gugik.gov.pl
...
- 74 Wilcza, 00-670 Warszawa, addr:city:simc: 0918123, building:levels: 6, building:material: plaster, source:addr: gugik.gov.pl
...
- parking, access: yes, fee: yes, orientation: parallel, parking: street_side, paving_stones:colour: grey, paving_stones:orientation: across, paving_stones:pattern: half_bond, paving_stones:shape: double_t, surface: sett
- leisure: garden
- building:levels: 1, office: security
...
- footway, footway: sidewalk, lit: yes, paving_stones:colour: grey, paving_stones:orientation: across, paving_stones:pattern: half_bond, paving_stones:shape: double_t, surface: paving_stones
- footway, unmarked, footway: crossing, lit: yes, paving_stones:colour: grey, paving_stones:orientation: across, paving_stones:pattern: half_bond, paving_stones:shape: double_t, surface: sett
- Koszykowa (twoway 2-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, maxspeed: 50km/h, sidewalk: separate
- Profesora Witolda Wierzbickiego (sett road), cycleway:both: no, service: driveway
- Wilcza (residential oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Wilcza w Warszawie, maxspeed: 50km/h, oneway:bicycle: no, sidewalk: separate
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- service, access: private, bicycle: permissive, cycleway:both: no, service: driveway, surface: asphalt
- footway, access: permissive, horse: no, lit: no, motor_vehicle: no, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: paving_stones
