...
The tourist is currently located at these coordinates: 52°28'45.48"N, 1°53'34.71"W (52.47929913347879, -1.8929748662104078).
Name of Road: Moor Street Queensway
...
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: no, traffic_signals:vibration: no (4m)
- enforcement: busgate, man_made: surveillance, surveillance: enforccement (14m)
- give way (14m)
- Moor Street Queensway, bicycle parking, bcc_ref: 68, bicycle_parking: stands, capacity: 20, covered: no (18m)
- parking, access: yes, capacity: 1, fee: no, lit: yes, maxstay: load-unload, parking: street_side, parking:orientation: parallel, smoothness: intermediate, supervised: no, surface: asphalt (21m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (21m)
- MS4 ( road, lit), asset_ref: 507411, bench: yes, bin: no, bus: yes, naptan:AtcoCode: 43000203203, naptan:Bearing: NE, naptan:BusStopType: MKD, naptan:CommonName: Moor St Station, naptan:Indicator: Stop MS4, naptan:NaptanCode: nwmajajp, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: MOOR ST QUEENSWAY, naptan:Towards: Bull Street/Priory Queensway a, public_transport: platform, route_ref: 58;59;59A;60;X1;X2, shelter: yes (22m)
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: no, traffic_signals:vibration: no (25m)
- bicycle rental, capacity: 20, network: Beryl, network:regional: Starley, official_name: Birmingham Moor Street, operator: West Midlands Cycle Hire, ref:wmch: 8 (26m)
- MS8A ( road), bus: yes, naptan:AtcoCode: 43000203209, naptan:Bearing: SW, naptan:BusStopType: MKD, naptan:CommonName: Bus Mall, naptan:Indicator: Stop MS8A, naptan:NaptanCode: nwmapawj, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: MOOR ST QUEENSWAY, naptan:Towards: Hockley, Handsworth Wood, Great Barr, West Bromwich, naptan:code: nwmagwga, public_transport: platform, route_ref: 16;16A, shelter: no (30m)
- fire hydrant (underground), operator: WMFS (31m)
- emergency: defibrillator, indoor: no, ref:GB:the_circuit: 08474EDD-1B07-46C6-90F9-ADCE00A26253 (33m)
- operator: Network Rail, railway: signal, railway:signal:position: bridge (33m)
- operator: Network Rail, railway: signal, railway:signal:direction: forward, railway:signal:position: bridge (34m)
- entrance: yes, wheelchair: yes (34m)
- tourism: artwork (37m)
- enforcement: busgate, man_made: surveillance, surveillance: enforccement (39m)
- age: young, constituency: Strategic Routes, genus: Platanus, height: 6, height:range: 5 to 5.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 110006, ref:usrn: 2702040, site_name: MOOR STREET QUEENSWAY, species: Platanus x acerifolia, tree_form: natural, ward: Nechells (42m)
- fire hydrant (underground), operator: WMFS (42m)
- MS5 ( road, lit), bench: yes, bin: no, bus: yes, naptan:AtcoCode: 43000201501, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Church Centre, naptan:Indicator: Stop MS5, naptan:NaptanCode: nwmagtwg, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: CARRS LANE, naptan:Towards: Sparkbrook, Acocks Green and S, naptan:code: nwmagtwg, public_transport: platform, route_ref: 63, shelter: yes (42m)
- MS3 ( road, lit), asset_ref: 507416, bench: yes, bin: no, bus: yes, naptan:AtcoCode: 43000203204, naptan:Bearing: NE, naptan:BusStopType: MKD, naptan:CommonName: Moor St Station, naptan:Indicator: Stop MS3, naptan:NaptanCode: nwmajajt, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: MOOR ST QUEENSWAY, naptan:Towards: Small Heath, Yardley and Birmi, public_transport: platform, route_ref: 16;16A;16W;82;87;98;99;424;424E;X64, shelter: yes (43m)
- man_made: street_cabinet, street_cabinet: ? (48m)
- man_made: street_cabinet, street_cabinet: ? (50m)

Within a 75m radius, there are also:
- Didcot and Chester Line, electrified: no, gauge: 1435, maxspeed: 30 mphkm/h, railway: rail, usage: main
...
- Carrs Lane (asphalt road, lit), cycleway:both: no, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, motor_vehicle: destination, sidewalk: both
- Carrs Lane (oneway 2-lane asphalt road, lit), bicycle: yes, bus: yes, gritting: priority_3, lane_markings: yes, maintenance: gritting, maxspeed: 20 mphkm/h, motor_vehicle: destination, psv: yes, shoulder: no
...
- 42 High Street, B4 7SS Birmingham, architect: James M Munro & Son, building:levels: 4, height: 13, old_name: Marks & Spencer, shop: vacant, start_date: 1956, toilets: yes, wheelchair: yes
- pedestrian, area: yes, lit: yes, surface: asphalt
- Carrs Lane, B4 7SX Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/Carrs Lane Church, Birmingham, place of worship, architect: Denys Hinton & Partners, height: 13, name: Carrs Lane Church Centre, religion: christian, start_date: 1968, wheelchair: yes
...
- Snow Hill Tunnel, electrified: no, gauge: 1435, maxspeed: 20 mphkm/h, passenger_lines: 2, railway: rail, tunnel: yes, tunnel:name: Snow Hill Tunnel, usage: main
- leisure: park
- Didcot and Chester Line, electrified: no, gauge: 1435, maxspeed: 30 mphkm/h, railway: rail, railway:signal:direction: backward, usage: main
...
- Moor Street Queensway (oneway 1-lane asphalt road, lit), bicycle: yes, maxspeed: 20 mphkm/h, motor_vehicle: destination, psv: yes, taxi: yes
- footway
- steps, handrail: yes
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- Moor Street Queensway (oneway 2-lane asphalt road, lit), bicycle: yes, gritting: priority_2, maintenance: gritting, maxspeed: 20 mphkm/h, motor_vehicle: destination, postal_code: B7, psv: yes, taxi: yes
...
- Moor Street Queensway (oneway 1-lane asphalt road, lit), bicycle: yes, cycleway:left: no, emergency: yes, motor_vehicle: destination, psv: yes
- New Meeting Street (asphalt road)
- Moor St Kiosk, kiosk: news, shop: kiosk
- service, access: yes, level: 1, lit: yes, maxspeed: 20 mphkm/h, surface: asphalt
- Moor Street Queensway (oneway 2-lane asphalt road, lit), bicycle: yes, cycleway:left: share_busway, gritting: priority_2, lanes:psv: 1, maintenance: gritting, maxspeed: 20 mphkm/h, motor_vehicle: no, psv: yes, sidewalk: left, taxi: yes
- Platform 1, area: yes, bench: yes, departures_board: realtime, public_transport: platform, railway: platform, shelter: yes, train: yes, wheelchair: yes
- Platform 2, area: yes, bench: yes, bin: no, departures_board: realtime, public_transport: platform, railway: platform, shelter: yes, train: yes, wheelchair: yes
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: paving_stones
...
- HS2 Curzon Street Station, opening_date: 2030
- footway, unmarked, footway: crossing, lit: yes, surface: paving_stones
- footway, lit: yes, surface: paving_stones
- footway, unmarked, footway: crossing, lit: yes, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, unmarked, footway: crossing, lit: yes, surface: paving_stones
- service, lit: yes, surface: paving_stones
