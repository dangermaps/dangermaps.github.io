...
The tourist is currently located at these coordinates: 52°28'43.04"N, 1°54'2.59"W (52.47862085467907, -1.900718675553636).
...
- Joey's Pizzeria, fast food, cuisine: pizza (6m)
- railway: switch (15m)
- telephone, atm: yes, booth: K6, colour: red (17m)
- barrier: lift_gate (19m)
- crossing (21m)
- man_made: surveillance (23m)
- crossing, traffic_signals, crossing_ref: pelican, source:type: BCC_CycleData (28m)
- HM Inspectorate of Constabulary and Fire & Rescue Services, See Wikipedia: https://en.wikipedia.org/wiki/His Majesty's Inspectorate of Constabulary and Fire & Rescue Services, addr:housenumber: 23, addr:postcode: B2 4BH, addr:street: Stephenson Street, contact:twitter: https://twitter.com/hmicfrs, office: government, short_name: HMICFRS, website: https://hmicfrs.justiceinspectorates.gov.uk/ (29m)
- railway: switch (29m)
- mini roundabout (29m)
- Colonade Carpark, parking (31m)
- 12 Ethel Street, B2 4BG Birmingham, disused:shop: yes (31m)
- railway: tram_crossing (32m)
- internet_access: wlan, operator: BT, service: Birmingham FIZ (32m)
- railway: tram_level_crossing (35m)
- stop (35m)
- barrier: lift_gate (35m)
- H&T Pawnbrokers, brand: H&T Pawnbrokers, opening_hours: Mo-Sa 09:00-17:00, shop: pawnbroker (35m)
- grit bin (36m)
- Fitness4less, leisure: sports_centre (36m)
- door: yes, entrance: exit, level: 1 (37m)
- railway: signal (38m)
- level: 1 (38m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (38m)
- railway: signal (39m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (40m)
- level: 0 (43m)
...
- 37 Pinfold Street, B2 4DG Birmingham, height: 22, source:height: emuanalytics
- generator:method: photovoltaic, generator:output:electricity: yes, generator:source: solar, generator:type: solar_photovoltaic_panel, power: generator
- level: 1
- footway, bridge: yes, covered: yes, level: 1, lit: yes, surface: paving_stones
...
- 33 Stephenson Street, B2 4BH Birmingham, fhrs:id: 638880, height: 22, name: All Greek, shop: deli, source:height: emuanalytics
- 34 Stephenson Street, B2 4BH Birmingham, height: 22, source:height: emuanalytics
- 29,30 Stephenson Street, B2 4BH Birmingham, cafe, cuisine: coffee_shop, fhrs:id: 1106310, height: 22, name: Yorks Bakery Cafe, source:height: emuanalytics
...
- 35 Pinfold Street, B2 4DG Birmingham, height: 22, name: Pinfolds, shop: dry_cleaning, source:height: emuanalytics
- 36 Pinfold Street, B2 4DG Birmingham, height: 22, name: Courtney Co, shop: hairdresser, source:height: emuanalytics
- 12 Navigation Street, B2 4BT Birmingham, height: 22, name: Guildhall Buildings, source:height: emuanalytics
- 13 Navigation Street, B2 4DD Birmingham, fast food, cuisine: italian, height: 22, name: Polo Pasta, source:height: emuanalytics
- 31 Stephenson Street, B2 4BH Birmingham, height: 22, source:height: emuanalytics
- 14 Navigation Street, B2 4DD Birmingham, fast food, fhrs:id: 600602, height: 22, name: Urban Feast, source:height: emuanalytics
- 35-37 Stephenson Street, B2 4BH Birmingham, height: 22, name: Hush Hair, shop: hairdresser, source:height: emuanalytics
- 15 Navigation Street, B2 4DD Birmingham, (Candy & Liquor), fhrs:id: 604063, height: 22, name: Sandhu News, shop: newsagent, source:height: emuanalytics
- 32 Stephenson Street, B2 4BJ Birmingham, height: 22, name: Ikon, opening_hours: Mo,We 09:30-18:30; Th 10:00-19:30; Fr 09:30-18:30; Sa 09:00-17:00, shop: hairdresser, source:height: emuanalytics
- taxi
- barrier: wall
- barrier: wall
...
- Pinfold Street (oneway concrete road, lit), cycleway:left: no, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2, sidewalk: both
...
- Navigation Street (oneway paved road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2
- Pinfold Street (oneway asphalt road, lit), cycleway:both: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2, sidewalk: both
- footway, colonnade:left: open, covered: colonnade, level: 1, lit: yes, surface: paving_stones
- area: yes, level: 0, public_transport: platform, railway: platform, wheelchair: yes
- area: yes, level: 0, public_transport: platform, railway: platform, wheelchair: yes
- Stephenson Street, B2 4BH Birmingham, fast food, cuisine: grill, fhrs:id: 600603, name: Polo
...
- electrified: contact_line, frequency: 0, railway: tram, voltage: 750
- service, access: private, bridge: yes
...
- barrier: wall
- artwork_type: decorative fence, barrier: fence, tourism: artwork
- taxi, level: 0
- steps, handrail: yes, lit: yes, surface: paving_stones
- Pinfold Street (concrete road, lit), access: no, bicycle: no, emergency: yes, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2, sidewalk: both
- Pinfold Street (oneway asphalt road, lit), cycleway:left: no, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2, sidewalk: both
- electrified: no, railway: tram
- cycleway, lit: yes, oneway: yes, surface: paving_stones
- footway, bicycle: dismount, surface: paved
...
- footway, tunnel: yes
- barrier: wall
- Rugby Birmingham and Stafford Line, electrified: contact_line, frequency: 50, gauge: 1435, maxspeed: 10 mphkm/h, railway: rail, railway:track_ref: 2A, usage: main, voltage: 25000
- Rugby Birmingham and Stafford Line, electrified: contact_line, frequency: 50, gauge: 1435, maxspeed: 10 mphkm/h, railway: rail, railway:track_ref: 1B, usage: main, voltage: 25000
- service
- 32 Stephenson Street, B2 4BJ Birmingham, height: 22, name: Ikon, opening_hours: Mo,We 09:30-18:30; Th 10:00-19:30; Fr 09:30-18:30; Sa 09:00-17:00, shop: hairdresser, source:height: emuanalytics
