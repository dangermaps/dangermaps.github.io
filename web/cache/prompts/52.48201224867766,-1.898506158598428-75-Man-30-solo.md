...
The tourist is currently located at these coordinates: 52°28'55.24"N, 1°53'54.62"W (52.48201224867766, -1.898506158598428).
...
- Imperial & Whitehall Chambers, entrance: yes (14m)
- 21 Colmore Row, B3 2BS Birmingham, cafe, fhrs:id: 941972, name: 200 degrees, opening_hours: Mo-Fr 07:00-20:00; Sa 08:00-19:00; Su 09:00-18:00, smoking: outside, source:addr:postcode: code-point_open, toilets: yes, toilets:wheelchair: yes, wheelchair: yes (14m)
- 23 Colmore Row, B3 2BS Birmingham, source:addr:postcode: code-point_open (16m)
- bicycle parking, bicycle_parking: stands, capacity: 12, covered: no (16m)
- age: semi-mature, constituency: City Centre, height: 10, height:range: 9 to 9.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100010, ref:usrn: 2701508, site_name: COLMORE ROW, species: Carpinus betulus, species:wikidata: Q158776, taxon: Carpinus betulus fastigiata, tree_form: natural, ward: Ladywood (16m)
- Pasture Birmingham, restaurant, addr:postcode: B3 2BH, contact:instagram: pasture_birmingham, cuisine: steak_house, opening_hours: Mo-We 12:00-15:00, 17:00-21:30; Th-Sa 12:00-21:30; Su 12:00-20:30, website: https://pasturerestaurant.com/locations/pasture-birmingham/, website:menu: https://pasturerestaurant.com/menus/ (19m)
- SH3 ( road, lit), bench: yes, bin: yes, bus: yes, naptan:AtcoCode: 43000206201, naptan:Bearing: SW, naptan:BusStopType: MKD, naptan:CommonName: Colmore Row, naptan:Indicator: Stop SH3, naptan:Landmark: St Phillips Churchyard, naptan:NaptanCode: nwmajdta, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: COLMORE ROW, naptan:Towards: Harborne, Bartley Green, Quinton and Northfield, public_transport: platform, route_ref: 101, shelter: yes (19m)
- 25 Colmore Row, B3 2BS Birmingham, name: Crockett & Jones, shop: shoes, source:addr:postcode: code-point_open, wheelchair: yes (20m)
- 27 Colmore Row, B3 2BS Birmingham, fhrs:id: 1179775, name: Liquor Store, shop: clothes, source:addr:postcode: code-point_open (23m)
- age: semi-mature, constituency: City Centre, height: 10, height:range: 9 to 9.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100009, ref:usrn: 2701508, site_name: COLMORE ROW, species: Carpinus betulus, species:wikidata: Q158776, taxon: Carpinus betulus fastigiata, tree_form: natural, ward: Ladywood (23m)
- 29 Colmore Row, B3 2BS Birmingham, brand: Up & Running, fhrs:id: 1272487, name: Up & Running, shop: sports, source:addr:postcode: code-point_open, sport: running, wheelchair: no (28m)
- fire hydrant (underground), operator: WMFS, position:distance: 8 (28m)
- fire hydrant (underground), operator: WMFS, position:distance: 8 (29m)
- age: semi-mature, constituency: City Centre, height: 10, height:range: 9 to 9.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100008, ref:usrn: 2701508, site_name: COLMORE ROW, species: Carpinus betulus, species:wikidata: Q158776, taxon: Carpinus betulus fastigiata, tree_form: natural, ward: Ladywood (30m)
- post box, brand: Royal Mail, collection_times: Mo-Fr 18:30; Sa 12:00, operator: Royal Mail, post_box:type: pillar, royal_cypher: EIIR, royal_cypher:wikidata: Q33102113 (30m)
- 31 Colmore Row, B3 2BS Birmingham, name: Loake Shoemaker, shop: shoes, source:addr:postcode: code-point_open (32m)
- 33 Colmore Row, B3 2BS Birmingham, name: John Shepherd, office: estate_agent, source:addr:postcode: code-point_open (36m)
- age: semi-mature, constituency: City Centre, height: 10, height:range: 9 to 9.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100007, ref:usrn: 2701508, site_name: COLMORE ROW, species: Carpinus betulus, species:wikidata: Q158776, taxon: Carpinus betulus fastigiata, tree_form: natural, ward: Ladywood (37m)
- 5 St Philip's Place, B3 2PW Birmingham, name: Government Office for the West Midlands, office: government (38m)
- bicycle parking, bicycle_parking: stands, capacity: 12 (39m)
- internet_access: wlan, operator: BT, service: Birmingham FIZ (39m)
- fire hydrant (underground), operator: WMFS (40m)
- age: semi-mature, constituency: City Centre, genus: Platanus, height: 13, height:range: 12 to 12.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100001, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: asymmetric, ward: Ladywood (42m)
- ticket validator, operator: Transport for West Midlands, operator:short: TfWM, payment:swift_card: yes (43m)
...
- St Philip's Place (paving_stones road, lit), designation: public_footpath, prow_ref: Birmingham FP 1807, source:prow_ref: birmingham_city_council_prow_gis_data
...
- footway, check_date:smoothness: 2023-08-17, designation: public_footpath, lit: yes, prow_ref: Birmingham FP 1806, smoothness: excellent, source:prow_ref: birmingham_city_council_prow_gis_data, surface: paving_stones
...
- parking space, parking: surface, parking_space: disabled
- 15 Colmore Row, B3 2BH Birmingham, building:levels: 6, disused:shop: yes
- 15 Colmore Row, B3 2BH Birmingham, building:levels: 6, disused:shop: yes
- Barwick Street, B3 2NT Birmingham, building:levels: 6
- 22 Colmore Row, B3 2QD Birmingham, fast food, brand: Pret A Manger, cuisine: sandwich, fhrs:id: 706039, height: 36, name: Pret A Manger, short_name: Pret, takeaway: yes
- Colmore Row, B3 2QD Birmingham, disused:amenity: bank, height: 36, old_name: Halifax
- Colmore Row, B3 2QD Birmingham, (Sainsbury's Local Colmore Row), brand: Sainsbury's Local, height: 36, name: Sainsbury's Local, nohousenumber: yes, shop: convenience, website: https://stores.sainsburys.co.uk/4894/birmingham-colmore-row-local
- 5 St Philip's Place, B3 2PW Birmingham, height: 36
- Colmore Row (oneway 2-lane asphalt road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h
- Livery Street (oneway 1-lane asphalt road, lit), cycleway:left: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: left
- Livery Street (oneway 2-lane asphalt road, lit), cycleway:both: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B3, sidewalk: both
- Colmore Row (oneway 1-lane asphalt road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h
