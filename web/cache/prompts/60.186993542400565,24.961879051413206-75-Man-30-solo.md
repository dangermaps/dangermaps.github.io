...
The tourist is currently located at these coordinates: 60°11'13.18"N, 24°57'42.76"E (60.186993542400565, 24.961879051413206).
Name of Road: Vilhonvuorenkuja
...
- 8 Vilhonvuorenkuja, Helsinki (5m)
- access: private, addr:housenumber: 8, addr:street: Vilhonvuorenkuja, addr:unit: B, entrance: staircase (6m)
- 25 Hämeentie, 00500 Helsinki (11m)
- 25 Hämeentie, 00500 Helsinki, branch: Hämeentie, brand: Alepa, diet:halal: no, diet:kosher: no, name: Alepa, opening_hours: 24/7, payment:credit_cards: yes, payment:debit_cards: yes, shop: convenience, website: https://s-kanava.fi/toimipaikka/alepa-hameentie/512504267, wheelchair: yes (11m)
- access: yes, addr:housenumber: 25, addr:street: Hämeentie, addr:unit: B, entrance: yes, wheelchair: yes (12m)
- access: yes, addr:housenumber: 25, addr:street: Hämeentie, entrance: yes, wheelchair: yes (15m)
- access: private, addr:housenumber: 8, addr:street: Vilhonvuorenkuja, addr:unit: A, entrance: staircase (15m)
- access: private, addr:housenumber: 25, addr:street: Hämeentie, addr:unit: A, entrance: yes (16m)
- With keycode, access: private, barrier: gate (19m)
- ele: 20, source:ele: barometric*1 (20m)
- Alepa deliveries, access: delivery, entrance: service, wheelchair: yes (21m)
- access: no, barrier: lift_gate (23m)
- access: private, barrier: gate (24m)
- Archi tattoo, addr:housenumber: 23, addr:street: Hämeentie, level: 1, shop: tattoo (26m)
- access: yes, addr:housenumber: 23, addr:street: Hämeentie, entrance: yes, wheelchair: no (28m)
- access: private, addr:housenumber: 10, addr:street: Vilhonvuorenkuja, addr:unit: D, entrance: staircase (28m)
- Haircut room, addr:housenumber: 23, addr:street: Hämeentie, contact:instagram: haircut_room_, level: 1, shop: hairdresser (30m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I] (30m)
- traffic_sign: FI:871[Yksityisalue] (30m)
- access: yes, addr:housenumber: 23, addr:street: Hämeentie, entrance: yes, wheelchair: no (31m)
- traffic_sign: FI:372 (31m)
- traffic_sign: FI:344[12 t] (31m)
- fire hydrant (underground), diameter: 300, location: underground (32m)
- Julia Nails, addr:housenumber: 23, addr:street: Hämeentie, beauty: nails, shop: beauty (33m)
- 10 Vilhonvuorenkuja, Helsinki (33m)
- access: yes, addr:housenumber: 23, addr:street: Hämeentie, entrance: yes, wheelchair: no (34m)
- pääovi, Mustekasetti.com, mustekasetti.com, addr:housenumber: 27, addr:street: Hämeentie, entrance: yes, wheelchair: no (35m)
- traffic_sign: FI:372 (35m)
- traffic signals, traffic_signals: signal (35m)
- access: private, addr:housenumber: 23, addr:street: Hämeentie, addr:unit: A, entrance: staircase (36m)
- Tanema, addr:housenumber: 23, addr:street: Hämeentie, contact:website: https://www.villakoira.com, level: 1, shop: vacuum_cleaner (36m)
- mustekasetti.com, addr:housenumber: 27, addr:street: Hämeentie, level: 1, payment:credit_cards: yes, payment:debit_cards: yes, shop: yes (36m)
- denotation: park, leaf_cycle: deciduous, leaf_type: broadleaved, species: Ulmus glabra, species:fi: Vuorijalava, species:wikidata: Q147498, species:wikipedia: fi:Vuorijalava (37m)
- access: private, addr:housenumber: 10, addr:street: Vilhonvuorenkuja, addr:unit: C, entrance: staircase (37m)
- access: yes, addr:housenumber: 23, addr:street: Hämeentie, entrance: yes, wheelchair: no (38m)
- access: no, tunnel: entrance (39m)
- access: private, addr:housenumber: 6, addr:street: Vilhonvuorenkuja, addr:unit: C, entrance: staircase (40m)
- addr:unit: A, entrance: yes (47m)
...
- guard:operator: Vartioässät
- building:maintenance:operator: Lassila&Tikanoja, guard:operator: Securitas
- barrier: retaining_wall
- building:levels: 8, operator: Hämeentie 25, operator:type: cooperative, roof:levels: 0
- 50 Hämeentie, Helsinki, building:levels: 8, building:maintenance:operator: JJ-Erikoishuolto Oy, roof:material: metal
...
- barrier: fence
- Vilhonvuorenkuja (residential road), maxspeed: 30km/h, parking:condition:left: ticket, parking:condition:left:default: free, parking:condition:left:residents: I, parking:condition:left:time_interval: Mo-Fr 09:00-19:00, parking:left: yes, parking:left:orientation: parallel, parking:right: no, parking:right:restriction: no_parking, parking:ticket:zone: 3, paved:date: 2011
- footway, est_width: 0.6, footway: sidewalk, paved:date: 2011, surface: asphalt
- barrier: retaining_wall
- service, maxweight: 12, service: driveway
...
- service, service: driveway
- service, maxheight:signed: no, service: driveway, tunnel: yes
...
- steps, handrail: yes, incline: up, lit: yes, ramp: no, step_count: 30, surface: paving_stones
