...
The tourist is currently located at these coordinates: 52°28'50.36"N, 1°53'38.69"W (52.480655691078226, -1.8940811246880118).
Name of Road: Dale End
...
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: no, traffic_signals:vibration: no (6m)
- age: semi-mature, constituency: City Centre, height: 12, height:range: 11 to 11.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100004, ref:usrn: 2701547, site_name: DALE END, species: Tilia x europaea, species:wikidata: Q163760, tree_form: natural, ward: Ladywood (9m)
- Dale End, B4 7LS Birmingham, name: City Hair & Beauty, shop: hairdresser (10m)
- Dale End, B4 7LS Birmingham, name: Promises Promises, shop: erotic (10m)
- BS1 ( road, lit), bench: yes, bin: no, bus: yes, naptan:AtcoCode: 43000206701, naptan:NaptanCode: nwmajgag, public_transport: platform, shelter: yes (11m)
- 59 Dale End, B4 7LS Birmingham, fast food, cuisine: fish_and_chips, fhrs:id: 598786, name: Ocean Fish Bar, source:addr: FHRS Open Data (11m)
- Dale End, B4 7LS Birmingham, name: Drinkstop, shop: alcohol (13m)
- Priory Square, bicycle parking, bcc_ref: 561, bicycle_parking: stands, capacity: 8 (13m)
- Dale End, bicycle parking, bcc_ref: 267, bicycle_parking: stands, capacity: 4, check_date:capacity: 2021-08-06, covered: no (13m)
- Dale End, B4 7LS Birmingham (15m)
- Priory Square, B4 7LG Birmingham, name: Big "H", shop: variety_store (18m)
- Dale End, B4 7LS Birmingham, fast food, cuisine: chicken, fhrs:id: 604632, name: DFC Chicken (18m)
- Taylors and Lloyds commemorative plaque, fixme: is this still here?, historic: memorial, memorial: plaque, openplaques:id: 1586 (18m)
- age: semi-mature, constituency: City Centre, height: 12, height:range: 11 to 11.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100005, ref:usrn: 2701547, site_name: DALE END, species: Tilia x europaea, species:wikidata: Q163760, tree_form: natural, ward: Ladywood (19m)
- Dale End, B4 7LS Birmingham, name: Long Nails, shop: beauty (21m)
- age: semi-mature, constituency: City Centre, height: 10, height:range: 9 to 9.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100002, ref:usrn: 2701547, site_name: DALE END, species: Liquidambar styraciflua, species:wikidata: Q469652, tree_form: asymmetric, ward: Ladywood (22m)
- parking, access: customers, operator: Voi, operator:type: private, parking: e-scooter (23m)
- Dale End, B4 7LS Birmingham, bank, name: Streek UK (24m)
- taxi (26m)
- shop: vacant (26m)
- Dale End, B4 7LS Birmingham, pub, fhrs:id: 1179695, name: The Peaky Blinder (27m)
- Peaky Blinders Speakeasy, artwork:location: wall, artwork_type: streetart, tourism: artwork (28m)
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: no, traffic_signals:vibration: no (29m)
- age: semi-mature, constituency: City Centre, height: 8, height:range: 7 to 7.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100003, ref:usrn: 2701547, site_name: DALE END, species: Liquidambar styraciflua, species:wikidata: Q469652, tree_form: unbalanced, ward: Ladywood (31m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (31m)
- Sabina City Hair and Cosmetics, operator: Sabina City Hair and Cosmetics, shop: cosmetics (32m)
- age: semi-mature, constituency: City Centre, fixme: Is this still here?, genus: Platanus, height: 16, height:range: 15 to 15.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100011, ref:usrn: 2735830, site_name: ALBERT STREET, species: Platanus x acerifolia, tree_form: asymmetric, ward: Ladywood (33m)
- shop: vacant (35m)
- telephone, booth: InLink, fixme: Still here? Needs re-survey, internet_access: wlan, internet_access:fee: no, operator: BT (37m)
- railway: tram_level_crossing (38m)
- railway: tram_crossing (40m)
- railway: tram_level_crossing (40m)
- Bull Street near Dale End, bicycle parking, bcc_ref: 550, bicycle_parking: stands, capacity: 8, check_date:capacity: 2021-06-04, covered: no, fixme: Still here? Needs re-survey (40m)
- bicycle parking, access: customers, capacity: 10, operator: Voi, operator:type: private, small_electric_vehicle: designated (42m)
- Street Wear, shop: clothes (44m)
- entrance: yes, maxheight: 1.99, vehicle: yes (48m)

Within a 75m radius, there are also:
- footway, lit: yes, surface: paving_stones
- Priory Square (paving_stones road), area: yes
- Albert Street, parking, access: yes, capacity: 1200, fee: yes, operator: National Car Parks, operator:type: private, parking: multi-storey
- The Square, architect: Sir Frederick Gibberd, start_date: 1963
- Bull Street (twoway asphalt road, lit), access: no, bicycle: yes, bus: yes, cycleway: opposite, cycleway:right: lane, emergency: yes, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h
- footway, covered: arcade
- New Meeting Street (asphalt road, lit), lane_markings: no, maxspeed: 20 mphkm/h
- Albert Street (asphalt road, lit), bus: yes, cycleway:both: no, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- Dale End (2-lane asphalt road, lit), cycleway:both: shared_lane, cycleway:both:lane: pictogram, gritting: priority_3, maintenance: gritting, maxheight: default, maxspeed: 20 mphkm/h, motor_vehicle: destination, postal_code: B4, sidewalk: both
- service, surface: asphalt
- unclassified, oneway: yes
- unclassified, oneway: yes
- Dale End (oneway 2-lane asphalt road, lit), cycleway:both: shared_lane, cycleway:both:lane: pictogram, gritting: priority_3, maintenance: gritting, maxheight: default, maxspeed: 20 mphkm/h, motor_vehicle: destination, postal_code: B4, sidewalk: both
- unclassified, oneway: yes
- Dale End (oneway 2-lane asphalt road, lit), cycleway:both: shared_lane, cycleway:both:lane: pictogram, gritting: priority_3, maintenance: gritting, maxheight: default, maxspeed: 20 mphkm/h, motor_vehicle: destination, postal_code: B4, sidewalk: both
- High Street (oneway asphalt road, lit), bicycle: yes, bus: yes, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, motor_vehicle: destination, psv: yes
- Albert Street (asphalt road, lit), bus: yes, cycleway:both: no, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- Albert Street (asphalt road, lit), bus: yes, cycleway:both: no, gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- Birmingham Eastside Extension, construction: tram, construction:railway: tram, electrified: contact_line, frequency: 0, gauge: 1435, railway: tram, source:track_in_situ: https://metroalliance.co.uk/wp-content/uploads/2025/01/Eastside-Edition-22-Jan-2025-compressed.pdf?fbclid=IwY2xjawIBC4VleHRuA2FlbQIxMAABHYRIJHtEdMeHHZPZ6EoVQ3GwE9eIpyqqklAi-1_EDIiUgof1_Vmt46TZIQ_aem_ZU3QyHQBpUS8OkBS0kw8mA, voltage: 750
- Birmingham Eastside Extension, Indicative: 137, Mode: Metro, Phase_1: Development, Phase_2: Development, construction:electrified: contact_line, construction:frequency: 0, construction:voltage: 750, funded_secured: yes, proposed: tram, proposed:railway: tram, railway: tram, source:track_in_situ: https://metroalliance.co.uk/wp-content/uploads/2025/01/Eastside-Edition-22-Jan-2025-compressed.pdf?fbclid=IwY2xjawIBC4VleHRuA2FlbQIxMAABHYRIJHtEdMeHHZPZ6EoVQ3GwE9eIpyqqklAi-1_EDIiUgof1_Vmt46TZIQ_aem_ZU3QyHQBpUS8OkBS0kw8mA
