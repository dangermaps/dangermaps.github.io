...
The tourist is currently located at these coordinates: 37°59'50.11"N, 23°43'20.31"E (37.99725366916875, 23.722308471172866).
...
- ΠΛΑΤΕΙΑ ΑΤΤΙΚΗΣ ( road, unlit), bench: yes, bin: no, bus: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΑΣΑ, passenger_information_display: yes, public_transport: platform, shelter: yes (6m)
- ΠΛΑΤΕΙΑ ΑΤΤΙΚΗΣ, bus: yes, operator: ΟΑΣΑ, public_transport: stop_position, shelter: no (27m)
- ΠΛΑΤΕΙΑ ΑΤΤΙΚΗΣ ( road, unlit), bench: no, bin: yes, bus: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΑΣΑ, public_transport: platform, shelter: no (28m)
- Λιοσίων, Αθήνα, restaurant, cuisine: greek, name: Η Λέσχη του φαγητού (29m)
- 133 Λιοσίων, 10445 Αθήνα (32m)
- 121 Λιοσίων, 10445 Αθήνα (33m)
