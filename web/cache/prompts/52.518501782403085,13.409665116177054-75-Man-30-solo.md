...
The tourist is currently located at these coordinates: 52°31'6.61"N, 13°24'34.79"E (52.518501782403085, 13.409665116177054).
Name of Road: Rathausstraße
...
- camera:angle: 25, camera:direction: 300, camera:mount: wall, camera:type: fixed, height: 5.50, man_made: surveillance, surveillance: outdoor, surveillance:type: camera, surveillance:zone: parking (7m)
- entrance: service, maxheight: 4.2 (11m)
- 50 Jüdenstraße, 10178 Berlin, addr:suburb: Mitte (12m)
- camera:direction: 240, camera:mount: wall, camera:type: dome, height: 3.5, man_made: surveillance, surveillance: indoor, surveillance:type: camera, surveillance:zone: building (13m)
- camera:direction: 10, camera:mount: wall, camera:type: dome, height: 2.50, man_made: surveillance, surveillance: indoor, surveillance:type: camera, surveillance:zone: building (13m)
- street lamp (14m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: yes, traffic_signals:vibration: yes (25m)
- traffic signals, traffic_signals: signal (26m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 4, covered: no, fee: no, operator:type: public (27m)
- camera:angle: 25, camera:direction: 180, camera:mount: wall, camera:type: fixed, height: 4.20, man_made: surveillance, surveillance: indoor, surveillance:type: camera, surveillance:zone: parking_entrance (27m)
- camera:angle: 10, camera:direction: 260, camera:mount: wall, camera:type: fixed, height: 2.50, man_made: surveillance, surveillance: indoor, surveillance:type: camera, surveillance:zone: parking_entrance (27m)
- 5+7 Grunerstraße, 10178 Berlin, car rental, addr:suburb: Mitte, brand: SIXT, contact:phone: +49 1806292929, name: SIXT, wheelchair: yes (27m)
- street lamp (28m)
...
- crossing, traffic_signals, button_operated: yes, crossing:signals: yes, traffic_signals:sound: yes, traffic_signals:vibration: yes (32m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 2, covered: no, fee: no (34m)
- Cop GmbH & Co. Shop Berlin KG Sicherheitsausrüster, addr:postcode: 10178, phone: +49 30 69582727, shop: security_materials (34m)
- street lamp (36m)
- 1 Jüdenstraße, 10178 Berlin, addr:suburb: Mitte (37m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 40, covered: no, fee: no (40m)
- crossing, traffic_signals, button_operated: yes, crossing:signals: yes, traffic_signals:sound: yes, traffic_signals:vibration: yes (44m)
- charging station, amperage: 32, authentication:short_message: yes, brand: e.on Drive, capacity: 2, fee: yes, note:de: Jüdenstraße vor rotem Rathaus, operator: E.ON, socket:type2: 2, source:delivery_date: 2011/01/17, voltage: 400 (48m)
- street lamp (49m)

Within a 75m radius, there are also:
- Gustav-Böß-Straße (oneway 3-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, dual_carriageway: yes, lane_markings: yes, maxspeed: 30km/h, postal_code: 10178, priority_road: designated, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
...
- building:colour: #aa6957, building:levels: 4, building:material: brick, building:part: yes, designation: Berliner Rathaus, height: 30, roof:material: tar_paper, roof:shape: flat
- building:levels: 7
- Grunerstraße (oneway 3-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, dual_carriageway: yes, lane_markings: yes, maxspeed: 30km/h, parking:both: no, postal_code: 10179, priority_road: designated, sidewalk:left: no, sidewalk:right: separate, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
- footway, check_date:surface: 2023-11-11, colonnade:left: open, covered: colonnade, footway: sidewalk, lit: yes, postal_code: 10179, surface: paving_stones
- service, service: driveway, surface: sett
- Jüdenstraße (residential asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Jüdenstraße (Berlin-Mitte), cycleway:both: no, maxspeed: 30km/h, postal_code: 10178, sidewalk:both: separate, smoothness: good
- footway, traffic_signals, button_operated: no, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt, traffic_signals:sound: yes
...
- footway, traffic_signals, button_operated: yes, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt, traffic_signals:sound: yes
- footway, traffic_signals, button_operated: yes, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt, traffic_signals:sound: yes
- footway, check_date:surface: 2021-11-12, footway: sidewalk, lit: yes, postal_code: 10179, smoothness: good, surface: paving_stones
- footway, check_date:surface: 2021-11-12, footway: sidewalk, lit: yes, postal_code: 10179, smoothness: good, surface: paving_stones
- Grunerstraße (oneway 2-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), cycleway:left: no, cycleway:right: separate, dual_carriageway: yes, maxspeed: 30km/h, parking:both: no, postal_code: 10179, priority_road: designated, sidewalk:left: no, sidewalk:right: separate, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
