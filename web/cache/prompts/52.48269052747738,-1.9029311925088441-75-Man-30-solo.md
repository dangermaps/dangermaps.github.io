...
The tourist is currently located at these coordinates: 52°28'57.69"N, 1°54'10.55"W (52.48269052747738, -1.9029311925088441).
...
- Blue Plaque: Birmingham Guild of Handicraft Arthur Stansfield Dixon, historic: memorial (20m)
- telephone, access: yes, advertising: totem, defibrillator:location: Attached to an advertising totem and phone booth., emergency: defibrillator, indoor: no, not:ref:GB:the_circuit: 2D0E4EF8-63D9-4E86-A849-7758B0FD110A;A01421F6-832C-41EE-BFC1-AE6700926D2B;622F812F-0961-4140-A22E-AF2000BBED25, opening_hours: 24/7, operator: JCDecaux (31m)
- man_made: tower, tower:type: communication (31m)
- fire hydrant (underground), operator: WMFS (33m)
- man_made: tower, tower:type: communication (34m)

Within a 75m radius, there are also:
- New Market Street (asphalt road, lit), maxspeed: 20 mphkm/h, postal_code: B3, sidewalk: both
- Queensway (oneway 2-lane road, lit), gritting: priority_1, length: 548m, maintenance: gritting, maxheight: default, maxspeed: 30 mphkm/h, not:name: Queensway (Tunnel), source:name: survey; OS_Locator, tunnel: yes
...
- 67 Newhall Street, B3 1NQ Birmingham, addr:housename: Lancaster House, building:levels: 7
- Great Charles Street Car Park, parking, fee: yes, operator: Birmingham City Council, parking: surface
...
- height: 42, source:height: emuanalytics
- 61-71 Cornwall Street, B3 2EE Birmingham, building:levels: 6, name: Vodafone
- 43;45 Great Charles Street Queensway, B3 2LX Birmingham, architect: Arthur S Dixon, height: 38, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, name: New Guild House, source:addr:postcode: code-point_open, source:height: emuanalytics, start_date: 1897
...
- access: private, disused:highway: footway, disused:tunnel: yes, operator: BT
