...
The tourist is currently located at these coordinates: 37°59'47.67"N, 23°43'23.39"E (37.99657539036903, 23.723163434903636).
...
- stop (6m)
- 16 Αδμήτου, 10440 Αθήνα (6m)
- 47 Αγορακρίτου, 10440 Αθήνα (10m)
- shop: kiosk (11m)
- toilets (24m)
- stop, direction: forward (24m)

Within a 75m radius, there are also:
- Admitou (oneway asphalt road), lane_markings: no, smoothness: intermediate, source:width: ARCore, width: 7.8
- Πλατεία Αττικής
- Αγορακρίτου (oneway 3-lane asphalt road), trolley_wire: yes
- Αγορακρίτου (residential oneway asphalt road, lit), sidewalk: both
