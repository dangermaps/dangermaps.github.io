...
The tourist is currently located at these coordinates: 37°59'35.46"N, 23°43'38.78"E (37.99318399637044, 23.727438253557487).
Name of Road: Χέυδεν
...
- 31 Χέυδεν, Αθήνα, name: Addis Market, shop: convenience (31m)
- 31 Χέυδεν, Αθήνα, name: Anahita, shop: hairdresser (35m)
- stop (39m)
- crossing (41m)
- 76 Αχαρνών, 10434 Αθήνα, name: American (45m)
- traffic signals, traffic_signals: signal (46m)

Within a 75m radius, there are also:
- Μαμάη (residential oneway asphalt road)
- Έλλης (residential oneway asphalt road)
- Κατριβάνου (residential oneway asphalt road)
- 2ο Γενικό Λύκειο Αθηνών, school
