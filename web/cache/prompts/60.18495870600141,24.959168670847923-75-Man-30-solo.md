...
The tourist is currently located at these coordinates: 60°11'5.85"N, 24°57'33.01"E (60.18495870600141, 24.959168670847923).
Name of Road: Sakarinkatu
...
- access: private, addr:housenumber: 3, addr:street: Sakarinkatu, addr:unit: B, entrance: staircase, wheelchair: no (5m)
- 3 Sakarinkatu, Helsinki (7m)
- traffic_sign: FI:511 (8m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I] (9m)
- traffic_sign: FI:511 (9m)
- access: yes, addr:housenumber: 3, addr:street: Sakarinkatu, entrance: yes (11m)
- Studio Micas, addr:housenumber: 3, addr:street: Sakarinkatu, level: 1, payment:credit_cards: yes, payment:debit_cards: yes, shop: beauty (12m)
- crossing, uncontrolled, check_date:crossing: 2020-12-05 (14m)
- access: private, addr:housenumber: 3, addr:street: Sakarinkatu, entrance: yes, wheelchair: no (15m)
- With keycode, access: private, addr:housenumber: 3, addr:street: Sakarinkatu, addr:unit: A, entrance: staircase, wheelchair: no (17m)
- Näkemys, addr:housenumber: 3, addr:street: Sakarinkatu, healthcare: yes, level: 1 (18m)
- crossing, uncontrolled, check_date:crossing: 2020-12-05 (18m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I] (19m)
- 17 Pengerkatu, Helsinki (19m)
- vending machine, currency:EUR: yes, opening_hours: Mo-Fr 09:00-19:00, operator: HKR, parking:ticket:zone: 3, vending: parking_tickets (20m)
- With keycode, access: private, addr:housenumber: 4, addr:street: Sakarinkatu, addr:unit: B, entrance: staircase, wheelchair: no (21m)
- traffic_sign: FI:511 (21m)
- 4 Sakarinkatu, 00530 Helsinki (22m)
- Nurk & Spacement, addr:housenumber: 15, addr:street: Pengerkatu, office: yes (23m)
- crossing, uncontrolled (23m)
- access: yes, addr:housenumber: 15, addr:street: Pengerkatu, entrance: yes (24m)
- access: yes, addr:housenumber: 1, addr:street: Sakarinkatu, entrance: yes (25m)
- 15 Pengerkatu, Helsinki (25m)
- traffic_sign: FI:511 (26m)
- crossing, uncontrolled (26m)
- With keycode, access: private, addr:housenumber: 17, addr:street: Pengerkatu, addr:unit: C, entrance: staircase, wheelchair: no (27m)
- With keycode, access: private, addr:housenumber: 15, addr:street: Pengerkatu, addr:unit: A, entrance: staircase (27m)
- access: yes, addr:housenumber: 1, addr:street: Sakarinkatu, entrance: yes, wheelchair: no (28m)
- traffic_sign: FI:331, traffic_sign:2: FI:417 (28m)
- Almary Kauneushoitola, addr:housenumber: 1, addr:street: Sakarinkatu, payment:credit_cards: yes, payment:debit_cards: yes, shop: beauty (29m)
- traffic_sign: FI:511 (29m)
- With buzzer, access: private, addr:housenumber: 1, addr:street: Sakarinkatu, addr:unit: B, entrance: staircase (31m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I], traffic_sign:4: FI:551[left], traffic_sign:5: FI:871[← Lippuautomaatti] (32m)
- access: private, barrier: gate (36m)
- access: private, addr:housenumber: 2, addr:street: Sakarinkatu, addr:unit: D, entrance: staircase (37m)
- traffic_sign:bug:missing: FI:363[30];FI:364[30] (37m)
- With buzzer, access: private, addr:housenumber: 38, addr:street: Hämeentie, addr:unit: C, entrance: staircase (38m)
- access: private, barrier: gate (38m)
- traffic_sign: FI:677a[24 h], traffic_sign:2: FI:871[Pysäköinti omalla vastuulla Yksityisalue], traffic_sign:3: FI:342[2,2 m], traffic_sign:4: FI:871[Korkeus maks. 1,5m merkityillä alueilla], traffic_sign:5: FI:871[Samma på svenska], traffic_sign:6: FI:835 (38m)
- With buzzer, access: private, barrier: gate (40m)
- access: yes, addr:housenumber: 2, addr:street: Sakarinkatu, entrance: yes, wheelchair: no (43m)
- access: private, barrier: gate (45m)
- addr:housenumber: 2, addr:street: Sakarinkatu, addr:unit: C, entrance: staircase, wheelchair: no (46m)
- FIXME:pipeline: Sijainti tuuletusputkesta., manhole: heat (47m)
- highway:give_way: yes (51m)

Within a 75m radius, there are also:
- 38 Hämeentie, Helsinki, building:levels: 8, building:maintenance:operator: Huoltoalanen Oy
- building:levels: 7, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy, operator: Hämeentie 36, operator:type: cooperative
- Pengerkatu (residential oneway 1-lane paved road), maxspeed: 30km/h, snowplowing: yes
...
- footway, lit: yes, snowplowing: yes, surface: paved
- Sakarinkatu (residential 2-lane asphalt road, lit), maxspeed: 30km/h, parking:both: no, parking:both:restriction: no_stopping, sidewalk:both: separate, snowplowing: yes
...
- Pengerkatu (residential oneway 1-lane paved road), maxspeed: 30km/h, parking:both: no, parking:both:restriction: no_parking, snowplowing: yes
...
- steps, incline: up
- footway, bicycle: no, footway: sidewalk, lit: yes, snowplowing: yes, surface: asphalt
- 13b Pengerkatu, Helsinki, building:levels: 7, building:maintenance:operator: Insales Oy
...
- building:levels: 8, building:min_level: 6, building:part: yes
- building:levels: 6, building:maintenance:operator: Kiinteistöhuolto Hussein Tmi
- building:levels: 8, building:maintenance:operator: Kiinteistöhuolto Toivonen Oy
...
- barrier: fence
- barrier: retaining_wall
- Sakarinkatu (residential 2-lane asphalt road, lit), maxspeed: 30km/h, parking:both: lane, parking:both:orientation: parallel, parking:both:placement: on_street, parking:condition:both: ticket, parking:condition:both:default: free, parking:condition:both:residents: I, parking:condition:both:time_interval: Mo-Fr 09:00-21:00, parking:ticket:zone: 3, sidewalk:both: separate, snowplowing: yes
- man_made: beam
- man_made: beam
- man_made: beam
- man_made: beam
