...
The tourist is currently located at these coordinates: 60°11'27.83"N, 24°57'18.37"E (60.191063215198874, 24.9551031).
...
- traffic_sign: FI:417 (5m)
- street lamp, traffic_sign: FI:142, traffic_sign:2: FI:121, traffic_sign:3: FI:871, traffic_sign:4: FI:815 (7m)
- FIXME:pipeline: Sijainti liikkuvasta autosta., hole:diameter: 40cm, man_made: manhole, manhole: gas (11m)
- Helsinki, (city bike), bicycle rental, bicycle_rental: docking_station, capacity: 20, name: Gebhardinaukio, name:en: Gebhardinaukio, network: Helsinki&Espoo, opening_hours: 24/7, operator: City Bike Finland, payment:american_express: yes, payment:cash: no, payment:mastercard: yes, payment:visa: yes, seasonal: spring;summer;autumn, website: https://hsl.fi/kaupunkipyorat (13m)
...
- traffic_sign: FI:142, traffic_sign:2: FI:121, traffic_sign:3: FI:871, traffic_sign:4: FI:815 (16m)
- traffic_sign: FI:417 (16m)
- vending machine, currency:EUR: yes, opening_hours: Mo-Fr 09:00-19:00, operator: HKR, parking:ticket:zone: 3, vending: parking_tickets (17m)
- street lamp (18m)
- denotation: street, leaf_cycle: deciduous, leaf_type: broadleaved, species: Tilia x europaea, species:fi: Puistolehmus, species:wikidata: Q163760, species:wikipedia: fi:Puistolehmus (20m)
- denotation: street, leaf_cycle: deciduous, leaf_type: broadleaved, species: Tilia x europaea, species:fi: Puistolehmus, species:wikidata: Q163760, species:wikipedia: fi:Puistolehmus (22m)
- street lamp (22m)
- advertising: column (23m)
- traffic_sign: FI:521, traffic_sign:2: FI:845, traffic_sign:3: FI:855b[9-19], traffic_sign:4: FI:871[Vyöhyke 3 Kertamaksu enint. 4 h] (25m)
- street lamp (25m)
- denotation: street, leaf_cycle: deciduous, leaf_type: broadleaved, species: Tilia x europaea, species:fi: Puistolehmus, species:wikidata: Q163760, species:wikipedia: fi:Puistolehmus (28m)
- addr:housenumber: 2a, addr:postcode: 00510, addr:street: Suvannontie (28m)
- traffic_sign: FI:424 (29m)
- denotation: street, end_date: 2021-10, leaf_cycle: deciduous, leaf_type: broadleaved, was:natural: tree (30m)
- addr:housenumber: 3a, addr:postcode: 00510, addr:street: Teollisuuskatu (36m)
- street lamp (36m)
...
- Ihana Sushi, restaurant, cuisine: sushi (39m)
- leaf_type: broadleaved (40m)
- street lamp (43m)
- man_made: manhole, manhole: missing_gas, marker:label: Vesi-säil., marker:shape: circle (44m)
...
- advertising: column (50m)

Within a 75m radius, there are also:
- footway, bicycle: no, footway: sidewalk, lit: yes, smoothness: good, snowplowing: yes, surface: paving_stones
- service, surface: asphalt
- barrier: wall
- footway, bicycle: no, footway: sidewalk, lit: yes, surface: asphalt
- footway, lit: yes, surface: asphalt
- FIXME:pipeline: Vain kaksi kantta havaittu., location: underground, man_made: pipeline, substance: gas
- Teollisuuskatu (oneway 3-lane asphalt road, lit), bicycle: use_sidepath, cycleway:right: separate, fi:hkr:kunnossapitoluokka: I, guideposted_leads_to_ref: 1;3;45;51, lit:perceived: poor, maxspeed: 50km/h, placement: right_of:1, priority_road: designated
- Teollisuuskatu (oneway 2-lane asphalt road, lit), bicycle: use_sidepath, cycleway:right: separate, fi:hkr:kunnossapitoluokka: I, guideposted_leads_to_ref: 1;3;45;51, lit:perceived: poor, maxspeed: 50km/h, parking:condition:right:reason: turning_lane, parking:lane:left: no_stopping, parking:lane:right: no_parking, parking:lane:right:no_parking: on_kerb, placement: transition, priority_road: designated, snowplowing: yes
...
- Satamaradankatu (residential asphalt road, lit), fixme: Parking väärin, mutta osa merkkien tiedoista vielä puuttuu, lane_markings: no, maxspeed: 30km/h, parking:condition:left: ticket, parking:condition:left:default: free, parking:condition:left:time_interval: Mo-Fr 09:00-19:00, parking:condition:right: free, parking:lane:both:parallel: on_street, parking:ticket:zone: 3, railway: abandoned
- date_off: 2011, was:building: industrial
...
- service, surface: asphalt
- Teollisuuskatu (oneway 3-lane asphalt road, lit), bicycle: use_sidepath, cycleway:right: separate, fi:hkr:kunnossapitoluokka: I, guideposted_leads_to_ref: 1;3;45;51, lit:perceived: poor, maxspeed: 50km/h, parking:condition:right: ticket, parking:condition:right:maxstay: 4 h, parking:condition:right:time_interval: Mo-Fr 09:00-19:00, parking:lane:left: no_stopping, parking:lane:right: parallel, parking:lane:right:parallel: on_kerb, placement: right_of:1, priority_road: designated, snowplowing: yes
- planted: yes
...
- Teollisuuskatu (oneway 2-lane asphalt road, lit), bicycle: use_sidepath, fi:hkr:kunnossapitoluokka: I, guideposted_leads_to_ref: 170, lit:perceived: poor, maxspeed: 50km/h, parking:condition:reason:left: dual_carriage, parking:lane:left: no_stopping, parking:lane:right: no_parking, priority_road: designated, snowplowing: yes
- building:levels: 5
- addr:housenumber: 3a, addr:street: Teollisuuskatu, building:levels: 5
- building:levels: 5
...
- path, informal: yes, mtb:scale: 0, surface: unpaved
