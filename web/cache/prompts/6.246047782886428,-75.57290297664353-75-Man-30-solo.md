...
The tourist is currently located at these coordinates: 6°14'45.77"N, 75°34'22.45"W (6.246047782886428, -75.57290297664353).
Name of Road: Carrera 54
...
- speed camera, fixme: start-date not follow ISO 8601 system. Source https://tramitefoto.mintransporte.gov.co/static/public/files/sast-aprobados.json has values for keys 'operator':(tercero_solicitante), 'ref':("Radar doppler") and 'from'+'to' from Relation:enforcement, start_date: 10/12/2018, website: https://tramitefoto.mintransporte.gov.co/ubicaciones-aprobadas/ (20m)
- toilets, fee: no, opening_hours: Mo-Su 09:00-17:00 (21m)
- speed camera, fixme: start-date not follow ISO 8601 system. Source https://tramitefoto.mintransporte.gov.co/static/public/files/sast-aprobados.json has values for keys 'operator':(tercero_solicitante), 'ref':("Radar doppler") and 'from'+'to' from Relation:enforcement, start_date: 10/12/2018, website: https://tramitefoto.mintransporte.gov.co/ubicaciones-aprobadas/ (30m)

Within a 75m radius, there are also:
- San Juan (oneway 3-lane asphalt road)
- Parque de Las Luces, leisure: park
- 44-48 Carrera 54, 050015 Medellin, library, name: Biblioteca EPM, operator: EPM, phone: +574 3807516, website: https://www.grupo-epm.com/bibliotecaepm/, wheelchair: yes
- Fuentes EPM
- Fuentes EPM
