...
It is Sunday, Aug 13, 2023, 1:58 PM local time.

The tourist is currently located at these coordinates: 37°59'34.45"N, 23°43'48.73"E (37.99290162815103, 23.730201950067258).
Name of Road: 3ης Σεπτεμβρίου
...
- Victoria Taxi station, taxi (5m)
- traffic signals (10m)
- 94 3ης Σεπτεμβρίου, Αθήνα, cafe, brand: Coffee Island, cuisine: coffee_shop, name: Coffee Island, takeaway: yes (11m)
- 94 3ης Σεπτεμβρίου, Αθήνα, fast food, drive_through: no, name: Κουλουράδες (12m)
- crossing, traffic_signals (14m)
- post box, colour: yellow, drive_through: no, operator: Ελληνικά Ταχυδρομεία, operator:el: Ελληνικά Ταχυδρομεία, operator:en: Hellenic Post, short_name: ΕΛΤΑ (15m)
- 94 3ης Σεπτεμβρίου, Αθήνα (18m)
- ΠΛ. ΒΙΚΤΩΡΙΑΣ ( road), bus: yes, public_transport: platform, route_ref: 054 (19m)
- ΠΛ. ΒΙΚΤΩΡΙΑΣ ( road), bus: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΑΣΑ, passenger_information_display: no, public_transport: stop_position, shelter: yes (19m)
- recycling, recycling:clothes: yes, recycling:shoes: yes, recycling_type: container (20m)
- 3ης Σεπτεμβρίου, Αθήνα, shop: kiosk (21m)
- 92 3ης Σεπτεμβρίου, 10434 Αθήνα (22m)
- Victoria, public_transport: stop_position, railway: stop, subway: yes, wheelchair: yes (24m)
- Αθήνα, name: Αττικά Αρτοποιεία, shop: bakery (25m)
- crossing (26m)
- Victoria, subway entrance (wheelchair accessible) (27m)
- Victoria, subway entrance (wheelchair accessible) (28m)
- 16 Χέυδεν, 10434 Αθήνα, name: Perfect toys, shop: toys (29m)
- recycling, recycling:paper: yes (30m)
- Victoria, See Wikipedia: https://el.wikipedia.org/wiki/Σταθμός Βικτωρίας (Μετρό Αθήνας), network: Μετρό Αθήνας, operator: ΣΤΑΣΥ, public_transport: station, railway: station, station: subway, subway: yes (30m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 5, covered: no, fee: no (31m)
- 3 Πλατεία Κυριακού, Αθήνα, cafe (33m)
- Victoria Social Centre, social facility, addr:housenumber: 14, addr:street: Γκυιλφόρδου, fixme: might be on nearby building. The type of social facility might have to be updated too, operator: En Red Sos Refugiados, social_facility: soup_kitchen, social_facility:for: refugees (33m)
- 87 3ης Σεπτεμβρίου, 10434 Αθήνα (34m)
- shop: convenience (35m)
- To kalamaki tis kyras Sofias, fast food, addr:housenumber: 15, addr:street: Χέυδεν, cuisine: souvlaki (35m)
- 96 3ης Σεπτεμβρίου, Αθήνα (38m)
- 3 Πλατεία Βικτωρίας, Αθήνα, name: Cut N' Go, shop: hairdresser (38m)
- 3ης Σεπτεμβρίου, Αθήνα, shop: kiosk (38m)
- 11 Γκυιλφόρδου, Αθήνα (40m)
- 85 3ης Σεπτεμβρίου, Αθήνα, cafe, name: Coffee Orange (41m)

Within a 75m radius, there are also:
- Γκυιλφόρδου (residential oneway 1-lane asphalt road)
- Πλατεία Κυριακού (residential oneway asphalt road)
- Victoria Square, area: yes, place: square, surface: paving_stones
- September 3 (oneway 2-lane asphalt road)
- 90 3ης Σεπτεμβρίου, 10434 Αθήνα
- 14 Χέυδεν, 10434 Αθήνα
- public_transport: platform, railway: platform, train: yes, tunnel: yes
- public_transport: platform, railway: platform, train: yes, tunnel: yes
- leisure: outdoor_seating, operator: Goody's
- Χέυδεν (residential oneway asphalt road)
- Line 1, (Green line), colour: #007A33, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, network: Μετρό Αθήνας, operator: ΣΤΑΣΥ, railway: subway, start_date: 1948-03-01, tunnel: yes, usage: main, voltage: 750
- Line 1, (Green line), colour: #007A33, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, network: Μετρό Αθήνας, operator: ΣΤΑΣΥ, railway: subway, start_date: 1948-03-01, tunnel: yes, usage: main, voltage: 750
