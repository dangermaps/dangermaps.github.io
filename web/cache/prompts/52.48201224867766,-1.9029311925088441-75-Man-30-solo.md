...
The tourist is currently located at these coordinates: 52°28'55.24"N, 1°54'10.55"W (52.48201224867766, -1.9029311925088441).
Name of Road: Newhall Street
...
- fire hydrant (underground) (14m)
- Grove Tompkins Bosworth, office: lawyer (15m)
- Dental Practice, dentist, healthcare: dentist (17m)
- 58 Newhall Street, B3 3RJ Birmingham, cafe, fhrs:id: 603229, name: Café Costes, previous_name: Charlie's No 1 (18m)
- NH2 ( road, unlit), bench: no, bin: no, bus: yes, naptan:AtcoCode: 43000284502, naptan:Bearing: SE, naptan:BusStopType: MKD, naptan:CommonName: Great Charles St, naptan:Indicator: Stop NH2, naptan:NaptanCode: nwmwgpmw, naptan:PlusbusZoneRef: West Midlands, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: NEWHALL ST, naptan:Towards: City Centre, naptan:verified: no, public_transport: platform, route_ref: 101, shelter: no (19m)
- Cornwall Street, bicycle parking, bicycle_parking: stands, capacity: 4 (21m)
- give way (21m)
- give way (23m)
- 55 Newhall Street, B3 3RB Birmingham, addr:housename: Avebury House, email: hello@ecommercedesign.agency, name: eCommerce Agency, office: yes, phone: +44121 371 0435, website: https://ecommercedesign.agency/ (26m)
- Jojolapa, restaurant, cuisine: nepalese (27m)
- man_made: tower, tower:type: communication (27m)
- internet_access: wlan, operator: BT, service: Birmingham FIZ (29m)
- man_made: surveillance (31m)
- communication:mobile_phone: yes, man_made: mast, operator: EE, tower:type: communication (32m)
- man_made: street_cabinet, operator: Orange, utility: telecom (34m)
- man_made: tower, tower:type: communication (34m)
- internet_access: wlan, man_made: surveillance, operator: BT, service: Birmingham FIZ (36m)
- 64 Newhall Street, B3 3RJ Birmingham, restaurant, cuisine: pizza, name: Mediterranean Pizza, old_name: Subway (37m)
- Cogs, bar, disused: yes (37m)
- man_made: tower, tower:type: communication (37m)
- Capsticks, office: lawyer (38m)
- fire hydrant (underground) (41m)
- man_made: tower, tower:type: communication (41m)
- traffic signals (41m)
- NH7, naptan:AtcoCode: 43000284503, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Great Charles St, naptan:Indicator: Stop NH7, naptan:NaptanCode: nwmagpwj, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: NEWHALL ST, naptan:Towards: Newtown and Perry Common, naptan_refresh: query (42m)
- vending machine, vending: parking_tickets (42m)
- fire hydrant (underground) (43m)
- fire hydrant (underground) (44m)
- fire hydrant (underground), operator: WMFS (45m)
- traffic signals (49m)

Within a 75m radius, there are also:
- Cornwall Street (oneway asphalt road, lit), maxspeed: 20 mphkm/h, postal_code: B3
- Newhall Street (2-lane asphalt road, lit), See Wikipedia: https://en.wikipedia.org/wiki/Newhall Street, cycleway:both: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B3, sidewalk: both
- 37-38 Great Charles Street Queensway, B3 3JN Birmingham, addr:housename: York House, building:levels: 6
- Queensway (oneway 2-lane road, lit), gritting: priority_1, length: 548m, maintenance: gritting, maxspeed: 30 mphkm/h, not:name: Queensway (Tunnel), source:name: survey; OS_Locator, tunnel: yes
- 54 Newhall Street, B3 3QG Birmingham, building:levels: 4, heritage: 2, heritage:operator: Historic England, listed_status: Grade II
- 40 Great Charles Street Queensway, B3 2LX Birmingham, height: 38, name: Devonshire House, source:height: emuanalytics
- 73 Cornwall Street, B3 2DF Birmingham, bar, fhrs:id: 1045204, height: 38, name: Zen Metro, source:height: emuanalytics
- 89;91 Cornwall Street, B3 3BY Birmingham, architect: C E Bateman, building:levels: 4, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*
- 43,45 Newhall Street, B3 3QR Birmingham, bar, brand: All Bar One, fhrs:id: 601066, height: 38, name: All Bar One, source:height: emuanalytics
- 35 Church Street, B3 3PU Birmingham
- 61-71 Cornwall Street, B3 2EE Birmingham, building:levels: 6, name: Vodafone
- 100;102 Edmund Street, B3 3PN Birmingham, building:levels: 5, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Louisa Ryland House, source:named_for: Wikipedia
- 58;60 Newhall Street, B3 3RJ Birmingham, building:levels: 4, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*
- 43-51 Newhall Street, B3 3RB Birmingham, height: 38, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Cornwall Buildings, source:height: emuanalytics
- 55 Newhall Street, B3 3RB Birmingham, height: 38, source:height: emuanalytics
- 61 Newhall Street, B3 3RB Birmingham, height: 38, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:addr:postcode: code-point_open, source:height: emuanalytics
- height: 38, source:height: emuanalytics
- 85;87 Cornwall Street, B3 3BY Birmingham, building:levels: 4, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, name: Cornwall Chambers
- 50 Newhall Street, B3 3RJ Birmingham, building:levels: 4, heritage: 2, heritage:operator: Historic England, listed_status: Grade II
- 52 Newhall Street, B3 3RJ Birmingham, building:levels: 4, heritage: 2, heritage:operator: Historic England, listed_status: Grade II
- Great Charles Street Queensway (oneway 1-lane paved road, lit), gritting: priority_2, maintenance: gritting, maxspeed: 30 mphkm/h, not:name: Sherlock Street, postal_code: B3
- Cornwall Street (asphalt road, lit), maxspeed: 20 mphkm/h, postal_code: B3
- Newhall Street (2-lane asphalt road, lit), See Wikipedia: https://en.wikipedia.org/wiki/Newhall Street, cycleway:both: no, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B3, sidewalk: both
