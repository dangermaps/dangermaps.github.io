...
The tourist is currently located at these coordinates: 52°31'26.14"N, 13°24'58.71"E (52.52392801280083, 13.416308793648438).
Name of Road: Bernhard-Weiß-Straße
...
- 6 Bernhard-Weiß-Straße, 10178 Berlin, addr:suburb: Mitte (20m)
- entrance: yes (23m)
- bicycle parking, bicycle_parking: stands, capacity: 20, covered: no, fee: no (23m)
- defibrillator:location: Rechts der Rezeption in der Raumecke, defibrillator:location:en: To the right of reception in a room niche, emergency: defibrillator, indoor: yes (24m)
- wheelchair: yes (25m)
- entrance: main (25m)
- 6 Bernhard-Weiß-Straße, 10178 Berlin, fast food, addr:suburb: Mitte, contact:email: mitte.berlin@wandel-restaurant.de, contact:phone: +49 30 24047230, contact:website: https://www.wandel-restaurant.de/restaurants/wandel-berlin-mitte, cuisine: canteen, diet:vegan: no, diet:vegetarian: yes, indoor_seating: yes, name: Wandel, opening_hours: Mo-Fr 08:00-14:30, operator: Widynski & Roick GmbH, outdoor_seating: yes, toilets:wheelchair: yes, website:menu: https://portal.wandel-restaurant.de/menu/Wandel%20Restaurant%20Berlin%20Mitte/Berlin%20Mitte, wheelchair: yes (26m)
- fire hydrant (underground), operator: Berliner Wasserbetriebe (27m)
- 6 Bernhard-Weiß-Straße, 10178 Berlin, addr:suburb: Mitte, contact:phone: +49 30 902275000, contact:website: https://www.berlin.de/sen/bjf/, government: ministry, name: Senatsverwaltung für Bildung, Jugend und Familie, office: government (27m)
- railway: power_supply, voltage: 750 (30m)
- 6 Bernhard-Weiß-Straße, 10178 Berlin, Netzwerkstelle der Jugendberufsagentur Berlin, addr:suburb: Mitte, contact:phone: +49 30 902272976, contact:website: https://jba-berlin.de, government: employment_agency, name: Jugendberufsagentur Berlin, office: government, operator: Senatsverwaltung für Bildung, Jugend und Wissenschaft, operator:type: government (30m)
- railway: power_supply, voltage: 750 (33m)
- railway: tram_level_crossing (36m)
- atm, operator: Euronet Worldwide (37m)
- railway: tram_crossing (38m)
- wheelchair: yes (41m)
- crossing, unmarked (44m)

Within a 75m radius, there are also:
- Bernhard-Weiß-Straße (residential asphalt road, lit), cycleway:both: no, lane_markings: no, maxspeed: 30km/h, maxspeed:type: DE:zone30, parking:both: lane, parking:both:orientation: parallel, postal_code: 10178, sidewalk:both: separate, smoothness: good, source:width: ARCore, traffic_sign: DE:274.1, width: 13.8, zone:maxspeed: DE:30
- Theanolte-Bähnisch-Straße (residential asphalt road, lit), cycleway:both: no, lane_markings: no, maxspeed: 30km/h, maxspeed:type: DE:zone30, parking:both: street_side, parking:both:fee: yes, parking:both:fee:conditional: no @ (Mo-Fr 00:00-09:00,20:00-24:00; Sa 00:00-09:00,18:00-24:00), parking:both:orientation: parallel, parking:both:zone: 14, postal_code: 10178, sidewalk:left: separate, sidewalk:right: yes, smoothness: good, traffic_sign: DE:274.1, zone:maxspeed: DE:30
- electrified: contact_line, frequency: 0, gauge: 1435, maxspeed: 30km/h, operator: Berliner Verkehrsbetriebe, railway: tram, railway:electricity:ref: 204.06, voltage: 750
- electrified: contact_line, frequency: 0, gauge: 1435, maxspeed: 30km/h, operator: Berliner Verkehrsbetriebe, railway: tram, railway:electricity:ref: 204.06, voltage: 750
- 8 Bernhard-Weiß-Straße, 10178 Berlin, addr:suburb: Mitte, brand: greet, building:levels: 8, internet_access: wlan, name: Greet Berlin Alexanderplatz, operator: accor, roof:shape: flat, tourism: hotel, wheelchair: limited
- Bernhard-Weiß-Straße (residential asphalt road, lit), bicycle: use_sidepath, check_date:smoothness: 2023-03-04, cycleway:left: separate, lane_markings: no, maxspeed: 30km/h, maxspeed:type: DE:zone30, postal_code: 10178, sidewalk:both: separate, smoothness: good, traffic_sign: DE:274.1, width: 10, zone:maxspeed: DE:30
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
- service, access: private, surface: asphalt
- building:levels: 1, building:part: yes
- building:levels: 1, building:part: yes
- razed:building: commercial
- 25 Otto-Braun-Straße, 10178 Berlin, addr:suburb: Mitte, building:levels: 7, roof:colour: #7d837f, roof:shape: flat, wheelchair: yes
- building:levels: 8, building:part: yes
- service, access: private, surface: asphalt
- service, access: private, surface: asphalt, tunnel: building_passage
- service, oneway: yes, service: parking_aisle, smoothness: good, surface: asphalt
- parking, access: yes, fee: yes, park_ride: no, parking: surface, supervised: no, surface: asphalt
- building:levels: 8, building:part: yes
- building:levels: 7, building:part: yes
- building:levels: 8, building:part: yes
- Bernhard-Weiß-Straße (residential asphalt road, lit), cycleway:both: no, lane_markings: no, maxspeed: 30km/h, maxspeed:type: DE:zone30, postal_code: 10178, sidewalk:both: separate, smoothness: good, traffic_sign: DE:274.1, width: 10, zone:maxspeed: DE:30
- footway, unmarked, footway: crossing, lit: yes, surface: asphalt
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
- footway, unmarked, footway: crossing, lit: yes, smoothness: intermediate, surface: sett
- footway, footway: sidewalk, surface: paving_stones
- footway, footway: sidewalk, lit: yes, smoothness: excellent, surface: asphalt, wheelchair: yes
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones, wheelchair: yes
- steps, access: yes, handrail: no, incline: up, lit: yes, ramp: no, step_count: 5, surface: paving_stones
- cycleway, cycleway: link, lit: yes, oneway: no, smoothness: good, surface: asphalt
- bicycle parking, bicycle_parking: stands, capacity: 20, check_date:capacity: 2024-02-25, covered: no, fee: no
- building:levels: 8, building:part: yes
- 6 Bernhard-Weiß-Straße, 10178 Berlin, addr:suburb: Mitte, building:levels: 8, roof:shape: flat, smoking: outside, type: multipolygon
