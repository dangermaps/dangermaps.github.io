...
The tourist is currently located at these coordinates: 52°13'37.32"N, 21°0'49.62"E (52.227032483936604, 21.01378428441424).
...
- advertising: column (3m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 14, check_date:capacity: 2023-10-10, covered: no, fee: no (6m)
- waste basket (7m)
...
- barrier: bollard, bollard: fixed, material: metal (13m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: no (13m)
- barrier: bollard, bollard: fixed, material: metal (14m)
- The Mexican, restaurant, addr:housenumber: 41, addr:street: Wspólna, cuisine: mexican, indoor_seating: yes, opening_hours: Mo-Th 11:30-24:00; Fr-Sa 12:00-01:00; Su 11:30-23:00, outdoor_seating: yes, wheelchair: limited (14m)
- traffic signals (15m)
- traffic signals, road_marking: solid_stop_line (15m)
- barrier: bollard, bollard: fixed, material: metal (16m)
- barrier: bollard, bollard: fixed, material: metal (17m)
- fire hydrant (underground), fire_hydrant:diameter:signed: no (17m)
- barrier: bollard, bollard: fixed, material: metal (18m)
- waste basket (18m)
- atm, brand: BOŚ Bank, covered: yes, opening_hours: 24/7, operator: Euronet, wheelchair: yes (20m)
- Mail Boxes Etc., post office, addr:housenumber: 41, addr:street: Wspólna, brand: Mail Boxes Etc., opening_hours: Mo-Fr 09:30-17:30, post_office: post_partner, shop: copyshop, wheelchair: limited (21m)
- barrier: bollard, bollard: fixed, material: metal (21m)
- barrier: bollard, bollard: fixed, material: metal (22m)
- BOŚ Bank, bank, addr:housenumber: 41, addr:street: Wspólna, brand: BOŚ Bank, opening_hours: Mo-Fr 09:30-17:00, operator: BOŚ Bank, wheelchair: limited (24m)
- barrier: bollard, bollard: fixed, material: metal (24m)
- man_made: manhole (24m)
- tourism information, information: guidepost (25m)
...
- railway: tram_level_crossing (29m)
- barrier: bollard, bollard: fixed, material: metal (30m)
...
- entrance: main (31m)
- advertising: column (31m)
- barrier: bollard, bollard: fixed, material: metal (31m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (32m)
- barrier: bollard, bollard: fixed, material: metal (33m)
- waste basket (33m)
- railway: tram_crossing (35m)
- Społem, addr:housenumber: 78/80, addr:street: Marszałkowska, brand: Społem, opening_hours: Mo-Fr 06:15-21:30; Sa 08:00-22:00; Su 09:00-17:00 "tylko niedziele handlowe", shop: convenience, wheelchair: yes (35m)
- barrier: bollard, bollard: fixed, material: metal (35m)
- fire hydrant (underground), fire_hydrant:diameter:signed: no (35m)
- leaf_type: broadleaved (36m)
- barrier: bollard, bollard: fixed, material: metal (36m)
- atm, brand: Euronet, covered: yes, opening_hours: 24/7, operator: Euronet, wheelchair: yes (37m)
- traffic_signals, button_operated: yes, railway: tram_crossing, traffic_signals:sound: yes, traffic_signals:vibration: no (37m)
- barrier: bollard, bollard: fixed, material: metal (38m)
- bicycle parking, bicycle_parking: stands, capacity: 10, covered: no (43m)
...
- 41 Wspólna, 00-519 Warszawa, addr:city:simc: 0918123, building:levels: 11, source:addr: gugik.gov.pl, wheelchair: yes
- Żyletkowiec, See Wikipedia: https://pl.wikipedia.org/wiki/Żyletkowiec (ul. Marszałkowska 82 w Warszawie), building:levels: 7, multiplehousenumbers: yes, roof:levels: 1, roof:shape: flat, start_date: 1952
...
- area:highway: yes, junction: yes
- area:highway: secondary
- footway, footway: crossing, lit: yes, smoothness: intermediate, surface: paving_stones, width: 8
- area:highway: yes, junction: yes
- cycleway, lit: yes, surface: paving_stones
- footway, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt, width: 8
- footway, footway: traffic_island, lit: yes, smoothness: good, surface: paving_stones, width: 8
- footway, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt, width: 8
...
- Ruch, brand: Ruch, building:levels: 1, disused:shop: kiosk, roof:shape: flat, was:building: kiosk, wheelchair: yes
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
- parking, access: yes, capacity:disabled: 0, fee: yes, orientation: perpendicular, parking: street_side
...
- Wspólna (residential oneway 2-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Wspólna w Warszawie, maxspeed: 50km/h, sidewalk: separate, smoothness: excellent
- parking, access: yes, capacity:disabled: 0, fee: yes, orientation: diagonal, parking: street_side
- footway, footway: sidewalk, lit: yes, smoothness: intermediate, surface: sett
