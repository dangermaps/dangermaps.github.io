...
It is Wednesday, Aug 16, 2023, 2:31 PM local time.

The tourist is currently located at these coordinates: 37°59'47.67"N, 23°43'20.31"E (37.99657539036903, 23.722308471172866).
Name of Road: Λιοσίων
Name of neighborhood: Αττική
...
- traffic signals, traffic_signals: signal (8m)
- recycling, colour: red, material: metal, recycling:clothes: yes, recycling:shoes: yes, recycling_type: container (21m)
- traffic signals, traffic_signals, button_operated: no, traffic_signals: signal, traffic_signals:sound: no, traffic_signals:vibration: no (21m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: no (25m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: no (28m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: no (31m)
- public_transport: stop_position, trolleybus: yes (32m)
- traffic signals (34m)
- ΑΦΕΤΗΡΙΑ (ΠΛΑΤΕΙΑ ΑΤΤΙΚΗΣ) ( road, unlit), bench: yes, bin: no, check_date:shelter: 2022-03-15, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΑΣΑ, public_transport: platform, route_ref: 1, shelter: yes, trolleybus: yes (36m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: no (36m)
- traffic signals, traffic_signals: signal (38m)
- stop (44m)
- 5 Σεπολίων, 10445 Αθήνα (49m)

Within a 75m radius, there are also:
- Σεπολίων (oneway 1-lane asphalt road)
- Πεισιστράτου (oneway 1-lane asphalt road)
- Πλατεία Αττικής
- Αγορακρίτου (oneway 3-lane asphalt road), trolley_wire: yes
- Πλατεία Αττικής (paving_stones road, lit), smoothness: intermediate
- Liosion (twoway 2-lane asphalt road), reg_ref: ΕΠ1, sidewalk: both, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Liosion (oneway 2-lane asphalt road), reg_ref: ΕΠ1, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Σεπολίων (asphalt road)
- 17 Αδμήτου, Αθήνα, bus depot, name: Ο.ΣΥ. - Αμαξοστάσιο Ηλεκτροκινήτων Λεωφορείων Πλατείας Αττικής
- leisure: park
- Liosion (oneway 2-lane asphalt road), reg_ref: ΕΠ1, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- colour: #DA291C, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, operator: ΣΤΑΣΥ, railway: subway, service: spur, start_date: 2000-01-28, tunnel: yes, voltage: 750
- building:levels: 2
- Αγορακρίτου (oneway 3-lane asphalt road), trolley_wire: yes
- roof:shape: flat
- 121 Λιοσίων, 10445 Αθήνα, name: Athens Lydia, tourism: hotel
- Πλατεία Αττικής (paving_stones road, lit)
- Πλατεία Αττικής (paving_stones road, lit), smoothness: good
- pedestrian, lit: yes, noname: yes, surface: paving_stones
- Liosion (oneway 2-lane asphalt road), reg_ref: ΕΠ1, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Σεπολίων (oneway 2-lane asphalt road), maxspeed:type: GR:urban, smoothness: excellent
- Liosion (oneway 2-lane asphalt road), reg_ref: ΕΠ1, sidewalk: right, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- Σεπολίων (oneway 1-lane asphalt road)
- Liosion (oneway 2-lane asphalt road), reg_ref: ΕΠ1, sidewalk: right, sidewalk:right:surface: paving_stones, smoothness: excellent, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
...
- Line 2, (Red line), colour: #DA291C, electrified: rail, electrified:rail: top, frequency: 0, gauge: 1435, network: Μετρό Αθήνας, operator: ΣΤΑΣΥ, railway: subway, start_date: 2000-01-28, tunnel: yes, usage: main, voltage: 750
- area: yes, surface: concrete
- area: yes, surface: concrete
- leisure: park
- Liosion (twoway 2-lane asphalt road), reg_ref: ΕΠ1, source:reg_ref: ΦΕΚ 47 Α/8.2.1956
- footway, footway: sidewalk, lit: yes, surface: concrete
