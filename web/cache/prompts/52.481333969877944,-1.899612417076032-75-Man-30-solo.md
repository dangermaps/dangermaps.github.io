...
The tourist is currently located at these coordinates: 52°28'52.8"N, 1°53'58.6"W (52.481333969877944, -1.899612417076032).
Name of Road: St Philip's Place
...
- SH1 ( road), bus: yes, naptan:AtcoCode: 43000206203, naptan:Bearing: SW, naptan:BusStopType: MKD, naptan:CommonName: Colmore Row, naptan:Indicator: Stop SH1, naptan:Landmark: St Phillips Churchyard, naptan:NaptanCode: nwmajdtg, naptan:PlusbusZoneRef: BHAMNWS, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: COLMORE ROW, naptan:Towards: Moor Street Interchange, City, public_transport: platform, route_ref: 9;10;10H;140;X10 (11m)
- Colmore Row, bicycle rental, capacity: 12, email: support@beryl.cc, fee: yes, network: West Midlands Cycle Hire, network:regional: Starley, official_name: Colmore Row, operator: Beryl, payment:app: yes, payment:cash: no, payment:credit_cards: no, payment:cryptocurrencies: no, payment:debit_cards: no, phone: +44 20 3003 5044, ref:gbfs: beryl_west_midlands:2838, ref:wmch: 53, rental: city_bike;ebike, website: https://beryl.cc/scheme/west-midlands (14m)
- Colmore Row, B3 2AB Birmingham, leisure: park, name: Pigeon Park (16m)
- age: early-mature, constituency: City Centre, genus: Platanus, height: 14, height:range: 13 to 13.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100012, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (16m)
- age: early-mature, constituency: City Centre, genus: Platanus, height: 14, height:range: 13 to 13.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100013, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: unbalanced, ward: Ladywood (17m)
- Lunar Society, tourism: artwork (18m)
- age: semi-mature, constituency: City Centre, height: 15, height:range: 14 to 14.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100016, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: suppressed, ward: Ladywood (19m)
- age: early-mature, constituency: City Centre, genus: Platanus, height: 14, height:range: 13 to 13.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100014, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: unbalanced, ward: Ladywood (21m)
- bench, backrest: yes, colour: black, material: metal, operator: Cathedral Church of Saint Philip, seats: 4 (22m)
- age: early-mature, constituency: City Centre, genus: Platanus, height: 14, height:range: 13 to 13.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100011, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (25m)
- bench, backrest: yes, colour: black, material: metal, operator: Cathedral Church of Saint Philip, seats: 4 (25m)
- fire hydrant (underground), operator: WMFS (26m)
- Bishop Charles Gore, PMSA_ref: WMbiBIxx221, artist_name: Thomas Stirling Lee, artwork:material: bronze, artwork_type: statue, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, start_date: 1914-03-06, tourism: artwork (26m)
- age: early-mature, constituency: City Centre, genus: Platanus, height: 14, height:range: 13 to 13.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100015, ref:usrn: 2701508, site_name: COLMORE ROW, species: Platanus x acerifolia, tree_form: unbalanced, ward: Ladywood (27m)
- emergency: bleed_control_kit, operator: West Midlands Ambulance Service (29m)
- direction: both, traffic_calming: table (29m)
- Rostill Lines Monument, heritage: 2, heritage:operator: Historic England, historic: monument, listed_status: Grade II (30m)
- crossing, marked, traffic_calming: table (32m)
- bicycle parking, bicycle_parking: stands, capacity: 6 (34m)
- give way, direction: backward (36m)
- man_made: surveillance (36m)
- crossing, marked, traffic_calming: table (37m)
- entrance: main (41m)
- Colmore Row Bus Station, bus station, bus: yes, iata: ZBC, public_transport: station (46m)

Within a 75m radius, there are also:
- Temple Row West (asphalt road, lit), cycleway:both: no, maxspeed: 20 mphkm/h, postal_code: B2, sidewalk: both
- Church Street (oneway asphalt road, lit), maxspeed: 20 mphkm/h, postal_code: B3
- Cathedral Square, grave yard, leisure: park, religion: christian, wheelchair: yes
- Colmore Row, B3 2QB Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/St Philip's Cathedral, Birmingham, place of worship, architect: Thomas Archer, architect:wikidata: Q534286, building:architecture: baroque, denomination: anglican, diocese: Diocese of Birmingham, height: 12, heritage: 2, heritage:operator: Historic England, heritage:website: https://historicengland.org.uk/listing/the-list/list-entry/1076173, highlight: yes, inscription_date: 1952-04-25, listed_status: Grade I, name: Cathedral Church of Saint Philip, ref:GB:nhle: 1076173, religion: christian, source:height: estimate, start_date: 1715, website: https://www.birminghamcathedral.com/, wheelchair: yes, year_of_construction: 1710-1725
- footway, lit: yes, surface: paving_stones
- footway, designation: public_footpath, lit: yes, prow_ref: Birmingham FP 1806, source:prow_ref: birmingham_city_council_prow_gis_data, surface: paving_stones
- Colmore Row, B3 2FE Birmingham, addr:housename: Grand Hotel, architect: Thomson Plevins, building:levels: 6, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, start_date: 1876
- 75 Colmore Row, B3 2AP Birmingham, architect: Yeoville Thomason, height: 36, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics, start_date: 1872
- footway, designation: public_footpath, lit: yes, prow_ref: Birmingham FP 1806, smoothness: excellent, source:prow_ref: birmingham_city_council_prow_gis_data, surface: paving_stones
- footway, lit: yes, surface: paving_stones
- 78-84 Colmore Row, B3 2AB Birmingham, height: 29, name: Mills & Reeve, office: lawyer, source:height: emuanalytics
- Colmore Row (oneway 2-lane asphalt road, lit), See Wikipedia: https://en.wikipedia.org/wiki/Colmore Row, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- footway, designation: public_footpath, lit: yes, prow_ref: Birmingham FP 1806, source:prow_ref: birmingham_city_council_prow_gis_data, surface: paving_stones
- building:colour: #d0c4c0, building:part: yes, height: 37, min_height: 26, roof:colour: #c0c0d0, roof:height: 6, roof:shape: dome
- building:colour: #c0c0d0, building:part: yes, height: 41.5, min_height: 36, roof:colour: #c0c0d0, roof:height: 2, roof:shape: dome
- building:colour: #d0c4c0, building:part: yes, height: 14.2, roof:colour: #c0c0d0, roof:height: 2.2, roof:orientation: across, roof:shape: round
- building:colour: #d0c4c0, building:part: yes, height: 26, min_height: 12, ref:dove: 15513, roof:colour: #c0c0d0, roof:shape: flat
- building:colour: #d0c4c0, building:part: yes, height: 14, roof:colour: #d0c4d0, roof:shape: flat
- building:part: yes, height: 14, roof:colour: #c0c0d0, roof:height: 1.5, roof:shape: gabled
- building:part: yes, height: 14.6, roof:colour: #c0c0d0, roof:height: 3.6, roof:shape: gabled
- Colmore Row (oneway 2-lane asphalt road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h
- footway, surface: paving_stones
- footway, footway: sidewalk
- footway, footway: sidewalk
- footway, footway: sidewalk
- footway, marked, footway: crossing, traffic_calming: table
- footway, marked, footway: crossing, traffic_calming: table
- footway, footway: sidewalk
- footway, footway: sidewalk
- Cathedral Square, grave yard, leisure: park, religion: christian, wheelchair: yes
