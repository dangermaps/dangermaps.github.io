...
The tourist is currently located at these coordinates: 37°56'54.19"N, 23°39'48.87"E (37.94838601769427, 23.66357440098292).
Name of Road: Σοφιανοπούλου
...
- crossing, uncontrolled, crossing_ref: zebra (43m)
- stop (46m)
- crossing, uncontrolled, crossing_ref: zebra (47m)
- crossing, marked, crossing_ref: zebra (52m)
- maxspeed: 40km/h, traffic_sign: maxspeed (61m)
- crossing, marked, crossing_ref: zebra (61m)
- crossing, uncontrolled, crossing_ref: zebra (66m)
- maxspeed: 40km/h, traffic_sign: maxspeed (77m)

Within a 75m radius, there are also:
- Karaoli & Dimitriou (oneway 2-lane asphalt road, lit), maxspeed: 40km/h
- Emmaluilidi Emmanouil (oneway asphalt road), sorting_name: Εμμανουηλίδη Εμμανουήλ
- leisure: pitch, sport: soccer
- Sofianopoulou (oneway 2-lane asphalt road)
- Ellinon Iroon (residential oneway asphalt road)
- Nikolopoulou (residential oneway asphalt road)
- Οικόπεδο Χαραγκιωνη
- service, oneway: yes, surface: asphalt
- Καραολή και Δημητρίου (oneway 1-lane asphalt road)
- service, surface: asphalt
- Sofianopoulou (oneway 1-lane asphalt road)
- Karaoli & Dimitriou (oneway 2-lane asphalt road, lit)
- Diamanti (residential oneway asphalt road)
- Σοφιανοπούλου (oneway 1-lane asphalt road)
- Karaoli & Dimitriou (oneway 2-lane asphalt road, lit)
