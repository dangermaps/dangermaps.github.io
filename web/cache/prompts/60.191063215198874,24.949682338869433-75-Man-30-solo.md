...
The tourist is currently located at these coordinates: 60°11'27.83"N, 24°56'58.86"E (60.191063215198874, 24.949682338869433).
Name of Road: Sturenkatu
...
- man_made: utility_pole, material: steel (4m)
- traffic_sign: FI:543a (13m)
- man_made: utility_pole, material: steel, traffic_sign: FI:371 (23m)
- est_height: 12, man_made: surveillance, revolving: yes (26m)
- traffic_sign: FI:424;FI:425 (27m)
- Sturenkatu ( road, lit), bench: yes, bin: yes, bus: yes, departures_board: realtime, public_transport: platform, ref:findr: 182202, shelter: yes, wheelchair: no, zone:HSL: A (27m)
- 1 Konepajankuja, 00510 Helsinki, restaurant, cuisine: italian, diet:halal: no, diet:kosher: no, name: Alice Italian, payment:credit_cards: yes, payment:debit_cards: yes, phone: +358 40 051 3933, website: https://www.aliceitalian.fi/ (28m)
- traffic_sign: FI:531 (28m)
- traffic signals (28m)
- 1 Konepajankuja, 00510 Helsinki, bar, name: Oluthuone Konepaja, payment:credit_cards: yes, payment:debit_cards: yes, phone: +358 10 76 63530, website: https://www.raflaamo.fi/fi/helsinki/konepaja (29m)
- traffic_sign: FI:871[Ei talvikunnossapitoa] (32m)
- man_made: utility_pole, material: steel, traffic_sign: FI:511, traffic_signals: signal, traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes (32m)
- traffic_signals:tram: yes (32m)
- traffic_signals:motor_vehicle: yes (33m)
- bicycle parking, access: private, bicycle_parking: stands, covered: yes (34m)
- addr:housenumber: 1, addr:street: Konepajankuja, entrance: main (34m)
- traffic_sign: FI:424 (34m)
- man_made: utility_pole, material: steel (34m)
- location: overhead, traffic_sign: FI:332, traffic_sign:2: FI:851[6-23 (6-23) 6-23] (35m)
- 17 Aleksis Kiven katu, 00510 Helsinki (36m)
- crossing, traffic_signals, button_operated: yes, check_date:crossing: 2021-09-23, pyörä_väistää_aina_autoa: tämä_jos_valoton, traffic_signals:sound: yes, traffic_signals:vibration: no (36m)
- crossing, traffic_signals, button_operated: no, check_date:crossing: 2021-01-27, traffic_signals:sound: yes, traffic_signals:vibration: no (37m)
...
- railway: tram_level_crossing (39m)
- 1 Konepajankuja, 00510 Helsinki, coworking space, name: Wonderland, website: https://wonderlandwork.fi/ (39m)
- crossing, traffic_signals, button_operated: yes, ele: 18, source:ele: barometric*2, traffic_signals:sound: yes, traffic_signals:vibration: no (39m)
- electrified: power_feed, man_made: utility_pole, material: steel, traffic_sign: FI:371, traffic_sign:2: FI:511 (40m)
- entrance: service (42m)
- crossing, traffic_signals, button_operated: no, check_date:crossing: 2021-01-27, traffic_signals:sound: no, traffic_signals:vibration: no (44m)
- man_made: utility_pole, material: steel (48m)

Within a 75m radius, there are also:
- cycleway, bicycle: designated, lit: yes, segregated: no, snowplowing: yes, surface: asphalt
- footway, footway: sidewalk, incline: up, lit: yes, snowplowing: yes, surface: asphalt
- Sturenkatu (oneway 3-lane asphalt road, lit), bicycle: use_sidepath, maxlength: 12, maxspeed: 40km/h, parking:lane:left: no_stopping, parking:lane:right: no_parking, paved:date: 2012-06, priority_road: yes_unposted, snowplowing: yes, tram:lanes:forward: yes||
...
- service, bus: yes, fi:hkr:kunnossapitoluokka: II, lanes: 1, lit: yes, motor_vehicle: no, oneway: yes, surface: asphalt, tram:lanes:forward: yes
- service, fi:hkr:kunnossapitoluokka: II, lanes: 1, lit: yes, motor_vehicle: no, oneway: yes, psv: yes, surface: asphalt
- Aleksis Kiven katu (oneway 1-lane asphalt road, lit), bicycle: use_sidepath, fi:hkr:kunnossapitoluokka: II, maxspeed: 40km/h, smoothness: good, snowplowing: yes
- odor:industrial: coffee roaster
- location: underground, man_made: pipeline, operator: Helen, start_date: 2010, substance: water
- Sturenkatu (oneway 2-lane asphalt road, lit), halting: no, maxlength: 12, maxspeed: 40km/h, parking:lane:left: no_stopping, parking:lane:right: no_stopping, paved:date: 2012-06, priority_road: designated, snowplowing: yes
- Sturenkatu (oneway 2-lane asphalt road, lit), bicycle: use_sidepath, guideposted_leads_to_ref: 4;7, maxspeed: 40km/h, parking:lane:left: no_stopping, parking:lane:right: no_parking, paved:date: 2012-06, priority_road: yes_unposted, start_date: before 1961, tram:lanes:forward: yes|
- Sturenkatu (oneway 2-lane asphalt road, lit), bicycle: use_sidepath, guideposted_leads_to_ref: 4;7;170, maxspeed: 40km/h, paved:date: 2012-06, priority_road: designated, tram:lanes:forward: yes|
...
- Sturenkatu (twoway 2-lane asphalt road, lit), destination:colour:forward: white, destination:forward: Itäkeskus;Pasila, guideposted_leads_to_ref:forward: 170, maxspeed: 40km/h, parking:condition:reason: junction;curve, snowplowing: yes, turn:backward: right
...
- electrified: contact_line, frequency: 0, gauge: 1000, oneway: yes, operator: HKL-Raitioliikenne, railway: tram, tram:segregation:physical: junction, voltage: 600
- electrified: contact_line, frequency: 0, gauge: 1000, oneway: yes, operator: HKL-Raitioliikenne, railway: tram, start_date: 2008-07, tram:segregation:physical: junction, voltage: 600
- building:levels: 6, building:name: Fredriksberg, building:part: office
- Sturenkatu (oneway 2-lane asphalt road, lit), halting: no, maxlength: 12, maxspeed: 40km/h, paved:date: 2012-06, priority_road: designated, snowplowing: yes
- building:levels: 6
- building:levels: 6, building:part: office
- service, access: private, service: parking_aisle, surface: concrete, tunnel: yes
- parking, access: private, parking: underground, surface: concrete
...
- Sturenkatu (twoway asphalt road, lit), lane_markings: no, maxspeed: 40km/h, parking:condition:reason: junction, snowplowing: yes
