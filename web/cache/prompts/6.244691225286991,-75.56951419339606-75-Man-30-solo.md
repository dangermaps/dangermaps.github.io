...
The tourist is currently located at these coordinates: 6°14'40.89"N, 75°34'10.25"W (6.244691225286991, -75.56951419339606).
Name of Road: Carrera 49
...
- entrance: yes (25m)
- crossing, traffic_signals (35m)
- crossing, traffic_signals (42m)
- traffic signals (46m)

Within a 75m radius, there are also:
- Carrera 50 (oneway 4-lane asphalt road), (Palacé), destination: Centro
- Iglesia de San Antonio, place of worship, denomination: roman_catholic, religion: christian
- Ciclorruta San Juan (paved road), marking:both: solid_line, segregated: yes, separation:both: no, traffic_mode:both: foot
- Carrera 50 (oneway 2-lane road), (Avenida Palacé), maxspeed: 40km/h
- Calle 44 (oneway 4-lane asphalt road), (San Juan)
- Carrera 50 (oneway 3-lane asphalt road), (Palacé), cycleway:right: lane, cycleway:right:marking:left: double_solid_line, cycleway:right:marking:right: solid_line, cycleway:right:oneway: no, cycleway:right:separation:left: no, cycleway:right:separation:right: kerb, cycleway:right:traffic_mode:left: motor_vehicle, cycleway:right:traffic_mode:right: foot, maxspeed: 40km/h
- footway, marked, footway: crossing
- leisure: park
- Calle 44 (oneway 5-lane asphalt road), (San Juan)
- Metrosalud Guayaquil, hospital
- Carrera 49 (oneway 2-lane asphalt road), (Junín), cycleway:right: lane, cycleway:right:marking:left: double_solid_line, cycleway:right:marking:right: solid_line, cycleway:right:oneway: no, cycleway:right:separation:left: no, cycleway:right:separation:right: kerb, cycleway:right:traffic_mode:left: motor_vehicle, cycleway:right:traffic_mode:right: foot
- Carrera 50 (oneway 3-lane asphalt road), (Palacé), cycleway: separate, maxspeed: 40km/h
