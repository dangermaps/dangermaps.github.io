...
The tourist is currently located at these coordinates: 60°11'5.85"N, 24°57'42.76"E (60.18495870600141, 24.961879051413206).
Name of Road: Lintulahdenaukio
...
- With buzzer, access: private, addr:housenumber: 8, addr:street: Lintulahdenaukio, entrance: staircase (27m)
- With buzzer, access: private, addr:housenumber: 6, addr:street: Lintulahdenaukio, entrance: staircase (31m)
- access: private, addr:housenumber: 17a, addr:street: Hämeentie, entrance: staircase (35m)
- addr:flats: 1, entrance: home (36m)
- barrier: swing_gate, bicycle: destination, locked: yes, material: metal, motor_vehicle: private, motorcar: private (41m)
- 3 Lintulahdenaukio, Helsinki (42m)
- With buzzer, access: private, addr:housenumber: 4b, addr:street: Lintulahdenaukio, addr:unit: C, entrance: staircase (44m)
- 17 B Hämeentie, 00500 Helsinki, driving school, name: Cap-Autokoulu, website: https://cap.fi/autokoulu/helsinki-hameentie (47m)

Within a 75m radius, there are also:
- 6 Lintulahdenaukio, Helsinki, building:maintenance:operator: Töölön Laatuhuolto Oy, operator: Lintulahdenpenger, operator:type: private
- 8 Lintulahdenaukio, Helsinki, building:maintenance:operator: Lassila&Tikanoja, operator: Helsingin Lintulahdenpuisto, operator:type: cooperative
- footway, bicycle: no, lit: yes, pihatie: yksityisalue, surface: paved
- steps, bicycle: no, pihatie: yksityisalue
- footway, bicycle: no, pihatie: yksityisalue
- Lintulahdenaukio (sett road, lit), motor_vehicle: destination, source:name:sv: Digiroad.fi
- footway, lit: yes, surface: paved
- footway, bicycle: no, lit: yes, pihatie: yksityisalue, surface: paved
- footway, bicycle: no, pihatie: yksityisalue
- building:maintenance:operator: RTK-Palvelu Oy, cleaning:operator: Lassila&Tikanoja, owner: TA-asumisoikeus Oy
- Lintulahti
...
- building:levels: 8, building:maintenance:operator: SOL Kiinteistöpalvelut
- steps, bicycle: no, incline: up, pihatie: yksityisalue
- footway, bicycle: no, pihatie: yksityisalue
- leisure: playground
- footway
- footway
- footway, bicycle: no, incline: up, pihatie: yksityisalue
- footway
- footway
- leisure: playground
- footway
