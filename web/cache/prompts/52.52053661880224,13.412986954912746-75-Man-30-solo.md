...
The tourist is currently located at these coordinates: 52°31'13.93"N, 13°24'46.75"E (52.52053661880224, 13.412986954912746).
Name of Road: 
...
- Asiagourmet, fast food, cuisine: asian, diet:pescetarian: yes, diet:vegetarian: no, indoor_seating: yes, opening_hours:signed: no, outdoor_seating: yes, wheelchair: yes (10m)
- Döner Curry, fast food, cuisine: kebab;sausage, diet:vegetarian: yes, indoor_seating: yes, opening_hours:signed: no, outdoor_seating: yes, smoking: outside, takeaway: yes, wheelchair: no (11m)
- railway: signal, railway:signal:combined: DE-ESO:ks, railway:signal:combined:form: light, railway:signal:combined:function: block, railway:signal:combined:height: normal, railway:signal:combined:states: DE-ESO:hp0;DE-ESO:ks1;DE-ESO:ks2, railway:signal:combined:substitute_signal: DE-ESO:db:zs12;DE-ESO:db:zs7;DE-ESO:dr:zs1, railway:signal:direction: forward, railway:signal:position: right, railway:signal:speed_limit: DE-ESO:zs3, railway:signal:speed_limit:form: light, railway:signal:speed_limit:height: normal, railway:signal:traversable: DE-ESO:mastschild_rot-weiss, railway:signal:traversable:type: written_default_speed;dictated_default_speed (14m)
- railway: signal, railway:signal:direction: forward, railway:signal:electricity: DE-ESO:el1, railway:signal:electricity:form: sign, railway:signal:electricity:height: dwarf, railway:signal:electricity:turn_direction: left, railway:signal:electricity:type: power_off, railway:signal:position: right (15m)
- Back-Factory, brand: Back-Factory, indoor_seating: yes, opening_hours: Mo-Fr 06:30-19:00; Sa 07:00-19:00; Su 07:00-19:00, outdoor_seating: yes, shop: bakery, wheelchair: yes (15m)
- waste basket, colour: orange, covered: no, indoor: no, material: steel, operator: BSR, waste: cigarettes;dog_excrement;trash (17m)
- 115 10179 Berlin, addr:place: Stadtbahnbogen, addr:suburb: Mitte, de:strassenschluessel: 11000000000009138 (19m)
- 117 Dircksenstraße, 10178 Berlin, (Kentucky Fried Chicken), fast food, addr:suburb: Mitte, air_conditioning: no, brand: KFC, contact:phone: +49 30 20054545, cuisine: chicken, diet:vegetarian: yes, drive_through: no, indoor_seating: yes, internet_access: no, name: KFC, opening_hours: Mo-Sa 10:00-24:00; Su 11:00-24:00, outdoor_seating: yes, payment:mastercard: yes, payment:visa: yes, phone: +49 30 20054545, smoking: no, surveillance: indoor, takeaway: yes, toilets:wheelchair: yes, website: https://www.kfc.de/, wheelchair: yes, wheelchair:description: Euro-Schlüssel notwendig! (21m)
- 116 10179 Berlin, addr:place: Stadtbahnbogen, addr:suburb: Mitte, de:strassenschluessel: 11000000000009138 (22m)
- 114 10179 Berlin, addr:place: Stadtbahnbogen, addr:suburb: Mitte, de:strassenschluessel: 11000000000009138 (25m)
- Alexanderplatz, subway entrance, check_date:wheelchair: 2022-06-30, entrance_marker:subway: yes, level: 0, public_transport: entrance, wheelchair: no (25m)
- Ks-Mehrabschnittssignal als Blocksignal in nordwestlicher Richtung, railway: signal, railway:signal:combined: DE-ESO:ks, railway:signal:combined:form: light, railway:signal:combined:function: block, railway:signal:combined:states: DE-ESO:hp0;DE-ESO:ks1;DE-ESO:ks2, railway:signal:combined:substitute_signal: DE-ESO:db:zs7, railway:signal:direction: forward, railway:signal:position: bridge, railway:signal:traversable: DE-ESO:mastschild_rot-weiss, railway:signal:traversable:type: written_default_speed;dictated_default_speed (26m)
- waste basket, colour: orange, covered: no, indoor: no, material: steel, operator: BSR (28m)
- Radnetz Deutschland, tourism information map, website: http://www.radnetz-deutschland.de/ (29m)
- operator: DB InfraGO AG, railway: switch, railway:switch: default (30m)
- 113 10179 Berlin, addr:place: Stadtbahnbogen, addr:suburb: Mitte, de:strassenschluessel: 11000000000009138 (31m)
- 117 10179 Berlin, addr:place: Stadtbahnbogen, addr:suburb: Mitte, de:strassenschluessel: 11000000000009138 (31m)
- level: -1 (32m)
- waste basket, colour: orange, covered: no, indoor: no, material: steel, operator: BSR, waste: cigarettes;dog_excrement;trash (36m)
- waste basket, street lamp, tourism information, bicycle: yes, information: guidepost (36m)
- ALX, shop: convenience (36m)
- advertising: column (37m)
- man_made: surveillance, surveillance: outdoor (38m)
- tourism information, bicycle: yes, information: guidepost (43m)
- 2 10178 Berlin, addr:place: Alexanderplatz, addr:suburb: Mitte, brand: Uniqlo, clothes: women;men;children, contact:website: http://www.uniqlo.com, internet_access: wlan, name: Uniqlo, opening_hours: PH,Su off; Mo-Sa 10:00-20:00, payment:cash: yes, payment:credit_cards: yes, payment:debit_cards: yes, shop: clothes, wheelchair: yes (46m)
- Dircksenstr. / Grunerstr., taxi (50m)
...
- 1 Rathausstraße, 10178 Berlin, building:levels: 5, height: 30 m, name: Cubix, roof:height: 6 m, roof:shape: flat, start_date: 2001
...
- Berliner Stadtbahn, bridge: viaduct, detail: track, electrified: rail, frequency: 0, gauge: 1435, level: 1, maxspeed: 60km/h, operator: DB Netz AG, passenger_lines: 2, railway: light_rail, railway:ballastless: yes, railway:ballastless:system: RHEDA-Berlin, railway:zbs: yes, usage: main, voltage: 750, workrules: DE:EBO
- Berliner Stadtbahn, bridge: viaduct, detail: track, electrified: contact_line, frequency: 16.7, gauge: 1435, maxspeed: 60km/h, operator: DB Netz AG, passenger_lines: 2, railway: rail, railway:ballastless: yes, railway:ballastless:system: RHEDA-Berlin, railway:lzb: no, railway:pzb: yes, railway:traffic_mode: passenger, start_date: 1882-02, usage: main, voltage: 15000, workrules: DE:EBO
- service, lit: yes, maxspeed: 30km/h, surface: asphalt
...
- footway, indoor: yes, level: -3, lit: 24/7, tunnel: yes
- Dircksenstraße (paving_stones road, lit), parking:both: no, postal_code: 10179, sidewalk: both, smoothness: intermediate, source:width: ARCore, width: 10, wikimedia_commons: Category:Dircksenstraße (Berlin-Mitte)
- covered: yes, leisure: outdoor_seating, operator: Carambar, roof:material: plastic
- pedestrian, bicycle: no, lit: yes, noname: yes, smoothness: intermediate, surface: paving_stones
