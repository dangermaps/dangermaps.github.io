...
The tourist is currently located at these coordinates: 52°29'53.37"N, 13°24'59.86"E (52.49815958115355, 13.41662690028327).
Name of Road: Admiralstraße
...
- barrier: gate, bicycle: yes (12m)
- 2 Admiralstraße, 10999 Berlin, addr:suburb: Kreuzberg (12m)
- barrier: swing_gate (17m)
- 1 Admiralstraße, 10999 Berlin, addr:suburb: Kreuzberg (18m)
- GLS;UPS;FedEx, parcel locker, addr:housenumber: 2, addr:street: Admiralstrasse, brand: Myflexbox, capacity: 77, colour: white, opening_hours: 24/7, parcel_locker:type: cabinet, parcel_mail_in: yes, parcel_pickup: yes (19m)
- parking entrance, access: private, parking: underground (20m)
- access: private, barrier: lift_gate, bicycle: yes, motorcar: yes, motorcycle: yes (21m)
- artwork_type: graffiti, covered: https://photos.app.goo.gl/BJSAJRcwUwMhgQsV8https://photos.app.goo.gl/pMZF33g9SCqVV1cV8, tourism: artwork (22m)
- street lamp (28m)
- artwork_type: graffiti, covered: yes, image: https://photos.app.goo.gl/8p2cpqjzsmaFNsfN9, tourism: artwork (29m)
- artwork_type: graffiti, covered: yes, image: https://photos.app.goo.gl/pgBSowbUUYt3f6NN6, tourism: artwork (32m)
- artwork_type: mural, image: https://photos.app.goo.gl/MiQoYdMBtVQLve2e6, tourism: artwork (32m)
- barrier: bollard, bollard: fixed (32m)
- barrier: bollard, bollard: fixed (33m)
- street lamp (34m)
- fire hydrant (underground), addr:floor: 0, level: 0 (35m)
- artwork_type: mural, image: https://photos.app.goo.gl/WnHKJ9VHwkzf3JZU9, tourism: artwork (37m)
- barrier: bollard, bollard: fixed (37m)
- barrier: bollard, bollard: fixed (39m)
- vending machine, currency:EUR: yes, payment:handyparken: yes, vending: parking_tickets (40m)
- leaf_cycle: evergreen, leaf_type: needleleaved (46m)
...
- Admiralstraße (residential asphalt road, lit), maxheight: default, maxspeed: 30km/h, parking:both: lane, parking:both:fee: no, parking:both:orientation: parallel, postal_code: 10999, sidewalk: both, sidewalk:both:surface: paving_stones, tunnel: building_passage
- 4 Admiralstraße, 10999 Berlin, addr:suburb: Kreuzberg, building:levels: 7
- 37 Admiralstraße, 10999 Berlin, building:levels: 11
- 3 Admiralstraße, 10999 Berlin, addr:suburb: Kreuzberg, building:levels: 8
- Admiralstraße (residential paving_stones road, lit), maxspeed: 30km/h, parking:both: lane, parking:both:fee: no, parking:both:orientation: parallel, postal_code: 10999, sidewalk: both
- Admiralstraße (residential asphalt road, lit), cycleway:both: no, maxspeed: 30km/h, parking:both: lane, parking:both:fee: no, parking:both:orientation: parallel, postal_code: 10999, sidewalk: both, sidewalk:both:surface: paving_stones
- 5 Skalitzer Straße, 10999 Berlin, addr:suburb: Kreuzberg
- footway
- footway, check_date:surface: 2021-03-27, smoothness: good, surface: paving_stones
...
- parking, access: private, capacity: 9, parking: surface
- footway
- service, oneway: yes, service: driveway, surface: paving_stones
- service, oneway: yes, service: driveway, surface: paving_stones
- parking, access: private, capacity: 3, parking: surface
- service, service: driveway
- barrier: retaining_wall
- service, service: driveway, surface: paving_stones
- service, access: private, service: driveway
- barrier: bollard
- parking, access: no, capacity: 1, disabled: private, markings: yes, orientation: parallel, parking: lane, surface: asphalt, traffic_sign: DE:314,1044-11
- parking, access: yes, access:conditional: no @ (Mo-Fr 10:00-17:00), capacity: 1, disabled:conditional: designated @ (Mo-Fr 10:00-17:00), fee: no, markings: yes, orientation: parallel, parking: lane, surface: asphalt
- parking, access: no, capacity: 1, disabled: private, markings: yes, orientation: parallel, parking: lane, surface: asphalt, traffic_sign: DE:314,1044-11
