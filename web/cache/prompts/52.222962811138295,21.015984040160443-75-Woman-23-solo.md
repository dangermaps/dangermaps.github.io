...
The tourist is currently located at these coordinates: 52°13'22.67"N, 21°0'57.54"E (52.222962811138295, 21.015984040160443).
...
- railway: tram_level_crossing (6m)
- crossing:barrier: no, railway: tram_level_crossing (7m)
- waste basket, material: concrete (11m)
- Plac Konstytucji, bicycle rental, bicycle_rental: dropoff_point, brand: Veturilo, capacity: 30, network: Veturilo, not:brand:wikidata: Q97373105, operator: Nextbike Polska (12m)
- Plac Konstytucji 06, network: ZTM Warszawa, operator: Tramwaje Warszawskie, public_transport: stop_position, railway: tram_stop, shelter: yes, tram: yes (14m)
- advertising: column (15m)
- traffic signals (16m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: no, traffic_signals:vibration: no (16m)
- traffic signals, traffic_signals: signal (24m)
- Plac Konstytucji 06, bench: yes, bin: yes, lit: yes, network: ZTM Warszawa, operator: Tramwaje Warszawskie, passenger_information_display: yes, public_transport: platform, shelter: yes, tram: yes (26m)
- waste basket, material: concrete (26m)
- traffic signals, traffic_signals: signal (26m)
- street lamp (28m)
- street lamp (28m)
- leaf_type: broadleaved (28m)
- leaf_type: broadleaved (30m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: yes (30m)
- bench, backrest: yes (35m)
- Plac Konstytucji 09, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position (35m)
- Plac Konstytucji 08, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position (36m)
- Plac Konstytucji 08 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: yes (37m)
- bench, backrest: yes (38m)
- give way (38m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: yes (38m)
- leaf_type: broadleaved (39m)
- grit bin, seasonal: winter (43m)
- traffic signals (44m)
- fire hydrant (pillar), couplings: 2 (44m)
- street lamp (46m)
- grit bin, seasonal: winter (47m)
- street lamp (49m)
- Plac Konstytucji 09 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: yes (49m)
- leaf_type: broadleaved (51m)

Within a 75m radius, there are also:
- Plac Konstytucji (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Plac Konstytucji w Warszawie, cycleway:left: no, cycleway:right: separate, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
...
- parking, access: yes, capacity: 103, capacity:disabled: 5, fee: no, park_ride: no, parking: surface
- service, lit: yes, service: parking_aisle, surface: paving_stones
...
- Koszykowa (twoway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, cycleway:both: no, lanes:backward: 2, lanes:forward: 1, maxspeed: 50km/h, sidewalk: separate, smoothness: good, turn:lanes:backward: through|through;right
- Plac Konstytucji (twoway 5-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Plac Konstytucji w Warszawie, cycleway:both: no, lanes:backward: 2, lanes:forward: 3, maxspeed: 50km/h, parking:both: no, sidewalk:left: separate, sidewalk:right: no, smoothness: excellent, turn:lanes:backward: through|through, turn:lanes:forward: left|through|through
...
- footway, footway: sidewalk, lit: no, smoothness: good, surface: paving_stones
- footway, footway: crossing, lit: yes, smoothness: excellent, surface: asphalt
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
- area:highway: bus
- area:highway: secondary
...
- Plac Konstytucji (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Plac Konstytucji w Warszawie, bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
- footway, footway: sidewalk, lit: yes, smoothness: good, surface: paving_stones
