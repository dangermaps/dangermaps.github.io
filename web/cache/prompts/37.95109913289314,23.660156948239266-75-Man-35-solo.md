...
The tourist is currently located at these coordinates: 37°57'3.96"N, 23°39'36.57"E (37.95109913289314, 23.660156948239266).
Name of Road: Καστανίτσης
...
- ΧΡΩΠΕΙ ( road), bench: yes, bus: yes, public_transport: platform, shelter: yes (72m)
- addr:housenumber: 5, addr:street: Ανδριτσαινης (74m)
- crossing, uncontrolled (76m)
- bus: yes, public_transport: stop_position (85m)

Within a 75m radius, there are also:
- Andritsainis (residential oneway asphalt road)
- Paxon (residential asphalt road)
- Zanetou (residential oneway asphalt road)
- Β' Πάροδος Ερμουπόλεως (residential oneway asphalt road)
- Katstanitsis (residential oneway asphalt road)
