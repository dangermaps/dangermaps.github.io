...
The tourist is currently located at these coordinates: 37°56'34.66"N, 23°40'13.47"E (37.94295978729652, 23.67040930647023).
...
- maxspeed: 50km/h, traffic_sign: maxspeed (24m)
- street lamp (47m)
- street lamp (57m)
- street lamp (68m)
- barrier: gate (89m)
...
- motorway, bridge: yes, destination: Κηφισού, destination:lang:el: Κηφισού, destination:lang:int: Kifisou, destination:ref: A1, destination:to: Λαμία, int_ref: E 75, junction:ref: 1, lanes: 2, lit: yes, maxspeed: 50km/h, oneway: yes, operator: Περιφέρεια Αττικής, source:destination:ref: ΦΕΚ ΑΑΠ 253/21.12.2015, surface: asphalt, toll: no
...
- service
- service, bridge: yes, oneway: yes, service: driveway
- service, oneway: yes, service: driveway
- service, oneway: yes, service: driveway
- service, oneway: yes, service: driveway
- service, bridge: yes, oneway: yes, service: driveway
- residential, oneway: yes
...
- residential, oneway: yes
- parking, access: customers, hgv: no, park_ride: no, parking: surface
- parking, access: customers, bus: yes, hgv: yes, motorcar: no, park_ride: no, parking: surface
...
- barrier: fence
- barrier: fence
- footway, bridge: yes, incline: up
- footway, incline: up
- barrier: wall
- tertiary, oneway: yes
- tertiary
- bridge:structure: beam, man_made: bridge
- Athina - Thessaloniki - Evzoni (oneway 2-lane asphalt bridge, lit), destination: Γλυφάδα|Γλυφάδα;ΣΕΦ, junction:ref: 1, loc_name: Κηφισού, loc_name:prefix: Λεωφόρος, maxspeed: 50km/h, operator: Περιφέρεια Αττικής, smoothness: excellent, toll: no
