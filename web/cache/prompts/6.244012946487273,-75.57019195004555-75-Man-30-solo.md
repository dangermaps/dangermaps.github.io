...
The tourist is currently located at these coordinates: 6°14'38.45"N, 75°34'12.69"W (6.244012946487273, -75.57019195004555).
...
- Palacé X San Juan ( road) (15m)
- access: permissive, barrier: gate (17m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: no (29m)
- access: permissive, barrier: gate (30m)
- crossing, traffic_signals (38m)
- traffic signals (43m)

Within a 75m radius, there are also:
- Calle 44 (oneway 3-lane asphalt road), (San Juan)
...
- Ciclorruta Palacé (asphalt road), cycleway: crossing, horse: no, marking:both: dashed_line, segregated: no
- footway, marked, footway: crossing
- Ciclorruta Palacé (asphalt road), horse: no, smoothness: excellent
