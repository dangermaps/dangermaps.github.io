...
The tourist is currently located at these coordinates: 52°13'20.22"N, 21°0'57.54"E (52.22228453233858, 21.015984040160443).
...
- Plac Konstytucji 01, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position (12m)
- street lamp (16m)
- vending machine, addr:floor: G, covered: no, indoor: no, level: 0, network: ZTM Warszawa, opening_hours: 24/7, operator: Mennica Polska, payment:maestro: yes, payment:mastercard: yes, payment:visa: yes, vending: public_transport_tickets (19m)
- Plac Konstytucji 01 ( road, lit), bench: yes, bin: yes, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: platform, shelter: yes (19m)
- leaf_type: broadleaved (20m)
- waste basket, material: concrete (20m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 10, covered: no, fee: no (21m)
- Śródmieście Południowe, See Wikipedia: https://pl.wikipedia.org/wiki/Śródmieście Południowe, place: quarter (21m)
- grit bin, seasonal: winter (21m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (22m)
- bench, backrest: no, material: wood (26m)
- leaf_type: broadleaved (26m)
- was:leaf_type: broadleaved, was:natural: tree (27m)
- bench, backrest: no, material: wood (28m)
- grit bin, seasonal: winter (28m)
- waste basket, material: concrete (29m)
- vending machine, addr:floor: G, covered: no, indoor: no, level: 0, manufacturer: Scheidt&Bachmann, network: ZTM Warszawa, operator: Mennica Polska, payment:maestro: yes, payment:mastercard: yes, payment:visa: yes, vending: public_transport_tickets (29m)
- leaf_type: broadleaved (29m)
- leaf_type: broadleaved (31m)
- noexit: yes (33m)
- bench, backrest: no, material: wood (33m)
- street lamp (33m)
- bench, backrest: no, material: wood (35m)
- leaf_type: broadleaved (35m)
- grit bin, seasonal: winter (36m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (37m)
- vending machine, operator: ZDM Warszawa, vending: parking_tickets (38m)
- fire hydrant (pillar), couplings: 2 (39m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 10, check_date:capacity: 2023-10-07, covered: no, fee: no (39m)
- leaf_type: broadleaved (40m)
- Plac Konstytucji 02, bus: yes, network: ZTM Warszawa, operator: Zarząd Transportu Miejskiego w Warszawie, public_transport: stop_position (41m)
- waste basket, material: concrete (44m)
- leaf_type: broadleaved (46m)
- 5 Plac Konstytucji, Warszawa, addr:floor: G, level: 0, name: Paris Optique, opening_hours: Mo-Fr 10:30-19:30; Sa 10:00-16:00, shop: optician, website: https://www.parisoptique.pl/, wheelchair: yes (51m)

Within a 75m radius, there are also:
- Plac Konstytucji (oneway 1-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Plac Konstytucji w Warszawie, cycleway:both: no, maxspeed: 50km/h, parking:both: no, sidewalk: no
...
- area:highway: footway, lit: yes
- Zaułek Braci Pakulskich, place: square
- 5 Plac Konstytucji, 00-657 Warszawa, See Wikipedia: https://pl.wikipedia.org/wiki/Marszałkowska Dzielnica Mieszkaniowa, addr:city:simc: 0918123, height: 0.1, historic: yes, source:addr: mapa.um.warszawa.pl
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
- building:colour: #e9d8c5, building:levels: 9, building:material: sandstone, building:min_level: 2, building:part: yes, roof:colour: #8a8a8a
- building:colour: #e9d8c5, building:levels: 2, building:material: concrete, building:part: yes
...
- Marszałkowska (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Marszałkowska w Warszawie, cycleway:both: no, maxspeed: 50km/h, sidewalk: separate, smoothness: excellent
- Plac Konstytucji (oneway 4-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Plac Konstytucji w Warszawie, bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
- cycleway, lit: yes, smoothness: excellent, surface: asphalt, width: 2
- Plac Konstytucji (oneway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Plac Konstytucji w Warszawie, cycleway:left: no, cycleway:right: separate, maxspeed: 50km/h, parking:both: no, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent
...
- footway, smoothness: good, surface: paving_stones
- footway, smoothness: good, surface: paving_stones
- path, bicycle: designated, segregated: no, smoothness: good, surface: paving_stones
