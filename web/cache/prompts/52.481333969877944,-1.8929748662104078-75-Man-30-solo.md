...
The tourist is currently located at these coordinates: 52°28'52.8"N, 1°53'34.71"W (52.481333969877944, -1.8929748662104078).
...
- DSA Theory Test Centre, office: government (16m)
- fire hydrant (underground), operator: WMFS (22m)
- traffic_sign: variable_message (26m)
- 31 Dale End, B4 7LN Birmingham, branch: Vault, brand: HMV, name: HMV, shop: music (32m)
- parking, access: disabled, capacity: 3, capacity:disabled: 3, fee: no, lit: yes, maxstay: no, opening_hours: 24/7, operator: Birmingham City Council, parking: street_side, parking:orientation: parallel, smoothness: intermediate, supervised: no, surface: asphalt (37m)
- PQ12 ( road), NaPTANAreaCode: 43000207605, bus: yes, naptan:AtcoCode: 43000207605, naptan:Bearing: NW, naptan:BusStopType: MKD, naptan:CommonName: Bus Mall, naptan:Indicator: Stop PQ12, naptan:NaptanCode: nwmajgmt, naptan:Status: ACT, naptan:StopType: BCT, naptan:Street: THE PRIORY QUEENSWAY, public_transport: platform, route_ref: 94;95, shelter: yes, shelter_ref: 0207605 (38m)
- man_made: street_cabinet (38m)
- age: semi-mature, constituency: City Centre, genus: Platanus, height: 12, height:range: 11 to 11.99m, leaf_cycle: deciduous, leaf_type: broadleaved, plot_number: 100012, ref:usrn: 2702381, site_name: THE PRIORY QUEENSWAY, species: Platanus x acerifolia, tree_form: natural, ward: Ladywood (42m)
- enforcement:maxheight: 2.8, man_made: monitoring_station, maxheight: 2.8, monitoring: max_height (45m)
