...
The tourist is currently located at these coordinates: 52°31'9.05"N, 13°24'42.77"E (52.5191800612028, 13.411879675334182).
...
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 6, covered: no, fee: no (7m)
- leaf_cycle: deciduous, leaf_type: broadleaved (8m)
- street lamp (8m)
- man_made: street_cabinet (10m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 8, covered: no, fee: no (11m)
- leaf_cycle: deciduous, leaf_type: broadleaved (12m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 8, covered: no, fee: no (16m)
- leaf_cycle: deciduous, leaf_type: broadleaved (16m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 6, covered: no, fee: no (16m)
- street lamp (19m)
- leaf_cycle: deciduous, leaf_type: broadleaved (23m)
- 7 Grunerstraße, 10179 Berlin, addr:suburb: Mitte (23m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 8, covered: no, fee: no (24m)
- 7 Grunerstraße, 10179 Berlin, addr:housename: BlueBox Sonnenstudio, addr:suburb: Mitte, beauty: tanning, contact:phone: +493024724733, contact:website: http://www.ltt-sonnenstudiobetriebe.de/Berlin-Mitte-am-Alex.html, name: BlueBox Sonnenstudio, opening_hours: Mo-Fr 08:00-20:00; Sa,Su,PH 09:00-20:00, shop: beauty, wheelchair: yes (26m)
- street lamp (29m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 14, covered: no, fee: no (31m)
- street lamp (32m)
- railway: switch (36m)
- 7 Grunerstraße, 10179 Berlin, addr:suburb: Mitte (38m)
- street lamp (39m)
- street lamp (39m)
- bicycle parking, access: yes, bicycle_parking: stands, bicycle_parking:position: sidewalk, capacity: 4, covered: no, fee: no (42m)
- bicycle parking, access: yes, bicycle_parking: stands, capacity: 8, covered: no, fee: no (43m)

Within a 75m radius, there are also:
- Grunerstraße (oneway 2-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), bicycle: no, cycleway:both: no, dual_carriageway: yes, maxspeed: 50km/h, parking:both: no, parking:right:restriction: no_stopping, postal_code: 10179, priority_road: designated, sidewalk: no, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
- Rathauspassagen, (Rathaus Passagen), See Wikipedia: https://de.wikipedia.org/wiki/Rathauspassagen, addr:city:fa: برلین, addr:housenumber: 1-14, addr:postcode: 10178, addr:street: Rathausstraße, addr:suburb: Mitte, building:levels: 12, contact:website: http://www.rathauspassagen-berlin.de, opening_hours: Mo-Sa 07:00-22:00, shop: mall, toilets: yes, wheelchair: yes, wikimedia_commons: Category:Rathauspassagen, year_of_construction: 1967..1972
...
- Klostertunnel, electrified: rail, gauge: 1435, loading_gauge: Kleinprofil, operator: Berliner Verkehrsbetriebe, railway: subway, service: crossover, tunnel: yes
- 5-7 Grunerstraße, 10178 Berlin, parking, access: yes, addr:suburb: Mitte, building:levels: 9, capacity: 600, fee: yes, image: https://photos.app.goo.gl/Hg84mbJ4XYoucGqr5, name: Parkhaus Rathauspassagen, opening_hours: 24/7, parking: multi-storey
- leisure: park, protection_title: Geschützte Grünanlage
...
- Grunerstraße (oneway 2-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, dual_carriageway: yes, maxspeed: 30km/h, parking:both: no, postal_code: 10179, priority_road: designated, sidewalk:left: no, sidewalk:right: separate, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
- footway, footway: sidewalk, lit: yes, paving_stones:width: 40, postal_code: 10179, smoothness: intermediate, surface: paving_stones
- Grunerstraße (oneway 3-lane asphalt road, lit), bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, dual_carriageway: yes, lane_markings: yes, maxspeed: 30km/h, parking:both: no, postal_code: 10179, priority_road: designated, sidewalk:left: no, sidewalk:right: separate, smoothness: excellent, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
- footway, check_date:surface: 2023-01-11, colonnade:left: open, covered: colonnade, footway: sidewalk, lit: yes, postal_code: 10179, smoothness: excellent, surface: paving_stones
- footway, footway: sidewalk, lit: yes, paving_stones:width: 35, postal_code: 10179, surface: paving_stones
- footway, bicycle: no, check_date:surface: 2023-09-01, dog: leashed, lit: yes, postal_code: 10179, surface: paving_stones
- Grunerstraße (oneway 2-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), bicycle: use_sidepath, cycleway:left: no, cycleway:right: separate, dual_carriageway: yes, maxspeed: 50km/h, parking:both: no, postal_code: 10179, priority_road: designated, sidewalk:left: no, sidewalk:right: separate, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
...
- 11 Grunerstraße, 10179 Berlin, branch: Berlin-Alexanderplatz, brand: Motel One, building:levels: 18, contact:website: https://www.motel-one.com/en/hotels/berlin/hotel-berlin-alexanderplatz/, internet_access: wlan, name: Motel One, phone: +493020969780, roof:shape: flat, rooms: 708, toilets:wheelchair: yes, tourism: hotel, wheelchair: yes
- building:levels: 9, building:part: yes, height: 67.7
- service, lit: yes, surface: sett
- barrier: bollard
- Grunerstraße (oneway 1-lane asphalt road, lit), See Wikipedia: https://de.wikipedia.org/wiki/Grunerstraße (Berlin), bicycle: no, construction:cycleway:right: lane, cycleway:left: no, dual_carriageway: yes, maxspeed: 30km/h, parking:both: no, parking:right:restriction: no_stopping, postal_code: 10179, sidewalk:left: no, sidewalk:right: separate, wikimedia_commons: Category:Grunerstraße (Berlin-Mitte), zone:traffic: DE:urban
- cycleway, lit: yes, oneway: yes, surface: asphalt, traffic_sign: DE:237
- GN-Tunnel, electrified: rail, gauge: 1435, loading_gauge: Großprofil, operator: Berliner Verkehrsbetriebe, railway: subway, service: crossover, tunnel: yes
- cycleway, bicycle: designated, is_sidepath: yes, lit: yes, oneway: yes, smoothness: excellent, surface: asphalt, traffic_sign: DE:237, width: 2
- service, access: yes, bicycle: designated, colonnade:left: open, covered: colonnade, lit: yes, parking:left: no, parking:right: lane, parking:right:orientation: parallel, parking:right:restriction: loading_only, surface: asphalt, traffic_sign: DE:237, width: 9.8
- cycleway, is_sidepath: yes, lit: yes, oneway: yes, smoothness: excellent, surface: asphalt, traffic_sign: DE:237
- residential, lit: yes, maxspeed: 30km/h, oneway: yes, parking:both: no, surface: asphalt
