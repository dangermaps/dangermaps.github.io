...
The tourist is currently located at these coordinates: 52°31'18.82"N, 13°24'50.74"E (52.521893176401676, 13.41409423449131).
Name of Road: 
...
- Alexanderplatz, public_transport: stop_position, railway: stop, ref:BVG: 222602, subway: yes, surveillance: indoor, website: https://qr.bvg.de/h222602 (3m)
- railway: buffer_stop (5m)
- railway: power_supply, railway:electricity:ref: 103.R2, voltage: 600 (8m)
- level: -5 (9m)
- level: -5 (11m)
- level: -5 (13m)
- railway: signal, railway:signal:direction: forward, railway:signal:position: overhead, railway:signal:speed_limit: DE-BOStrab:g2a, railway:signal:speed_limit:deactivated: no, railway:signal:speed_limit:form: sign, railway:signal:speed_limit:height: normal, railway:signal:speed_limit:speed: 10 (14m)
- uncontrolled, railway: tram_crossing (14m)
- level: -1 (14m)
- level: -3 (15m)
- elevator, description:de: Aufzug zwischen U2 und U5, indoor: yes, level: -1;-3;-5, wheelchair: yes (15m)
- railway: signal, railway:signal:direction: forward, railway:signal:position: overhead, railway:signal:speed_limit: DE-BOStrab:g4, railway:signal:speed_limit:deactivated: no, railway:signal:speed_limit:form: sign, railway:signal:speed_limit:height: normal, railway:signal:speed_limit:speed: 20 (17m)
- railway: tram_crossing (17m)
- level: -1 (17m)
- uncontrolled, railway: tram_crossing (18m)
- railway: power_supply, railway:electricity:ref: 103.02-1, voltage: 750 (19m)
- level: -1 (19m)
- railway: tram_crossing (20m)
- U Alexanderplatz, public_transport: stop_position, railway: tram_stop, ref:BVG: 308801, tram: yes, website: https://qr.bvg.de/h308801, wheelchair: yes (20m)
- level: -1 (20m)
- Alexanderplatz, public_transport: stop_position, railway: stop, ref:BVG: 222601, subway: yes, surveillance: indoor, website: https://qr.bvg.de/h222601 (21m)
- level: -1 (22m)
- railway: power_supply, railway:electricity:ref: 103.02-1, voltage: 750 (22m)
- level: -5 (26m)
- level: -3 (27m)
- elevator, bicycle: yes, entrance: yes, entrance_marker:subway: yes, level: -5;-3;-1;0, public_transport: entrance, wheelchair: yes (27m)
- level: -5 (28m)
- Alexanderplatz, level: -5, public_transport: stop_position, railway: stop, ref:BVG: 254002, subway: yes, website: https://qr.bvg.de/h254002 (28m)
- level: -5 (30m)
- bench, backrest: yes, level: -1 (31m)
- level: -1 (31m)
- level: -3 (31m)
- level: -2 (32m)
- waste basket, level: -1 (33m)
- bicycle parking, bicycle_parking: stands, capacity: 24, check_date:capacity: 2022-09-26, covered: no, fee: no (33m)
- level: -1 (33m)
- level: -1 (34m)
- level: -5 (35m)
- barrier: gate, level: -5, location: underground, tunnel: yes (36m)
- Alexanderplatz, check_date:wheelchair: 2022-09-26, level: -5, public_transport: station, railway: station, station: subway, subway: yes, surveillance: indoor, wheelchair: yes (37m)
- level: -3 (39m)
- street lamp (41m)
- 3 10178 Berlin, addr:place: Alexanderplatz, addr:suburb: Mitte (47m)

Within a 75m radius, there are also:
- 3 10178 Berlin, See Wikipedia: https://de.wikipedia.org/wiki/Die mitte, addr:place: Alexanderplatz, addr:suburb: Mitte, building:colour: #b6b0af, building:levels: 6, building:material: stone, height: 40, name: Die Mitte, roof:colour: #64664c, roof:material: grass, roof:shape: flat, shop: mall, start_date: 2009-3-25, wheelchair: limited, wikimedia_commons: Category:Die mitte
...
- footway, level: -1, lit: yes, smoothness: good, surface: paving_stones, tunnel: yes
...
- building:levels: 1, building:material: glass, max_level: 0, min_level: -5, nohousenumber: yes, roof:shape: flat, stairwell: elevator
- electrified: rail, electrified:rail: bottom, frequency: 0, gauge: 1435, level: -5, loading_gauge: Großprofil, maxspeed: 70km/h, operator: Berliner Verkehrsbetriebe, railway: subway, subway: yes, tunnel: yes, voltage: 750
- steps, incline: up, indoor: yes, level: -5;-1, lit: 24/7, tunnel: yes
- footway, level: -1, lit: yes, smoothness: good, surface: paving_stones, tunnel: yes
- indoor: area, level: -1, subway: yes, tunnel: yes
...
- steps, incline: down, indoor: yes, level: -2;-3, lit: 24/7, tunnel: yes
...
- steps, incline: down, indoor: yes, level: -3;-5, lit: 24/7, tunnel: yes
...
- footway, indoor: yes, level: -3, lit: 24/7, tunnel: yes
- U Alexanderplatz, U Alexanderplatz, Zwischengeschoss, area: yes, indoor: corridor, level: -3, subway: yes, tunnel: yes
- steps, incline: up, indoor: yes, level: -5;-1, lit: 24/7, tunnel: yes
...
- steps, conveying: forward, incline: up, indoor: yes, level: -5;-1, lit: 24/7, tunnel: yes
- steps, conveying: backward, incline: down, indoor: yes, level: -1;-5, lit: 24/7, tunnel: yes
- footway, level: -1, lit: yes, smoothness: excellent, surface: paving_stones, tunnel: yes
- footway, level: -1, lit: yes, smoothness: good, surface: paving_stones, tunnel: yes
- electrified: rail, electrified:rail: bottom, frequency: 0, gauge: 1435, level: -5, loading_gauge: Großprofil, maxspeed: 70km/h, operator: Berliner Verkehrsbetriebe, railway: subway, service: siding, subway: yes, tunnel: yes, voltage: 750
...
- footway, indoor: yes, level: -1, tunnel: yes
- footway, level: -1, lit: yes, smoothness: good, surface: paving_stones, tunnel: yes
- indoor: yes, level: -5;-3;-1, stairwell: elevator
- footway, indoor: yes, level: -1, location: underground
- Kaffee | Crepes, indoor: room, level: -2, room: shop, shop: coffee
- BVG Leitzentrale, indoor: room, level: -3, room: office
- indoor: room, level: -3, room: shop, shop: newsagent, toilets:wheelchair: no, wheelchair: yes
- Le Crobag, brand: Le Crobag, indoor: room, level: -3, room: shop, shop: bakery
- Samui, restaurant, cuisine: asian, indoor: room, level: -1, room: restaurant
- footway, indoor: yes, level: -5, lit: 24/7, tunnel: yes
- footway, indoor: yes, level: -5, lit: 24/7, tunnel: yes
...
- footway, indoor: yes, level: -1, location: underground
- footway, footway: sidewalk, lit: 24/7, location: underground, smoothness: excellent, surface: asphalt, tunnel: yes
- steps, handrail: yes, handrail:left: yes, handrail:right: yes, lit: 24/7, location: underground, ramp: no, surface: paving_stones, tunnel: yes
- level: -2, man_made: tunnel
- footway, footway: link, lit: yes, surface: concrete
- electrified: rail, electrified:rail: bottom, frequency: 0, gauge: 1435, level: -5, loading_gauge: Großprofil, maxspeed: 70km/h, operator: Berliner Verkehrsbetriebe, railway: subway, subway: yes, tunnel: yes, voltage: 750
