...
The tourist is currently located at these coordinates: 52°28'50.36"N, 1°54'2.59"W (52.480655691078226, -1.900718675553636).
...
- LM Recruitment, office: estate_agent (14m)
- traffic signals (17m)
- Centrick Property, office: estate_agent (18m)
- man_made: monitoring_station, monitoring:traffic: yes, operator: bcc, traffic:scoot_node:ref: E0111, traffic:sensor: loop, traffic:sensor:ref: N48111F (25m)
- fire hydrant (underground), operator: WMFS (25m)
- barrier: bollard, bicycle: yes, bollard: rising, colour: stainless steel, horse: yes, material: stainless_steel, motor_vehicle: designated (27m)
- Consulate of Ireland, country: IE, diplomatic: consulate, office: diplomatic (27m)
- traffic signals (29m)
- Duncan Lewis, office: lawyer (33m)
- fire hydrant (underground) (34m)
- The Old Joint Stock Theatre Company, theatre, wheelchair: no (34m)
- internet_access: wlan, operator: BT, service: Birmingham FIZ (35m)
- 34,36 Bennett's Hill, B2 5SN Birmingham, fast food, contact:website: https://www.philpotts.co.uk/?mid=1681&store_id=3, cuisine: sandwich, fhrs:id: 598441, name: Philpotts Sandwiches (36m)
- Waterloo Street, B2 5PP Birmingham, name: Kallkwik, office: communications, source:addr:postcode: code-point_open (37m)
- fire hydrant (underground) (38m)
- man_made: street_cabinet, operator: bcc, street_cabinet: traffic_signals (39m)
- Extra Personnel, office: employment_agency (40m)

Within a 75m radius, there are also:
- Newhall Street (oneway 2-lane asphalt road, lit), See Wikipedia: https://en.wikipedia.org/wiki/Newhall Street, gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B3
...
- Wellington Passage (paving_stones road, lit)
...
- 102 Colmore Row, B3 3AG Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics
...
- 38 Bennett's Hill, B2 5SN Birmingham, disused:amenity: pub, height: 30, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, old_name: Pint Shop, source:height: emuanalytics
- addr:housenumber: 3, height: 29, source:height: emuanalytics
- 85-89 Colmore Row, B3 2BB Birmingham, height: 36, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics
- 104;106 Colmore Row, B3 3AG Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics
- 112 Colmore Row, B3 3AG Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics
- 110 Colmore Row, B3 3AG Birmingham, architect: Henman & Cooper, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics, start_date: 1903
- 1-5 Bennett's Hill, B2 5ST Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:addr:postcode: code-point_open, source:height: emuanalytics
- 6 Bennett's Hill, B2 5ST Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, source:height: emuanalytics
...
- 37 Bennett's Hill, B2 5SN Birmingham, pub, addr:housename: Wellington, fhrs:id: 601990, height: 30, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: The Wellington, real_ale: yes, source:height: emuanalytics, website: https://www.thewellingtonrealale.co.uk/
- 92-98 Colmore Row, B3 2AB Birmingham, bar, brand: Vagabond, fhrs:id: 1420062, height: 30, name: Vagabond, source:height: emuanalytics
- 39 Bennett's Hill, B2 5SN Birmingham, height: 30, name: Colmore Place, source:height: emuanalytics
- 4 Temple Row West, B2 5NY Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/Old Joint Stock Theatre, pub, architect: J A Chatwin, brand: Fuller's, fhrs:id: 598508, height: 29, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: The Old Joint Stock, source:height: emuanalytics, start_date: 1862, website: https://www.oldjointstock.co.uk/, wheelchair: no
- 39-41 Waterloo Street, B2 5PP Birmingham, architect: W T Orton & Cecil Howett, height: 29, heritage: 6, heritage:operator: Birmingham City Council, listed_status: local_grade_B, name: Cavendish House, source:height: emuanalytics, start_date: 1937
- Bennett's Hill, B2 5SN Birmingham, height: 29, source:height: emuanalytics
...
- Nat West House, See Wikipedia: https://en.wikipedia.org/wiki/103 Colmore Row, architect: John Madin, demolished:building: yes, height: 80, office: yes, start_date: 1969
- 103 Colmore Row, See Wikipedia: https://en.wikipedia.org/wiki/103 Colmore Row
- 103 Colmore Row, Birmingham, building:levels: 26, height: 108, name: 103 Colmore Row
