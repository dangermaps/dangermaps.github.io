...
The tourist is currently located at these coordinates: 60°11'10.73"N, 24°57'37.89"E (60.18631526360085, 24.960523861130564).
...
- 1 Torkkelinkatu, Helsinki (18m)
- was:traffic_sign: FI:363[30];FI:364[30] (24m)
- 46 Hämeentie, Helsinki (26m)
- access: yes, entrance: yes (28m)
- access: yes, entrance: yes (31m)
- traffic_sign: FI:372, traffic_sign:2: FI:855a[9-21], traffic_sign:3: FI:871[Vyöhyke 3 Ei koske P-tunnuksella I] (31m)
- 3 Torkkelinkatu, Helsinki (31m)
- With buzzer, access: private, addr:unit: C, entrance: staircase, wheelchair: no (33m)
- traffic signals (34m)
- traffic_sign: FI:364[30], traffic_signals:motor_vehicle: yes (34m)
- traffic signals, highway:give_way: yes (34m)
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: yes, traffic_signals:vibration: no (35m)
- FIXME:pipeline: tarkempi sijainti, diameter: 300, hole:diameter: 20 cm, man_made: manhole, manhole: water, marker:shape: vertical oval on a rectangle (35m)
- crossing, traffic_signals, button_operated: no, traffic_signals:sound: no, traffic_signals:vibration: yes (35m)
- Express-Tilit oy, bank, addr:housenumber: 3, addr:street: Torkkelinkatu, level: 1 (36m)
- fire hydrant, diameter: 300, last_open_pit: 2010-10-14, location: underground (36m)
- access: yes, entrance: yes (37m)
- FIXME:pipeline: tarkempi sijainti, diameter: 200, hole:diameter: 20 cm, man_made: manhole, manhole: water, marker:shape: vertical oval on a rectangle (37m)
- traffic signals (37m)
- vending machine, currency:EUR: yes, opening_hours: Mo-Fr 09:00-19:00, operator: HKR, parking:ticket:zone: 3, vending: parking_tickets (38m)
- access: private, entrance: garage (40m)
- traffic_sign: FI:231, traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes (40m)
- Making movies, mamo, studio, addr:housenumber: 3, addr:street: Torkkelinkatu (41m)
- access: yes, entrance: yes (42m)
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: yes, traffic_signals:vibration: no (47m)
- traffic_signals:foot: yes, traffic_signals:motor_vehicle: yes, traffic_signals:tram: yes (49m)
- railway: tram_crossing (50m)
- crossing, traffic_signals, button_operated: yes, traffic_signals:sound: yes, traffic_signals:vibration: no (51m)
...
- 48 Hämeentie, 00500 Helsinki, building:levels: 7, building:maintenance:operator: Lassila&Tikanoja, owner: As Oy Hämeentie 48, roof:levels: 0, roof:material: metal, roof:shape: gabled, website: https://www.kauppalehti.fi/yritykset/yritys/asunto+oy+hameentie+/02339112
- residential, lit: yes, maxspeed: 30km/h, sidewalk:both: separate, snowplowing: yes, surface: asphalt
- Hämeentie (residential oneway 1-lane asphalt road, lit), maxspeed: 30km/h, paved:date:lanes: 2015|, paved:date:lanes:previous: 2012|, priority_road: yes_unposted, sidewalk:left: no, sidewalk:right: separate, snowplowing: yes, taxi: yes
...
- Torkkelinkatu (residential asphalt road, lit), maxspeed: 30km/h, sidewalk:both: separate, snowplowing: yes
...
- building:levels: 8, building:maintenance:operator: Eeron Talonmiespalvelu Oy
