...
The tourist is currently located at these coordinates: 52°13'20.22"N, 21°0'45.66"E (52.22228453233858, 21.012684406541137).
...
- bicycle parking, bicycle_parking: wall_loops, capacity: 4, covered: no (15m)
- 17 Lwowska, 00-660 Warszawa, pub, level: -1, name: Beer Station, opening_hours: Tu-Su 15:00-01:00, phone: +48508545956, website: http://www.beerstation.pl, wheelchair: no (16m)
- traffic signals, traffic_signals: signal (16m)
...
- Gmach V Gimnazjum Męskiego, tourism information, information: board (21m)
- Kamienica Firmy Budowlanej „Rogóyski, Horn i Rupiewicz”, tourism information, information: board (22m)
- Być Może, restaurant, addr:housenumber: 17, addr:street: Lwowska, shop: bakery, wheelchair: no (24m)
- waste basket, material: concrete (26m)
- entrance: main (27m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: yes (31m)
- traffic signals, traffic_signals: signal (32m)
- crossing, traffic_signals, button_operated: yes, crossing_ref: zebra, traffic_signals:sound: yes, traffic_signals:vibration: yes (34m)
- traffic signals, traffic_signals: signal (37m)
- waste basket, material: concrete (37m)
- Bohdan Pniewski, artwork_type: bust, tourism: artwork (37m)
- Nice Cream, addr:housenumber: 59, addr:street: Koszykowa, disused:amenity: ice_cream, opening_hours: 12:00-20:00, wheelchair: limited (37m)
- bicycle parking, bicycle_parking: stands, capacity: 6, covered: no (38m)
- bicycle parking, access: yes, bicycle_parking: wall_loops, capacity: 11, covered: no, fee: no (38m)
- waste basket, material: concrete (39m)
- bicycle parking, bicycle_parking: stands, capacity: 6, covered: no (43m)

Within a 75m radius, there are also:
- Lwowska (residential oneway asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Lwowska w Warszawie, lane_markings: no, maxspeed: 50km/h, sidewalk: separate
- Lwowska (residential oneway 1-lane asphalt road, lit), hgv: no, maxspeed: 50km/h, sidewalk: separate
- 17 Lwowska, 00-660 Warszawa, addr:city:simc: 0918123, building:levels: 7, historic: yes, source:addr: gugik.gov.pl
- 55 Koszykowa, 00-659 Warszawa, See Wikipedia: https://pl.wikipedia.org/wiki/Gmach Wydziału Architektury Politechniki Warszawskiej, addr:city:simc: 0918123, building:levels: 5, historic: yes, name: Gmach Architektury, name:en: WUT Faculty of Architecture, official_name: Wydział Architektury Politechniki Warszawskiej, roof:shape: double_saltbox, source:addr: gugik.gov.pl
- building:levels: 5, nohousenumber: yes
- 15 Lwowska, 00-660 Warszawa, addr:city:simc: 0918123, building:levels: 6, historic: yes, source:addr: gugik.gov.pl
...
- Koszykowa (twoway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Koszykowa w Warszawie, cycleway:both: no, lanes:backward: 1, lanes:forward: 2, maxspeed: 50km/h, sidewalk: separate, turn:lanes:forward: through|right
...
- footway, footway: crossing, lit: yes, surface: asphalt
- footway, footway: crossing, lit: yes, surface: asphalt
- Lwowska (residential oneway 3-lane asphalt road, lit), See Wikipedia: https://pl.wikipedia.org/wiki/Ulica Lwowska w Warszawie, maxspeed: 50km/h, sidewalk: separate, smoothness: good
- Politechnika Warszawska, university
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- footway, footway: sidewalk, lit: yes, surface: paving_stones
- parking, access: yes, fee: yes, parking: street_side
- footway, footway: sidewalk, lit: yes, surface: paving_stones
