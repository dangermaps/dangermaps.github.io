...
The tourist is currently located at these coordinates: 52°28'47.92"N, 1°53'50.64"W (52.47997741227851, -1.897399900120824).
...
- Trendco, hairdresser: extensions, shop: hairdresser (17m)
- 31 Corporation Street, B2 4LS Birmingham, description:en: Anime merchandise and Manga store, name: TokyoToys, opening_hours: Mo-Fr 10:00-17:00; Sa 10:00-20:00; Su 10:00-18:00, operator: TokyoToys UK Ltd, phone: +44 1212 937292, shop: toys, website: https://www.tokyotoys.com/ (18m)
- clock (19m)
- Roberts, shop: jewelry (20m)
- Fore St, bicycle rental, capacity: 15, email: support@beryl.cc, fee: yes, network: West Midlands Cycle Hire, network:regional: Starley, official_name: Fore St, operator: Beryl, payment:app: yes, payment:cash: no, payment:credit_cards: no, payment:cryptocurrencies: no, payment:debit_cards: no, phone: +44 20 3003 5044, ref:gbfs: beryl_west_midlands:2763, ref:wmch: 7, rental: city_bike;ebike, website: https://beryl.cc/scheme/west-midlands (21m)
- Regis, shop: hairdresser (22m)
- man_made: surveillance (23m)
- barrier: bollard (26m)
- railway: tram_crossing (28m)
- barrier: bollard (28m)
- railway: tram_crossing (34m)
- Corporation Street, public_transport: stop_position, railway: tram_stop, tram: yes (34m)
- Corporation Street, public_transport: stop_position, railway: tram_stop, tram: yes (35m)
- Berketex Bride, clothes: bridal, shop: clothes (36m)
- Beautiful, shop: beauty (38m)

Within a 75m radius, there are also:
- Warwick Passage (paving_stones road, lit), postal_code: B2
- New Cannon Passage (paving_stones road, lit), designation: public_footpath, postal_code: B2, prow_ref: Birmingham FP 2001, source:prow_ref: birmingham_city_council_prow_gis_data
- Cannon Street (oneway paving_stones road, lit), bicycle: yes, maxspeed: 20 mphkm/h, oneway:bicycle: no, postal_code: B2
- Fore Street (paving_stones road, lit), postal_code: B2
- 8 Cherry Street, B2 5AL Birmingham, architect: Fitzroy Robinson & Partners, heritage: 6, heritage:operator: Birmingham City Council, listed_status: local_grade_B, name: Bank House, previous_occupier: Bank of England, start_date: 1969
- 47 Cannon Street, B2 5EF Birmingham, architect: Halpern Partnership, name: City Plaza, shop: mall, start_date: 1987
- 11 Cannon Street, B2 5EN Birmingham, height: 25, name: Mint, shop: beauty, source:height: emuanalytics
...
- 37;39 Corporation Street, B2 4LS Birmingham, architect: Dempster & Heaton, disused:shop: travel_agency, height: 25, old_name: Sta Travel, source:height: emuanalytics
- 17 Cannon Street, B2 5EN Birmingham, height: 25, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics
- 16 Cannon Street, B2 5EN Birmingham, height: 25, source:height: emuanalytics
- 43;45 Corporation Street, B2 4LS Birmingham, height: 25, name: Birmingham Army Careers Centre, source:height: emuanalytics
...
- 33;35 Corporation Street, B2 4LS Birmingham, bank, architect: Dempster & Heaton, brand: Leeds Building Society, height: 25, name: Leeds Building Society, source:height: emuanalytics
- 15 Cannon Street, B2 5EN Birmingham, height: 25, source:height: emuanalytics
- 11-14 Cannon Street, B2 5EN Birmingham, addr:housename: Ingleby House, height: 25, name: Birmingham City Council Legal & Democratic Services, source:height: emuanalytics
- 12 Cherry Street, B2 5AR Birmingham, brand: Evapo, fhrs:id: 777638, height: 25, name: Evapo, old_name: Sandhu News, shop: e-cigarette, source:height: emuanalytics
- architect: Dempster & Heaton, height: 25, source:height: emuanalytics
- 10 Cherry Street, B2 5AR Birmingham, disused:shop: mobile_phone, height: 25, old_name: Carphone Warehouse, source:height: emuanalytics
- Cannon Street, B2 5EN Birmingham, height: 25, source:height: emuanalytics
- 41 Corporation Street, B2 4LS Birmingham, brand: Scrivens, height: 25, name: Scrivens, old_name: New Era, shop: optician, source:height: emuanalytics
...
- 7 Fore Street, B2 5ER Birmingham, brand: William Hill, height: 25, name: William Hill, shop: bookmaker, source:height: emuanalytics
- Cannon Street, B2 5EP Birmingham, height: 24, source:addr:postcode: code-point_open, source:height: emuanalytics
- 1 Fore Street, B2 5ER Birmingham, addr:housename: Caxton House, height: 24, source:addr:postcode: code-point_open, source:height: emuanalytics
...
- Corporation Street (oneway 1-lane concrete road, lit), access: delivery, bicycle: no, delivery: yes, emergency: yes, fixme: Should this be highway=pedestrian or is service road correct? No access except for delivery (and trams but they're mapped separately). Only exit is via Upper Bull Street which is mapped as highway=pedestrian., gritting: priority_3, maintenance: gritting, motor_vehicle: destination, oneway:emergency: no, oneway:tram: no, postal_code: B2
- Cannon Street (paving_stones road, lit), bicycle: yes, maxspeed: 20 mphkm/h, postal_code: B2
- 11-14 Cannon Street, B2 5EN Birmingham, addr:housename: Ingleby House, height: 25, name: Birmingham City Council Legal & Democratic Services, source:height: emuanalytics
