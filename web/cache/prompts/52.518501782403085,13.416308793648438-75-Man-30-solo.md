...
The tourist is currently located at these coordinates: 52°31'6.61"N, 13°24'58.71"E (52.518501782403085, 13.416308793648438).
...
- WE, brand: WE, shop: clothes, wheelchair: yes (3m)
- s.Oliver, brand: s.Oliver, shop: clothes, wheelchair: yes (11m)
- Zara, brand: Zara, level: 0, opening_hours: Mo-Sa 10:00-21:00, shop: clothes, wheelchair: yes (13m)
- parking entrance, fee: yes, parking: underground, wheelchair: yes (14m)
- Berlin, brand: EDEKA, level: -1, name: EDEKA, opening_hours: Mo-Sa 08:00-21:00, payment:cash: yes, payment:debit_cards: yes, shop: supermarket, wheelchair: yes (20m)
- La Bella, female: yes, male: yes, shop: hairdresser (22m)
- Postbank, atm, brand: Postbank, drive_through: no, level: 2, network: Cash Group, operator: Postbank, wheelchair: yes (22m)
- disused:name: LOXX Miniatur Welten Berlin, disused:tourism: theme_park, disused:website: http://loxx-berlin.de, indoor: yes, level: 3, wheelchair: yes (23m)
- 20 Grunerstraße, 10179 Berlin, addr:suburb: Mitte, contact:email: member@mysuperfit.com, contact:facebook: https://www.facebook.com/Superfit-MitteAlexa-232940396804941/, contact:foursquare: https://foursquare.com/v/_/4d98ab3e0caaa1439943b2b3, contact:phone: +49 30 27879810, contact:website: https://superfit.club/, leisure: fitness_centre, level: 4, name: SuperFit, opening_hours: 24/7, wheelchair: limited (24m)
- Vor den Toiletten im Foodcourt hinter Subway, bicycle: no, emergency: defibrillator, horse: no, indoor: yes, level: 2, motor_vehicle: no, opening_hours: Mo-Sa 10:00-21:00 (26m)
- 20 Grunerstraße, 10179 Berlin, addr:housename: EKZ Alexa, addr:suburb: Mitte, brand: H&M, level: 0;1, name: H&M, opening_hours: 10:00-21:00, shop: clothes, wheelchair: yes (26m)
- KIKO Milano, brand: KIKO Milano, level: 0, shop: cosmetics (28m)
- Berlin, name: Roland, shop: shoes, wheelchair: limited (28m)
- Euronet, atm, brand: Euronet, level: 0, operator: Euronet, wheelchair: yes (28m)
- 20 Grunerstraße, 10179 Berlin, addr:suburb: Mitte, brand: Rossmann, contact:phone: +49 30 24638955, contact:website: https://www.rossmann.de, level: -1, name: Rossmann, opening_hours: Mo-Sa 09:00-21:00, operator: Dirk Rossmann GmbH, ref:shop:num: 1771, ref:vatin: DE115055186, shop: chemist, wheelchair: yes (28m)
- elevator, level: 0;1;2;3, opening_hours: 24/7 (29m)
- elevator, level: 0;1;2;3, opening_hours: 24/7 (30m)
- 20 Grunerstraße, 10179 Berlin, dentist, addr:city:fa: برلین, addr:housename: Zahnarztpraxis MundWerk, addr:suburb: Mitte, healthcare: dentist, level: 3, name: Zahnarztpraxis MundWerk, wheelchair: yes (32m)
- Eingang Ravelinplatz, access: permissive, entrance: yes (33m)
- camera:direction: -45, camera:mount: wall, camera:type: fixed, man_made: surveillance, surveillance: outdoor, surveillance:type: camera (34m)
- Berlin, brand: Levi's, clothes: denim;men;women, level: 1, name: Levi's, shop: clothes, wheelchair: yes (37m)
- 20 Grunerstraße, 10179 Berlin, fast food, addr:suburb: Mitte, brand: McDonald's, contact:phone: +49 30 24085828, contact:website: http://www.mcdonalds.de, cuisine: burger, level: 2, name: McDonald's, outdoor_seating: yes, takeaway: yes, wheelchair: yes (39m)
- camera:direction: 40, camera:mount: wall, camera:type: fixed, man_made: surveillance, surveillance: outdoor, surveillance:type: camera (42m)
- Adidas, branch: Neo, brand: Adidas, fixme: exact pos, level: 0, shop: sports, wheelchair: yes (42m)
- Pomodori, restaurant, cuisine: italian, level: 0 (46m)

Within a 75m radius, there are also:
- Ravelinplatz, lit: yes, place: square
- 20 Grunerstraße, 10179 Berlin, (Alexa Berlin), See Wikipedia: https://de.wikipedia.org/wiki/Alexa (Einkaufszentrum), addr:city:fa: برلین, addr:housename: Alexa, addr:suburb: Mitte, building:colour: #b6434e, building:levels: 4, building:material: concrete, contact:website: https://www.alexacentre.com/, name: Alexa, opening_hours: Mo-Sa 10:00-21:00, phone: +49 30 269340121, roof:colour: gray, roof:shape: flat, shop: mall, start_date: 2007-9-12, toilets: yes, toilets:wheelchair: yes, wheelchair: yes
- building:colour: white, building:levels: 5, building:material: concrete, building:part: yes, roof:colour: gray, roof:shape: flat
- building:levels: 4, building:part: yes, roof:colour: gray, roof:shape: flat
- building:colour: #b6434e, building:levels: 4, building:material: concrete, building:part: yes, roof:colour: gray, roof:shape: flat
- building:colour: #b6434e, building:levels: 1, building:material: concrete, building:part: yes, roof:colour: gray, roof:shape: flat
- building:colour: #b6434e, building:levels: 5, building:material: concrete, building:part: yes, roof:colour: gray, roof:shape: flat
- building:colour: #b6434e, building:levels: 3, building:material: concrete, building:part: yes, roof:colour: gray, roof:shape: flat
- building:colour: #b6434e, building:levels: 2, building:material: concrete, building:part: yes, roof:colour: gray, roof:shape: flat
- building:colour: black, building:levels: 3, building:material: glass, building:part: yes, roof:colour: gray, roof:shape: flat
- residential: apartments
- 11 Voltairestraße, 10179 Berlin, addr:suburb: Mitte, building:levels: 20, name: Grandaire, roof:shape: flat, website: https://www.grandaire.berlin/
- footway, lit: yes, smoothness: good, surface: paving_stones
- indoor: room, level: 0, room: shop, shop: yes
- indoor: room, level: 0, room: shop, shop: yes, wheelchair: yes
- indoor: room, level: 0, room: shop, shop: yes, wheelchair: yes
- steps, conveying: backward, incline: up, indoor: yes, level: 0;-1
- steps, conveying: forward, incline: up, indoor: yes, level: 0;-1
- steps, conveying: forward, incline: up, indoor: yes, level: 0-1
- steps, conveying: backward, incline: up, indoor: yes, level: 0-1
- area:highway: steps, conveying: yes, indoor: area, level: -1;0, stairs: yes
- area:highway: steps, conveying: yes, indoor: area, level: -1;0, stairs: yes
- area:highway: steps, conveying: yes, indoor: area, level: 0;1, stairs: yes
- area:highway: steps, conveying: yes, indoor: area, level: 0;1, stairs: yes
- indoor: room, level: -1, room: shop
- indoor: corridor, level: -1
- elevator, indoor: room, level: -3-3
- elevator, indoor: room, level: -3-3
- elevator, indoor: room, level: -3-3
- elevator, indoor: room, level: -3-3
- indoor: room, level: 0, room: shop
- indoor: room, level: 0, room: shop, shop: yes
- indoor: room, level: 0, room: shop, shop: yes
- indoor: room, level: 0, room: shop
- indoor: room, level: 0
- indoor: room, level: 0, room: shop, shop: yes
- indoor: room, level: 0, room: shop, shop: yes
- indoor: room, level: 0, room: restaurant
- building:levels: 11, building:part: yes
- indoor: room, level: -1, room: shop, shop: yes
- indoor: room, level: -1, room: shop, shop: yes
- footway, conveying: forward, incline: down, indoor: yes, level: -2--1, oneway: yes
- footway, conveying: forward, incline: up, indoor: yes, level: -2--1, oneway: yes
- area:highway: footway, conveying: yes, indoor: area, level: -2--1
- indoor: corridor, level: -2
- area:highway: footway, conveying: yes, indoor: area, level: -2--1
- indoor: room, level: -1, room: shop, shop: yes
- indoor: room, level: -1, room: shop
- 20 Grunerstraße, 10179 Berlin, (Alexa Berlin), See Wikipedia: https://de.wikipedia.org/wiki/Alexa (Einkaufszentrum), addr:city:fa: برلین, addr:housename: Alexa, addr:suburb: Mitte, building:colour: #b6434e, building:levels: 4, building:material: concrete, contact:website: https://www.alexacentre.com/, name: Alexa, opening_hours: Mo-Sa 10:00-21:00, phone: +49 30 269340121, roof:colour: gray, roof:shape: flat, shop: mall, start_date: 2007-9-12, toilets: yes, toilets:wheelchair: yes, wheelchair: yes
