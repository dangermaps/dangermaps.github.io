...
The tourist is currently located at these coordinates: 37°56'39.54"N, 23°40'13.47"E (37.94431634489596, 23.67040930647023).
Name of Road: Φραγκισκάτου
...
- ΑΚΤΑΙΟΝ ( road), bench: yes, bin: yes, bus: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΣΥ, passenger_information_display: yes, public_transport: platform, route_ref: 130;Β1;500;040;Α1;217;218, shelter: yes (55m)
- ΑΚΤΑΙΟΝ, bus: yes, network: ΟΑΣΑ, operator: ΟΣΥ, public_transport: stop_position (60m)
- street lamp (62m)
- traffic signals (66m)
- street lamp (67m)
- man_made: standpipe (70m)
- crossing, traffic_signals (70m)
- ΣΚΑΙ, bus: yes, network: ΟΑΣΑ, operator: ΟΣΥ, public_transport: stop_position (74m)
- ΣΚΑΙ ( road), bench: yes, bus: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΣΥ, passenger_information_display: yes, public_transport: platform, route_ref: 040;130;217;218;229;500;Α1;Β1, shelter: yes, wheelchair: no (77m)
- crossing, traffic_signals (77m)
- crossing, traffic_signals, crossing_ref: zebra (78m)
- waste basket (80m)
- Parkit, parking (80m)
- shop: kiosk, wheelchair: no (82m)
- entrance: yes (82m)
- 9 Εθνάρχου Μακαρίου, 18547 Πειραιάς (85m)
- traffic signals, traffic_signals (97m)

Within a 75m radius, there are also:
- water: pond
- Falireos Dimitriou (residential oneway 1-lane asphalt road)
- motorway, bridge: yes, destination: Γλυφάδα, junction:ref: 1, lanes: 2, lit: yes, maxspeed: 50km/h, oneway: yes, operator: Περιφέρεια Αττικής, surface: asphalt, toll: no
- tertiary link, junction:ref: 1, lanes: 1, lit: yes, oneway: yes, source:ref: ΦΕΚ ΑΑΠ 253/21.12.2015, surface: asphalt, toll: no
- tertiary link, bridge: yes, destination: ΣΕΦ, junction:ref: 1, lanes: 1, lit: yes, maxspeed: 50km/h, oneway: yes, source:ref: ΦΕΚ ΑΑΠ 253/21.12.2015, surface: asphalt, toll: no
- motorway link, bridge: yes, destination: Πειραιάς, destination:lang:el-Latn: Peiraias, int_ref: E 75, junction:ref: 1, lanes: 1, lit: yes, maxspeed: 40km/h, oneway: yes, operator: Περιφέρεια Αττικής, placement: middle_of:1, smoothness: excellent, surface: asphalt, toll: no
...
- Falireos Dimitriou (residential oneway 1-lane asphalt road)
- tertiary, lanes: 1, maxheight: 4.5, oneway: yes, source:maxheight: sign, surface: asphalt, tunnel: yes
...
- Metropolitan Hospital, hospital, healthcare: hospital, phone: +30 210 48 09 000, toilets:wheelchair: yes, website: https://www.metropolitan-hospital.gr, wheelchair: yes
- Metropolitan Hospital, hospital, healthcare: hospital, toilets:wheelchair: yes, wheelchair: yes
- path
- Οδός Πειραιώς (oneway 2-lane asphalt road, lit), maxheight: 5, maxspeed: 60km/h, smoothness: excellent
...
- trunk link, lanes: 1, lit: yes, maxheight: 5.40, maxspeed: 50km/h, oneway: yes, source:maxheight: survey, surface: asphalt
- trunk, destination: Πειραιάς;Λιμάνι, lanes: 2, lit: yes, maxheight: 5.20, maxspeed: 60km/h, oneway: yes, surface: asphalt
- tertiary, lanes: 1, oneway: yes, surface: asphalt
- service, service: parking_aisle
- service, service: driveway
- tertiary, lit: yes, oneway: yes
- tertiary, lit: yes, oneway: yes
- parking, fee: no, park_ride: no, parking: surface, supervised: no
- tertiary, lit: yes, oneway: yes
- Ethnarchou Makariou (oneway 3-lane asphalt road, lit), access:lanes: yes|yes|no, bus:lanes: no|no|yes, lanes:bus: 1, maxspeed: 50km/h, placement: right_of:2, reg_ref: ΕΠ16, source:reg_ref: ΦΕΚ 47 Α/8.2.1956, turn:lanes: left|through|none
...
- footway, footway: crossing, surface: asphalt
- Eleftheriou Venizelou (residential oneway asphalt road), maxspeed: 30km/h
