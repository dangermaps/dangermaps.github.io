...
The tourist is currently located at these coordinates: 38°0'7.21"N, 23°44'0.32"E (38.00200162076678, 23.73342299967288).
Name of Road: Μηθύμνης
...
- 37 Μηθύμνης, Αθήνα, shop: convenience (3m)
- 37 Μηθύμνης, Αθήνα (10m)
- 39 Μηθύμνης, 11252 Αθήνα, brand: ΟΠΑΠ, name: ΟΠΑΠ, shop: bookmaker (17m)
- 167 Πατησίων, Αθήνα (18m)
- 37 Μηθύμνης, Αθήνα, name: Lycachat, shop: convenience (18m)
- shop: kiosk (22m)
- 167 Πατησίων, Αθήνα, name: Easywash, self_service: yes, shop: laundry (25m)
- 1 Πλατεία Αμερικής, Αθήνα (27m)
- 167 Πατησίων, 11252 Αθήνα, pharmacy, healthcare: pharmacy, name: ΠΗΝΕΛΟΠΗ ΚΑΣΑΡΤΖΙΔΗ (28m)
- crossing, traffic_signals (29m)
- ΠΛΑΤΕΙΑ ΑΜΕΡΙΚΗΣ ( road, unlit), bench: yes, bin: yes, network: ΟΑΣΑ, network:el: ΟΑΣΑ, network:en: OASA, operator: ΟΑΣΑ, passenger_information_display: yes, public_transport: platform, shelter: yes, trolleybus: yes (29m)
- crossing, marked (32m)
- Vodafone, brand: Vodafone, shop: mobile_phone (33m)
- traffic signals, traffic_signals: signal (34m)
- 1 Πλατεία Αμερικής, Αθήνα, name: Μαύρο διαμάντι, shop: hairdresser (35m)
- traffic signals, traffic_signals: signal (35m)
- 28 Θήρας, Αθήνα (36m)
- filandy, shop: jewelry (37m)
- ΠΛΑΤΕΙΑ ΑΜΕΡΙΚΗΣ, bus: yes, public_transport: stop_position, trolleybus: yes (37m)

Within a 75m radius, there are also:
- Πλατεία Αμερικής ( road), See Wikipedia: https://en.wikipedia.org/wiki/Amerikis Square, bicycle: yes
- Patision (oneway 2-lane asphalt road, lit), maxspeed: 50km/h, smoothness: excellent, source:name: Sign, trolley_wire: yes
- Μηθύμνης (residential oneway 1-lane asphalt road)
- Πλατεία Αμερικής
...
- height: 21, roof:material: concrete, roof:shape: flat
- 34Α Μηθύμνης, Αθήνα, height: 24, roof:material: concrete, roof:shape: flat
