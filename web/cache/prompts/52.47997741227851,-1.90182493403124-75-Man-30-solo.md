...
The tourist is currently located at these coordinates: 52°28'47.92"N, 1°54'6.57"W (52.47997741227851, -1.90182493403124).
Name of Road: Waterloo Street
...
- Waterloo Street, B2 5TJ Birmingham, bar, contact:facebook: purecraftbars, contact:instagram: purecraftbars, contact:twitter: purecraftbars, email: info@purecraftbars.com, name: Purecraft Bar & Kitchen, opening_hours: Mo-Fr 10:00-23:00; Sa 11:00-23:00; Su 11:00-18:00, payment:american_express: yes, payment:cash: no, payment:credit_cards: yes, payment:debit_cards: yes, phone: +44 121 237 5666, website: https://www.purecraftbars.com/ (7m)
- barrier: gate (8m)
- fire hydrant (underground), operator: WMFS (10m)
- VS1 ( road), (Victoria Sq/Council House), bench: yes, bus: yes, naptan_refresh: query, public_transport: platform, route_ref: Ring & Ride, shelter: no (12m)
- bench (15m)
- bench (17m)
- bench (18m)
- bench (20m)
- genus: Tilia, species:en: Lime (21m)
- 20 Waterloo Street, B2 5TB Birmingham, pub, name: Sommar Brew Co, opening_hours: Mo-Th 12:00-23:00; Fr-Sa 12:00-00:00; Su 12:00-22:00, payment:cash: yes (23m)
- William Hill, brand: William Hill, shop: bookmaker (23m)
- bench (23m)
- 130 Colmore Row, B3 3AP Birmingham, restaurant, fhrs:id: 1215709, name: Theatrix (25m)
- genus: Tilia, species:en: Lime (27m)
- The Guardian, artist_name: Dhruva Mistry, artwork_type: sculpture, tourism: artwork, wheelchair: yes (27m)
- toilets (27m)
- 16 Waterloo Street, B2 5UG Birmingham, restaurant, addr:housename: New Oxford House, cuisine: fine_dining;sushi, fhrs:id: 924719, name: Adams, website: https://www.adamsrestaurant.co.uk/ (28m)
- bench (31m)
- genus: Tilia, species:en: Lime (33m)
- barrier: block, material: stone, shape: spherical (35m)
- bench (35m)
- barrier: bollard, bicycle: yes, bollard: rising, colour: stainless steel, horse: yes, material: stainless_steel, motor_vehicle: designated (37m)
- fire hydrant (underground), operator: WMFS (37m)
- Youth, fountain, artist_name: Dhruva Mistry, artwork_type: sculpture, operator: Birmingham City Council, tourism: artwork (42m)
- Big Brum Buz ( road, lit), bench: no, bin: no, bus: yes, naptan: no, public_transport: platform, shelter: no, tourism: convenience (42m)

Within a 75m radius, there are also:
- Waterloo Street (oneway sett road, lit), gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2, sidewalk: both
- Waterloo Passage ( road)
- Eden Place (paving_stones road, lit), designation: public_footpath, prow_ref: Birmingham FP 2248, source:prow_ref: birmingham_city_council_prow_gis_data
- area: yes, area:highway: pedestrian
- steps, designation: public_footpath, handrail: yes, incline: down, lit: yes, prow_ref: Birmingham FP 2249, ramp: no, source:prow_ref: birmingham_city_council_prow_gis_data, step_count: 24, surface: paving_stones
...
- Victoria Square, B1 1BB Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/Council House, Birmingham, townhall, addr:housename: Council House, architect: Yeoville Thomason, building:levels: 6, heritage: 2, heritage:operator: Historic England, listed_status: Grade II*, name: Council House, operator: Birmingham City Council, start_date: 1874-9, wheelchair: yes
- Colmore Row (oneway sett road, lit), gritting: priority_3, maintenance: gritting, maxspeed: 20 mphkm/h, sidewalk: both
- 35;36 Waterloo Street, B2 5TJ Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Apsley House, source:height: emuanalytics
- 118-120 Colmore Row, B3 3BD Birmingham, bank, atm: no, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Co-operative Bank, source:height: emuanalytics
- 122-124 Colmore Row, B3 3AP Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/122–124 Colmore Row, cafe, architect: Prof W R Lethaby;C L Ball, cuisine: coffee_shop;sandwich;cake, fhrs:id: 777696, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade I, name: Java Roastery, not:addr:postcode: B3 3AU, opening_hours: Mo-Fr 07:00-19:00 Sa 09:00-19:00 Su 10:00-18:00, outdoor_seating: no, previous_name: Hudson's Coffee House (until late 2011), previous_use: Eagle Insurance offices, source:height: emuanalytics, start_date: 1900, website: https://javaroastery.co.uk/
- 126 Colmore Row, B3 3AP Birmingham, architect: S N Cooke, height: 23, source:height: emuanalytics, start_date: 1926
- 116 Colmore Row, B3 3BD Birmingham, bank, architect: Paul Waterhouse, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Victoria House, source:height: emuanalytics, start_date: 1912
- 114 Colmore Row, B3 3BD Birmingham, architect: Paul Waterhouse, atm: yes, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics, start_date: 1912
- 130 Colmore Row, B3 3AP Birmingham, See Wikipedia: https://en.wikipedia.org/wiki/130 Colmore Row, architect: Goddard & Co, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, source:height: emuanalytics, start_date: 1903
- 66-68 New Street, B2 4DU Birmingham, building:levels: 5, name: New Street Chambers
- 31-34 Waterloo Street, B2 5TJ Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Wellington House, source:height: emuanalytics
- 16 Waterloo Street, B2 5UG Birmingham, restaurant, addr:housename: New Oxford House, architect: S N Cooke, award:michelin: 1, brand: Pieminister, cuisine: pie, diet:vegan: yes, diet:vegetarian: yes, fhrs:id: 1150594, height: 41, heritage: 6, heritage:operator: Birmingham City Council, listed_status: local_grade_B, name: Pieminister, opening_hours: Su-Fr 12:00-22:00; Sa 11:00-22:00, payment:cash: yes, phone: +44 121 6433745, source:height: emuanalytics, start_date: 1934, website: https://www.adamsrestaurant.co.uk/
- 30 Waterloo Street, B2 5TJ Birmingham, height: 23, heritage: 2, heritage:operator: Historic England, listed_status: Grade II, name: Christchurch House, source:height: emuanalytics
- 14 Waterloo Street, B2 5TX Birmingham, architect: W Norman Twist, height: 41, heritage: 6, heritage:operator: Birmingham City Council, listed_status: local_grade_B, name: Neville House, source:height: emuanalytics, start_date: 1934
- 26 Waterloo Street, B2 5TJ Birmingham, height: 23, source:addr:postcode: code-point_open, source:height: emuanalytics
- footway, lit: yes, surface: paving_stones
- steps, handrail: no, incline: down, lit: yes, ramp: no, step_count: 24, surface: paving_stones
- footway, lit: yes, smoothness: excellent, surface: paving_stones
- Waterloo Street (oneway sett road, lit), gritting: priority_3, lane_markings: no, maintenance: gritting, maxspeed: 20 mphkm/h, postal_code: B2
...
- taxi
- footway, designation: public_footpath, handrail: yes, incline: down, lit: yes, prow_ref: Birmingham FP 2249, ramp: no, source:prow_ref: birmingham_city_council_prow_gis_data, step_count: 6, surface: paving_stones
- footway, footway: sidewalk
- footway, bicycle: designated, lit: yes, segregated: no, surface: paving_stones, wheelchair: yes
